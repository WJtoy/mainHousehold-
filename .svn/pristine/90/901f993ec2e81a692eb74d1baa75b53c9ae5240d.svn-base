...
public class MSCustomerProductFeignFallbackFactory implements FallbackFactory<MSCustomerProductFeign> {
    ...
    public MSCustomerProductFeign create(Throwable throwable) {
        return new MSCustomerProductFeign() {
             ...
             */
            @Override
            public MSResponse<MDCustomerProduct> getByCustomerIdAndProductId(Long customerId, Long productId) {
                return new MSResponse<>(MSErrorCode.FALLBACK_FAILURE);
            }
             ...
             */
            @Override
            public MSResponse<Map<Long, Integer>> findFixSpecByCustomerIdAndProductIdsFromCacheForSD(Long customerId, List<Long> productIds) {
                return new MSResponse<>(MSErrorCode.FALLBACK_FAILURE);
            }
             ...
             */
            @Override
            public MSResponse<Integer> emptyFixSpecById(MDCustomerProduct mdCustomerProduct) {
                return new MSResponse<>(MSErrorCode.FALLBACK_FAILURE);
            }
        };
    }
