...
public class B2BButtonLabelUtils {
    ...
    static {
        ...
        set(B2BDataSourceEnum.WEBER, ButtonEnum.APPOINT_AND_CANCEL, "直接取消");
        set(B2BDataSourceEnum.MBO, ButtonEnum.APPOINT_AND_CANCEL, "直接取消");
        set(B2BDataSourceEnum.JINJING, ButtonEnum.APPOINT_AND_CANCEL, "直接取消");
        set(B2BDataSourceEnum.USATON_GA, ButtonEnum.APPOINT_AND_CANCEL, "直接取消");
        set(B2BDataSourceEnum.MQI, ButtonEnum.APPOINT_AND_CANCEL, "忽略隐藏");
        set(B2BDataSourceEnum.JINRAN, ButtonEnum.APPOINT_AND_CANCEL, "忽略隐藏");
        ...
        set(B2BDataSourceEnum.JDUEPLUS, ButtonEnum.APPOINT_AND_CANCEL, "忽略隐藏");
