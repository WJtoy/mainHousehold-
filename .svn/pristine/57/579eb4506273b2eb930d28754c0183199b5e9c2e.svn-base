...
//            countSql = getCountSql(boundSql);
            countSql = getCountSql(removeOrders(sql));
//            log.error("COUNT SQL: " + StringUtils.replaceEach(countSql, new String[]{"\n", "\t"}, new String[]{" ", " "}));
        }
    ...
    private static String getCountSql(String countsql) {
        return countSqlParser.getSmartCountSql(countsql);
    }
     ...
     * @return
     */
    private static boolean hasLimt(String qlString) {
