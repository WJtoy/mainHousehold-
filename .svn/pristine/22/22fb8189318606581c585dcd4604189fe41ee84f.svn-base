...
<body>
	<form:form id="inputForm" modelAttribute="order" action="${ctx}/servicePoint/sd/orderOperation/servicePointPending" method="post" class="form-horizontal">
            ...
            $("#inputForm").validate({
                submitHandler: function(form){
                    ...
                    $.ajax({
                        ...
                        cache: false,
                        type: "POST",
                        url: "${ctx}/servicePoint/sd/orderOperation/servicePointPending?"+ (new Date()).getTime(),
                        data:order,
                        beforeSend: function () {
