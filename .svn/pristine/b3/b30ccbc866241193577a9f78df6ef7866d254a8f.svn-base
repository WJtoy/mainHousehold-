...
@Controller
@RequestMapping(value = "${adminPath}/rpt/provider/customerFrozenDailyRpt/")
public class MSCustomerFrozenDailyRptController extends BaseRptController {

    @Autowired
    private MSCustomerFrozenDailyRptService msCustomerFrozenDailyRptService;
    ...
    public String customerFrozenDailyRptData(RptSearchCondition rptSearchCondition, HttpServletRequest request, HttpServletResponse response, Model model) {
        ...
        if (rptSearchCondition.isSearching()) {
            page = msCustomerFrozenDailyRptService.getCustomerFrozenDailyRptList(page, customerId, saleId, query,subFlag);
        }
        model.addAttribute("page", page);
        return "modules/providerrpt/customerFrozenDailyReport";
    }
    ...
    public AjaxJsonEntity checkExportTask(RptSearchCondition rptSearchCondition) {
        ...
        try {
            ...
            if (customerId != null) {
                msCustomerFrozenDailyRptService.checkRptExportTask(customerId, saleId, endDate, user,subFlag);
            } else {
    ...
    public AjaxJsonEntity export(RptSearchCondition rptSearchCondition) {
        ...
        try {
            ...
            if (customerId != null) {
                msCustomerFrozenDailyRptService.createRptExportTask(customerId, saleId, endDate, user,subFlag);
