...
<ul id="navtabs" class="nav nav-tabs">
    <shiro:hasPermission name="sd:servicepointpraise:view">
        ...
        <li><a href="${ctx}/servicePoint/receipt/praise/approvedList" title="已审核">已审核</a></li>
        <li class="active"><a href="javascript:void(0);" title="所有">所有</a></li>
    </shiro:hasPermission>
</ul>
<form:form id="searchForm" modelAttribute="praisePageSearchModel" action="${ctx}/servicePoint/receipt/praise/findAllList" method="post" class="form-inline">
    ...
    <div class="control-group">
        ...
        <form:select path="status" cssClass="input-small" cssStyle="width:180px;">
            ...
            <form:option value="10" label="新增"/>
            <form:option value="20" label="待审核"/>
            <form:option value="30" label="驳回"/>
