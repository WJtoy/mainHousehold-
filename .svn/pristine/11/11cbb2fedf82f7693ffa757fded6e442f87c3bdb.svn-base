...
<ul id="navtabs" class="nav nav-tabs">
    ...
    <li><a href="${ctx}/servicePoint/sd/processOrderList/tmallServiceMonitorList" title="天猫预警">预警</a></li>
...
<form:form id="searchForm" modelAttribute="order" action="${ctx}/servicePoint/sd/processOrderList/alllist" method="post"
           class="form-inline">
            ...
            <td rowspan="${rowspan}">
                <c:choose>
                    <c:when test="${order.isNotAccept(30)}">
                        <a href="javascript:void(0);" style="color: red;" onclick="ServicePointOrderService.showProcessOrderDetail('${order.id}','${order.quarter}',${order.orderCondition.orderServiceType});">
                    ...
                    <c:when test="${not empty order.repeateNo}">
                        <a href="javascript:void(0);" onclick="ServicePointOrderService.showProcessOrderDetail('${order.id}','${order.quarter}',${order.orderCondition.orderServiceType});">
