            ...
            $("#inputForm").validate({
                submitHandler: function(form){
                    ...
                    $.ajax({
                        ...
                        cache: false,
                        type: "POST",
                        url: "${ctx}/md/customer/saveMerchandiser?"+ (new Date()).getTime(),
                        ...
                        success: function (data) {
                            ...
                            if(data && data.success == true){
                                ...
                                if(iframe != undefined){
                                    iframe.reMerchandiserPage($("#merchandiser\\.id").val(),data.data);
                                }
...
<form:form id="inputForm" modelAttribute="customer" method="post" class="form-horizontal">
    ...
    <div class="control-group" style="margin-top:30px;">
        ...
        <div class="controls">
            <div class="controls">
                <form:select path="merchandiser.id" cssClass="required input-medium" cssStyle="width: 220px;">
