...
<ul id="navtabs" class="nav nav-tabs">
    ...
    <li class="active"><a href="javascript:void(0);" title="需要等待的工单">停滞<span id="spn_order_count" class="badge badge-info">${page !=null ?page.count:''}</span></a></li>
...
<form:form id="searchForm" modelAttribute="order" method="post" class="form-inline">
    ...
    <div class="control-group">
        ...
        <label>用户电话：</label>
        <input type=text class="input-small" id="phone1" name="phone1" value="${order.phone1}"
    ...
    <div style="margin-top:0px; display:none;" id="div_search_customer">
        ...
        <div style="margin-top:5px;">
            ...
            <form:select path="dataSource" class="input-small" style="width:100px;">
            ...
            <label>状态：</label>
            <c:set var="statusList" value="${fns:getDictListOfRangeFromMS('order_status',20,60)}"/><%--切换为微服务--%>
            ...
            <label>服务项目：</label>
            <form:select path="serviceTypeId" class="input-small">
                <form:option value="" label="所有"/>
        ...
        <div style="margin-top:5px;">
            ...
            <label class="label-search">预约日期：</label>
            ...
            <input id="replyFlagCustomer" name="replyFlagCustomer"
                   ...
                   class="input-small"/> &nbsp;&nbsp;
            <label>反馈内容：</label>&nbsp;
            <input type=text class="input-small" style="width: 150px;" id="remarks" name="remarks" value="${order.remarks }"
                   maxlength="30"/>
            &nbsp;&nbsp;
            <label>预约状态：</label>
            <form:select path="appointmentStatusFlag" class="input-small" style="width:125px;">
                <form:option value="0" label="所有"/>
                <form:option value="1" label="未预约"/>
                <form:option value="2" label="预约到期"/>
                <form:option value="3" label="预约超期"/>
            </form:select>
        </div>&nbsp;
    </div>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        noLimitDatePicker('completeBegin','completeEnd',true,true);
    });
</script>
</body>
</html>
