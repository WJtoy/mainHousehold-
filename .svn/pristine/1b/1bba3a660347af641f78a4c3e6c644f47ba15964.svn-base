...
public interface MSProductFeign {
     ...
     * @return
     */
    @PostMapping("product/findListByCustomerIdAndCategoryId")
    MSResponse<List<MDProduct>> findListByCustomerIdAndCategoryId(@RequestParam("customerId") Long customerId,
