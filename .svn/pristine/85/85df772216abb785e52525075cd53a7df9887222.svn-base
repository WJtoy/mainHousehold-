        ...
        $(document).ready(function(){
                    $("#inputForm").validate({
                        submitHandler: function(form){
                            ...
                            $.ajax({
                                url:"${ctx}/fi/md/customer/saveCustomerAddress",
                                type:"POST",
                                data:$(form).serialize(),
                                dataType:"json",
...
<body>
    <form:form id="inputForm" modelAttribute="customerAddress" action="${ctx}/fi/md/customer/customerAddressForms" method="post" class="form-horizontal">
