...
//        savePath = savePath + "/uploads/"+year+"/"+month+"/"+day+"/";
        savePath = savePath + year+"/"+month+"/"+day+"/";
...
//                } while (file.exists());
                ...
                try {
                    ...
                    json.append("{id:'").append(id).append("',fileName:'").append(year).append("/").append(month).append("/").append(day).append("/").append(name).append("',status:'success',origalName:'").append(oldFileName).append("'");
