...
<head>
	...
	<%@ include file="/WEB-INF/views/modules/servicePoint/sd/reminder/tpl/confirmItems.html" %>
	...
	<script type="text/javascript">
		...
		$(document).ready(function() {
			...
			ServicePointOrderService.showReminderConfirmItems(model);
		});
		</c:if>
	</script>
	<style type="text/css">
	...
	<form:form id="inputForm" modelAttribute="reminder" method="post" cssClass="form-horizontal" cssStyle="width:800px;margin-left: 0px;">
		...
		<fieldset>
				...
				<div class="span6">
					<div class="control-group">
						...
						<div class="controls">
							...
							<a href="javascript:void(0);" onclick="ServicePointOrderService.showOrderDetailInfo('${reminder.orderId}','${reminder.quarter}');">${reminder.orderNo}</a>
			...
			<%--<div class="row-fluid">
				...
				<div class="span6">
					<div class="control-group">
						<label class="control-label">催单日期:</label>
						<div class="controls">
							<form:input path="createDate"  htmlEscape="false" cssClass="input-block-level" readonly="true"/>
						</div>
					</div>
				</div>
			</div>--%>
			<legend style="margin-top: 10px"><span style="border-bottom: #0096DA 4px solid;padding-bottom: 6px;">回复</span></legend>
			<div class="row-fluid">
				<div class="span12">
					<div class="control-group">
			...
			<%--<div class="row-fluid">
				<div class="span6">
					<div class="control-group">
						...
						<div class="controls">
							<form:input path="processName"  htmlEscape="false" cssClass="input-block-level" readonly="true"/>
						</div>
					</div>
				</div>
				<div class="span6">
					<div class="control-group">
						...
						<div class="controls">
							<form:input path="processDate"  htmlEscape="false" cssClass="input-block-level" readonly="true"/>
						</div>
					</div>
				</div>
			</div>--%>
