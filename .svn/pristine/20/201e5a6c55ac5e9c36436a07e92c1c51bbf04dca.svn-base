	...
	<script type="text/javascript">
		...
		$(document).ready(function() {
            ...
            $("#btnSubmit").on("click", function(){
                var url = "${ctx}/provider/md/customerPrice/list";
        ...
        function openPriceInfo(customerId, productId, params, qFirstSearch){
            var text = "服务价格";
            var url = "${ctx}/provider/md/customerPrice/productForm?customer.id="+customerId+"&product.id="+productId+"&"+params+"&qFirstSearch="+qFirstSearch+"";
            top.layer.open({
                type: 2,
                id:"customerPrice",
                zIndex:19891015,
...
<body>
	...
	<form:form id="searchForm" modelAttribute="customerPrice" action="${ctx}/provider/md/customerPrice/list" method="post" class="form-search" cssStyle="margin: 20px 0 20px 0;">
