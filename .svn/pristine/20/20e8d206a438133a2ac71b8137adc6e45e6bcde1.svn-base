			...
			$("#inputForm").validate({
				...
				submitHandler: function(form){
					...
					$.ajax({
                        ...
                        cache: false,
						type: "POST",
						url: "${ctx}/sd/order/saveservice?"+ (new Date()).getTime(),
						data:$(form).serialize(),
                        beforeSend: function () {
...
<body style="display:inline">
	...
	<form:form id="inputForm" modelAttribute="item" action="${ctx}/sd/order/saveservice" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<input type="hidden" id="hasErrorType" name="hasErrorType" value="0" />
		...
		<table border="0">
				...
				<td colspan="2">
					<div class="span6">
						<div class="control-group">
							<label class="control-label"><span class=" red">*</span>上门次数:</label>
							<div class="controls">
			...
			<tr>
				<td><div class="span6">
					<div class="control-group">
						<label class="control-label"><span class=" red">*</span>产品:</label>
						<div class="controls">
			...
			<tr>
				...
				<td><div class="span6">
					<div class="control-group">
						<label class="control-label"><span class=" red">*</span>服务类型:</label>
						<div class="controls">
			...
			<tr class="tr_repair">
				<td>
					<div class="span6">
						<div class="control-group">
							<label class="control-label"><span class=" red">*</span>故障分类:</label>
							<div class="controls">
				...
				<td>
					<div class="span6">
						<div class="control-group">
							<label class="control-label"><span class=" red">*</span>故障现象:</label>
							<div class="controls">
			...
			<tr class="tr_repair">
				<td colspan="2">
					<div class="span12">
						<div class="control-group">
							<label class="control-label"><span class=" red">*</span>故障处理:</label>
							<div class="controls">
			...
			<tr>
				<td>
					<div class="span6">
						<div class="control-group">
							<label class="control-label"><span class=" red">*</span>服务项目:</label>
							<div class="controls">
			...
			<tr>
				<td><div class="span6">
					<div class="control-group">
						<label class="control-label"><span class=" red">*</span>配件费：</label>
						<div class="controls">
			...
			<tr>
				...
				<td><div class="span6">
					<div class="control-group">
						<label class="control-label"><span class=" red">*</span>其他：</label>
						<div class="controls">
							<c:choose>
								<c:when test="${customerRemoteFee != null && customerRemoteFee == 0}">
									<form:input path="otherCharge" htmlEscape="false" type="number" value="0" maxlength="11" class="input-block-level required number" readonly="true"/>
									<c:if test="${order.orderFee.customerPlanOtherCharge ne null}">
										<label>预设厂商其他费用:<font color="red">${order.orderFee.customerPlanOtherCharge }</font></label>
									</c:if>
								...
								<c:when test="${limitRemoteCharge != null}">
									<%--远程费和其他费用合计限制品类--%>
									<input type="text" id="otherCharge" name="otherCharge" readonly="readonly" value="0.0" class="input-block-level required number" />
								</c:when>
								<c:otherwise>
									<form:input path="otherCharge" htmlEscape="false" type="number" value="${order.orderFee.customerPlanOtherCharge}" maxlength="11" class="input-block-level required number"/>
									<c:if test="${order.orderFee.customerPlanOtherCharge ne null}">
										<label>预设厂商其他费用:<font color="red">${order.orderFee.customerPlanOtherCharge }</font></label>
									</c:if>
									<c:if test="${customerRemoteFee!=null && customerRemoteFee==0}">
			...
			<tr>
				<td><div class="span6">
					<div class="control-group">
						<label class="control-label"><span class=" red">*</span>远程费：</label>
						<div class="controls">
							<c:choose>
				...
				<td><div class="span6">
					<div class="control-group">
						...
						<div class="controls">
							<c:choose>
								<c:when test="${ customerRemoteFee != null && customerRemoteFee == 0}">
									<%--厂商没设定远程费并且远程费为0,则不能输入--%>
									<input type="text" id="travelCharge" name="travelCharge" readonly="readonly"  value="0" class="input-block-level required number" />
			...
			<tr>
				<td><div class="span6">
					<div class="control-group">
						<label class="control-label"><span class=" red">*</span>快递费：</label>
						<div class="controls">
