...
<html>
  ...
  <ul id="navtabs" class="nav nav-tabs">
	...
	<form:form id="searchForm" modelAttribute="order" method="post" class="breadcrumb form-search">
		...
		<div>
			<label class="label-search">用&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;户：</label>
			<input type=text class="input-mini" id="userName" name="userName" value="${order.userName}" placeholder="用户姓名" maxlength="20" style="width: 100px"/>
			<label>数量：</label>
			<input type = "text" id="productQty" name="productQty" value="${order.productQty}" maxlength="3" class="input-small" style="width:73px;"/>
			<label>用户电话：</label>
		...
		<div style="margin-top:8px">
			<label class="label-search">客&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;户：</label><sys:treeselect id="customer" name="customer.id" value="${order.customer.id}" labelName="customer.name" labelValue="${order.customer.name}"
				title="客户" url="/md/customer/treeData" cssClass="input-small" allowClear="true" cssStyle="width:210px"/>
			<label>订单编号：</label>
		...
		<div style="margin-top:8px">
			...
			<label>~</label>&nbsp;&nbsp;&nbsp;
			<input id="completeEnd" name="completeEnd" type="text" readonly="readonly" style="width:95px" maxlength="20" class="input-small Wdate"
			...
			<form:select path="dataSource" class="input-small" style="width:135px;">
