...
public class B2BCustomerMappingService {
     ...
     * @return
     */
    public List<User> findCustomerAccountListByCustomerId(Long customerId){
        return userDao.findCustomerAccountListByCustomerId(customerId);
    }
     ...
     * @return
     */
    public Long getCustomerAccountIdByShopIdAndDataSource(Integer dataSource,String shopId){
        Long customerAccountId = 0L;
        MSResponse<Long> msResponse = customerMappingFeign.getCustomerAccountIdByShopIdAndDataSource(dataSource,shopId);
        if(MSResponse.isSuccess(msResponse)){
            customerAccountId = msResponse.getData();
        }
