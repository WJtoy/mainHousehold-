...
public interface MSServicePointPriceFeign {
     ...
     * @return
     */
    @PostMapping("/servicePointPrice/findPricesByPointsAndPriceType")
    MSResponse<MSPage<MDServicePointPrice>> findPricesByPointsAndPriceType(@RequestBody MDServicePointPriceDto mdServicePointPriceDto);
    /**
     * 通过网点id和价格轮次列表获取价格列表
    ...
    */
     ...
     * @return
     */
    @PostMapping("/servicePointPrice/batchInsertOrUpdateThreeVer")
    MSResponse<Integer> batchInsertOrUpdateThreeVer(@RequestBody List<MDServicePointPrice> servicePrices,@RequestParam("priceTypeFlag") Integer priceTypeFlag);
    /**
     * 批量新增或修改New
     * @param servicePrices
     * @return
     ...
     * @return
     */
    @PutMapping("/servicePoint/updateRemotePriceFlag")
    MSResponse<Integer> updateRemotePriceFlag(@RequestBody MDServicePoint servicePoint);
     ...
     * @return
     */
    @PostMapping("servicePointPrice/findListByCategoryAndAreaAndServiceTypeAndProductFromCacheForSD")
    public MSResponse<List<MDServicePointPriceDto>> findListByCategoryAndAreaAndServiceTypeAndProductFromCacheForSD(@RequestBody List<NameValuePair<Long, Long>> productServiceTypeList,
                                                                                                      @RequestParam("productCategoryId") Long productCategoryId,
                                                                                                      @RequestParam("cityId") Long cityId,
                                                                                                      @RequestParam("subAreaId") Long subAreaId,
                                                                                                      @RequestParam("servicePointId") Long servicePointId);
}
