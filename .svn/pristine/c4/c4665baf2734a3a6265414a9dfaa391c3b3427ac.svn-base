...
@Controller
@RequestMapping(value = "${adminPath}/rpt/provider/customerFrozenMonthRpt/")
public class MSCustomerFrozenMonthRptController extends BaseRptController {

    @Autowired
    private MSCustomerFrozenMonthRptService msCustomerFrozenMonthRptService;
    ...
    public String customerFrozenDailyRptData(RptSearchCondition rptSearchCondition, HttpServletRequest request, HttpServletResponse response, Model model) {
        ...
        if (rptSearchCondition.isSearching()) {
            page = msCustomerFrozenMonthRptService.getCustomerFrozenMonthRptList(page, customerId, saleId, subFlag ,rptSearchCondition.getSelectedYear(),rptSearchCondition.getSelectedMonth());
        }
        model.addAttribute("page", page);
        return "modules/providerrpt/customerFrozenMonthReport";
    }
    ...
    public AjaxJsonEntity checkExportTask(RptSearchCondition rptSearchCondition) {
        ...
        try {
            ...
            if (customerId != null) {
                msCustomerFrozenMonthRptService.checkRptExportTask(customerId, saleId, rptSearchCondition.getSelectedYear(),rptSearchCondition.getSelectedMonth(), user,subFlag);
            } else {
    ...
    public AjaxJsonEntity export(RptSearchCondition rptSearchCondition) {
        ...
        try {
            ...
            if (customerId != null) {
                msCustomerFrozenMonthRptService.createRptExportTask(customerId, saleId, rptSearchCondition.getSelectedYear(), rptSearchCondition.getSelectedMonth(), user,subFlag);
