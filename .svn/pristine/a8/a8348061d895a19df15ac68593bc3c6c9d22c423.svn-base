...
import com.wolfking.jeesite.modules.finance.rpt.service.FiServicePointChargeRptService;
...
@Slf4j
@Controller
@RequestMapping(value = "${adminPath}/finance/rpt/servicePointCharge/")
public class FiServicePointChargeRptController {

    @Autowired
    private FiServicePointChargeRptService fiServicePointChargeRptService;
     ...
     * @return
     */
    @RequiresPermissions("rpt:finance:servicePointPaySummaryReport:view")
    ...
    public String servicePointPaySummaryReport(RptSearchCondition rptSearchCondition, HttpServletRequest request, HttpServletResponse response, Model model) {
        ...
        if (rptSearchCondition.isSearching()) {
            ...
            if (productCategoryIds.isEmpty() &&
                ...
                page = fiServicePointChargeRptService.getServicePointPaySummaryRptList(page, rptSearchCondition.getSelectedYear(), rptSearchCondition.getSelectedMonth(), paymentType,
        ...
        return "modules/finance/rpt/fiServicePointPaySummaryReport";
    }


    @ResponseBody
    @RequiresPermissions("rpt:finance:servicePointPaySummaryReport:export")
    ...
    public AjaxJsonEntity checkPaySummaryExportTask(RptSearchCondition rptSearchCondition, Model model) {
        ...
        try {
            ...
            fiServicePointChargeRptService.checkPaySummaryRptExportTask(rptSearchCondition.getSelectedYear(), rptSearchCondition.getSelectedMonth(), paymentType,
    ...
    public AjaxJsonEntity paySummaryExport(RptSearchCondition rptSearchCondition, Model model) {
        ...
        try {
            ...
            fiServicePointChargeRptService.createPaySummaryRptExportTask(rptSearchCondition.getSelectedYear(), rptSearchCondition.getSelectedMonth(), paymentType,
                    rptSearchCondition.getServicePointId(), productCategoryIds, user);
