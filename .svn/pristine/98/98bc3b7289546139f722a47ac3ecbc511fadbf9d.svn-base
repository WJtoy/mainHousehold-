...
@Slf4j
@Component
public class B2BCenterOrderComplainProcessMQSender implements RabbitTemplate.ConfirmCallback {

    private RabbitTemplate rabbitTemplate;
    private RetryTemplate retryTemplate;

    @Autowired
    public B2BCenterOrderComplainProcessMQSender(RabbitTemplate manualRabbitTemplate, RetryTemplate kklRabbitRetryTemplate) {
        ...
        try {
            retryTemplate.execute((RetryCallback<Object, Exception>) context -> {
                ...
                rabbitTemplate.convertAndSend(
                        B2BMQConstant.MQ_B2BCENTER_COMPLAIN_PROCESS_DELAY,
                        B2BMQConstant.MQ_B2BCENTER_COMPLAIN_PROCESS_DELAY,
                ...
                log.error("【B2BCenterOrderComplainProcessMQSender.sendDelay_1】msgJson: {}, errorMsg: {}", msgJson, errorMsg);
            ...
            log.error("【B2BCenterOrderComplainProcessMQSender.sendDelay_2】msgJson: {}, errorMsg: {}", msgJson, errorMsg);
            B2BFailureLogUtils.saveFailureLog(B2BMQQueueType.B2BCENTER_ORDER_COMPLAIN_RETRY, msgJson, 3L,
                    B2BProcessFlag.PROCESS_FLAG_FAILURE, 0, "【B2BCenterOrderComplainProcessMQSender.sendDelay_2】" + errorMsg);
        }
