...
public class OrderComplain extends LongIDDataEntity<OrderComplain>
{
	...
	public static final Integer CREATE_TYPE_MANUANL = 1; //手动创建

	public static final Integer CREATE_TYPE_B2B = 2; //B2B创建
	...
	private int dataSource;//2020-10-14 数据源，用于与第三方系统交互，需要时从订单读取
	...
	public String getB2bComplainNo() {
		return b2bComplainNo;
	}

	public void setB2bComplainNo(String b2bComplainNo) {
		this.b2bComplainNo = b2bComplainNo;
	}
	...
	public Dict getOrderStatus() {
		return orderStatus;
	}

	public void setOrderStatus(Dict orderStatus) {
