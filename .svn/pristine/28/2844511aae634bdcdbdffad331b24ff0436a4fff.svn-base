...
<ul class="nav nav-tabs">
    ...
    <shiro:hasPermission name="md:customertimeliness:edit">
        <li><a href="${ctx}/md/customertimeliness/forms">添加</a>
        </li>
    </shiro:hasPermission>
</ul>
...
<table id="treeTable" class="table table-striped table-bordered table-condensed table-hover">
    ...
    <c:forEach items="${listmap}" var="entity">
        ...
        <tr id="${entity.customerId}" pId="0">
            ...
            <td>
                <shiro:hasPermission name="md:customertimeliness:edit">
                <a href="${ctx}/md/customertimeliness/forms?customer.id=${entity.customerId}&customer.name=${fns:urlEncode(entity.customerName)}">
                    ${entity.customerName}
                </a>
                </shiro:hasPermission>
                <shiro:lacksPermission name="md:customertimeliness:edit">
                    ${entity.customerName}
            ...
            <shiro:hasPermission name="md:customertimeliness:edit">
                <td>
                    <a href="${ctx}/md/customertimeliness/forms?customer.id=${entity.customerId}&customer.name=${fns:urlEncode(entity.customerName)}">修改</a>
