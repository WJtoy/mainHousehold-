...
<ul id="navtabs" class="nav nav-tabs">
    <shiro:hasPermission name="sd:abnormal:view">
        <%--<li><a href="${ctx}/sd/abnormalForm/waitProcessList" title="异常单待处理">待处理</a></li>--%>
...
<form:form id="searchForm" modelAttribute="abnormalForm" action="${ctx}/sd/abnormalForm/processedList" method="post" class="breadcrumb form-search">
