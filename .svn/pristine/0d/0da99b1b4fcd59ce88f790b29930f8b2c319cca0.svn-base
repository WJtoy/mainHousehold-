...
<form:form id="searchForm" modelAttribute="order" action="${ctx}/sd/order/deptleader/reminderlist" method="post"
                ...
                <td>
                    <c:if test="${o.orderCondition.replyFlagKefu == 1 }">
                        <a href="javascript:void(0);" style="color: red;"
                           onclick="Order.viewOrderDetail('${o.id}','${order.quarter}');"><abbr
...
<script type="text/javascript">
    $(document).ready(function () {
        oneYearDatePicker('beginDate','endDate',true);
        oneYearDatePicker('completeBegin','completeEnd');
