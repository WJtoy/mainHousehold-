...
<script type="text/javascript">
    ...
    $("#${id}Button").click(function(){
        ...
        var replyIdex = top.layer.open({
            ...
            zIndex:19891015,
            title:'${title}',
            content: "${ctx}/sd/order/crush/rushSelectForPlan?dialogType=layer&area.id=${areaId}&showArea=${showArea}&productCategoryId=${productCategoryId}&noSubEnginner=${noSubEnginner}&noblackList=${noblackList}&address="+addr+"&parentLayerIndex=" + parentLayerIndex,
            shade: ${noModal?0:0.3},
...
//                });
    ...
    $("#${id}ButtonNew").click(function(){
        ...
        var replyIdex = top.layer.open({
            ...
            zIndex:19891015,
            title:'${title}',
            content: "${ctx}/sd/order/crush/rushSelectForPlan?dialogType=layer&area.id=${areaId}&subArea.id=${subAreaId}&showArea=${showArea}&productCategoryId=${productCategoryId}&noSubEnginner=${noSubEnginner}&noblackList=${noblackList}&address="+addr + "&parentLayerIndex=" + parentLayerIndex,
            shade: ${noModal?0:0.3},
            area: ['${width}px', '${height}px'],
            maxmin: true,
            yes: function(index, layero){
