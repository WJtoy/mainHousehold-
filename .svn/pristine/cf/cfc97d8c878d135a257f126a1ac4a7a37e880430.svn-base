    ...
    <script type="text/javascript" language="javascript">
        $(document).ready(function() {
            ...
            $("#btnSubmit").click(function(){
                ...
                $("#pageNo").val(1);
                $("#searchForm").attr("action","${ctx}/finance/rpt/customerCharge/returnedOrderCancelledRpt");
                $("#searchForm").submit();
            });
...
<ul class="nav nav-tabs">
    ...
    <li><a href="${ctx}/finance/rpt/customerCharge/customerChargeWriteOffRpt">退补单</a>
    </li>
</ul>
