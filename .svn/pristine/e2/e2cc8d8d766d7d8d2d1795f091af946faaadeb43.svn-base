...
@Service
public class FiRechargeRecordRptService {
    ...
    public void checkRptExportTask(Integer actionType, Date beginDate,Date endDate,Long customerId, User user) {
        ...
        fiReportExportTaskService.checkRptExportTask(RPTReportEnum.FI_RECHARGE_RECORD_RPT, user, searchConditionJson);
    }
    ...
    public void createRptExportTask(Integer actionType, Date beginDate,Date endDate,Long customerId,User user) {
        ...
        String searchConditionJson = RedisGsonUtils.toJson(searchCondition);
        fiReportExportTaskService.createRptExportTask(RPTReportEnum.FI_RECHARGE_RECORD_RPT, RPTReportTypeEnum.ORDER_REPORT, user, reportTitle, searchConditionJson);
    }
