...
public class MqiOrderService extends B2BOrderManualBaseService {
    ...
    public MSResponse cancelOrderTransition(B2BOrderTransferResult b2BOrderTransferResult) {
        return mqiOrderFeign.cancelOrderTransition(b2BOrderTransferResult);
    }
    ...
    public MSResponse checkB2BOrderProcessFlag(List<B2BOrderTransferResult> b2bOrderNos) {
        return mqiOrderFeign.checkWorkcardProcessFlag(b2bOrderNos);
    }
    ...
    public MSResponse sendB2BOrderConversionProgressUpdateCommandToB2B(List<B2BOrderTransferResult> progressList) {
        return mqiOrderFeign.updateTransferResult(Lists.newArrayList(progressList));
    }
    ...
    public MSResponse sendOrderStatusUpdateCommandToB2B(MQB2BOrderStatusUpdateMessage.B2BOrderStatusUpdateMessage message) {
        ...
        if (message.getStatus() == B2BOrderStatusEnum.PLANNED.value) {
            ...
            LogUtils.saveLog("B2B工单状态变更消息的状态错误", "MqiOrderService.sendOrderStatusUpdateCommandToB2B", msgJson, null, null);
        }
        return response;
    }
    ...
    private MSResponse orderPlanned(Long messageId, Integer dataSource, Long b2bOrderId, String b2bOrderNo, String engineerName, String engineerMobile, long createById, long createDt) {
        ...
        return mqiOrderFeign.orderPlanned(planned);
    }
    ...
    private MSResponse orderAppointed(Long messageId, Integer dataSource, Long b2bOrderId, String b2bOrderNo, String operator, Long appointmentDt, String remark, long createById, long createDt) {
        ...
        return mqiOrderFeign.orderAppointed(appointed);
    }
    ...
    private MSResponse orderVisit(Long messageId, Long b2bOrderId, String b2bOrderNo, String visitedMan, Long visitedDt, String remarks,
        ...
        return mqiOrderFeign.orderVisited(visited);
    }
    ...
    private MSResponse orderCompleted(Long messageId, Integer dataSource, Long b2bOrderId, String b2bOrderNo, List<MqiOrderCompleted.CompletedItem> completedItems, long createById, long createDt) {
        ...
        return mqiOrderFeign.orderCompleted(completed);
    }
    ...
    private MSResponse orderCancelled(Long messageId, Integer dataSource, Long b2bOrderId, String b2bOrderNo, String operator, Long cancelDt, String remark, long createById, long createDt) {
        ...
        return mqiOrderFeign.orderCancelled(cancelled);
    }
    ...
    public MSResponse processKKLOrder(B2BOrderProcessEntity processEntity) {
        ...
        try {
            ...
            B2BOrderProcessEntity.saveFailureLog(processEntity, "修改快可立工单", "MqiOrderService.processKKLOrder", e);
        }
...
//                }
    ...
    public MSResponse updateFlag(Long b2bConsultingId,Long kklConsultingId){
        MSResponse msResponse = mqiOrderFeign.updateFlag(b2bConsultingId,kklConsultingId);
        return msResponse;
    }
    ...
    public MSResponse process(MqiConsultingOrderProcess consultingOrderProcess){
        return mqiOrderFeign.process(consultingOrderProcess);
    }
