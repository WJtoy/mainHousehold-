...
import com.wolfking.jeesite.common.config.ShiroConfig;
...
//        if(uri.toLowerCase().contains("servlet/validateCodeServlet")){
//            return false;
//        }
    ...
    public static boolean isStaticFile(String uri) {
        if(StringUtils.equalsIgnoreCase("/",uri)){
            return false;
        }
        /*
        if (staticFiles == null)
        ...
        if (staticFiles == null) {
            staticFiles = StringUtils.split(Global.getConfig("web.staticFile"), ",");
            staticFiles = ArrayUtil.removeEle(staticFiles,".html");
            staticFiles = ArrayUtil.removeEle(staticFiles,".jsp");
            staticFiles = ArrayUtil.removeEle(staticFiles,".java");
        }
        return StrUtil.endWithAny(uri.toLowerCase(),staticFiles);
    }
     ...
     * @return
     */
    public static boolean isAnonRequest(String uri){
