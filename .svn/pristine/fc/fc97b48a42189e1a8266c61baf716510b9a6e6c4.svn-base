...
import com.wolfking.jeesite.modules.finance.rpt.service.FiDepositRechargeSummaryRptService;
...
@Controller
@RequestMapping("${adminPath}/finance/rpt/depositRecharge/")
public class FiDepositRechargeSummaryController extends BaseRptController {

    @Autowired
    private FiDepositRechargeSummaryRptService fiDepositRechargeSummaryRptService;
     ...
     * 质保金充值汇总统计
     */
    @RequiresPermissions("rpt:finance:depositRecharge:view")
    ...
    public String customerRechargeSummary(RptSearchCondition rptSearchCondition, Model model) {
        ...
        if (rptSearchCondition.isSearching()) {
            list =fiDepositRechargeSummaryRptService.getDepositRechargeSummary(rptSearchCondition.getServicePointId(),rptSearchCondition.getSelectedYear(),rptSearchCondition.getSelectedMonth());
        }

        model.addAttribute("list", list);
        return "modules/finance/rpt/fiDepositRecharge";
    }
    ...
    public String rechargeRecordByPage(RptSearchCondition rptSearchCondition, HttpServletRequest request, HttpServletResponse response, Model model) {
        ...
        if (rptSearchCondition.isSearching()) {
            page = fiDepositRechargeSummaryRptService.getDepositRechargeDetails(page,rptSearchCondition.getActionType(),
                    rptSearchCondition.getBeginDate(), rptSearchCondition.getEndDate(), rptSearchCondition.getServicePointId());
        }
        model.addAttribute("page", page);
        return "modules/finance/rpt/fiDepositRechargedetails";
    }


    @ResponseBody
    @RequiresPermissions("rpt:finance:depositRecharge:export")
    @RequestMapping(value = "checkExportTask", method = RequestMethod.POST)
    public AjaxJsonEntity checkExportTask(RptSearchCondition rptSearchCondition) {
        AjaxJsonEntity result = new AjaxJsonEntity(true);
        try {
            User user = UserUtils.getUser();
            fiDepositRechargeSummaryRptService.checkRptExportTask(rptSearchCondition.getServicePointId(),rptSearchCondition.getSelectedYear(),rptSearchCondition.getSelectedMonth(),user);
    ...
    public AjaxJsonEntity export(RptSearchCondition rptSearchCondition) {
        ...
        try {
            ...
            fiDepositRechargeSummaryRptService.createRptExportTask(rptSearchCondition.getServicePointId(),rptSearchCondition.getSelectedYear(),rptSearchCondition.getSelectedMonth(),user);
    ...
    public AjaxJsonEntity checkExportDetalis(RptSearchCondition rptSearchCondition) {
        ...
        try {
            ...
            fiDepositRechargeSummaryRptService.checkExportTask(rptSearchCondition.getActionType(),
    ...
    public AjaxJsonEntity exportDetalis(RptSearchCondition rptSearchCondition) {
        ...
        try {
            ...
            fiDepositRechargeSummaryRptService.createExportTask(rptSearchCondition.getActionType(),
                    rptSearchCondition.getBeginDate(), rptSearchCondition.getEndDate(), rptSearchCondition.getServicePointId(),user);
            result.setMessage("报表导出任务创建成功，请前往'报表中心->报表下载'功能下载");
