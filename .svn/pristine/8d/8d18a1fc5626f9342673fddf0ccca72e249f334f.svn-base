...
<body>
	...
	<form:form id="searchForm" modelAttribute="order" action="${ctx}/sd/order/engineer/returnlist" method="post" class="breadcrumb form-search">
		...
		<div style="margin-top: 8px;">
			...
			<label>~</label>&nbsp;&nbsp;&nbsp;<input id="acceptEndDate" name="acceptEndDate"
				...
				onclick="WdatePicker({dateFmt:'yyyy-MM-dd',isShowClear:false});" />
			&nbsp;&nbsp; <label>退单时间：</label><input id="completeBegin"
