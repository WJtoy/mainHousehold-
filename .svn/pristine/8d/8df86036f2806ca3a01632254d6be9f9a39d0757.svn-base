...
<%@ attribute name="engineerName" type="java.lang.String" required="false" description="安维师傅姓名"%>
<%@ attribute name="contactInfo" type="java.lang.String" required="false" description="安维师傅电话"%>
...
<script type="text/javascript">
	$("#${id}Button").click(function(){
        ...
        var replyIdex = top.layer.open({
            ...
            zIndex:19891015,
            title:'选择${title}',
            content: "${ctx}/md/engineer/selectForKefu?name=${engineerName}&contactInfo=${contactInfo}&searchType=1",
            shade: 0.3,
