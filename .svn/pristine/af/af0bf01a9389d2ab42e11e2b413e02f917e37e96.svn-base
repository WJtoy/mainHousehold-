...
import com.wolfking.jeesite.ms.providerrpt.service.MSCreatedOrderRptService;
...
@Controller
@RequestMapping("${adminPath}/rpt/provider/createdOrderWork/")
public class MSCreatedOrderController extends BaseRptController {

    @Autowired
    private SystemService systemService;

    @Autowired
    private MSCreatedOrderRptService msCreatedOrderRptService;
     ...
     * @return
     */
    @RequestMapping(value = "createdOrderRpt")
    public String createdOrderWorkRpt(RptSearchCondition rptSearchCondition,Model model) {
        List<RPTOrderDailyWorkEntity> list = Lists.newArrayList();
        ...
        if (rptSearchCondition.isSearching()) {
            ...
            if (productCategoryIds.isEmpty() &&
                ...
                list = msCreatedOrderRptService.getCreatedOrderSource(rptSearchCondition.getSelectedYear(), rptSearchCondition.getSelectedMonth(),
                        rptSearchCondition.getCustomerId(), productCategoryIds);
            }
        }
        rptSearchCondition.setList(list);
        model.addAttribute("productCategoryList", productCategoryList);
        return "modules/providerrpt/orderSourceRpt";
    }
    ...
    public AjaxJsonEntity checkExportTask(RptSearchCondition rptSearchCondition) {
        ...
        try {
            ...
            msCreatedOrderRptService.checkRptExportTask(rptSearchCondition.getCustomerId(),
    ...
    public AjaxJsonEntity export(RptSearchCondition rptSearchCondition) {
        ...
        try {
            ...
            msCreatedOrderRptService.createRptExportTask(rptSearchCondition.getCustomerId(), productCategoryIds, rptSearchCondition.getSelectedYear(), rptSearchCondition.getSelectedMonth(), user);
    ...
    @RequestMapping(value = "orderSourceChartRpt")
    public String orderDailyWorkChart(RptSearchCondition rptSearchCondition, Model model) {
        ...
        if (rptSearchCondition.isSearching()) {
            ...
            if (productCategoryIds.isEmpty() &&
                ...
                map = msCreatedOrderRptService.turnToChartInformation(rptSearchCondition.getSelectedYear(), rptSearchCondition.getSelectedMonth(), rptSearchCondition.getCustomerId(),
                        productCategoryIds);
            }
        }
        model.addAttribute("createDates", map.get("createDates"));
        model.addAttribute("orderCreateDates", map.get("orderCreateDates"));
        model.addAttribute("manualOrders", map.get("manualOrders"));
        model.addAttribute("manualOrderRates", map.get("manualOrderRates"));
        model.addAttribute("b2bOrderRates", map.get("b2bOrderRates"));
        model.addAttribute("tmOrders", map.get("tmOrders"));
        model.addAttribute("pddOrders", map.get("pddOrders"));
        model.addAttribute("jdOrders", map.get("jdOrders"));
        model.addAttribute("restOrders", map.get("restOrders"));
        model.addAttribute("daySums", map.get("daySums"));
        model.addAttribute("productCategoryList", productCategoryList);
        return "modules/providerrpt/orderSourceChartRpt";
    }
}
