...
public interface MSProductInsuranceFeign {
    ...
    @GetMapping("productInsurance/getIdByCategoryId/{productCategoryId}")
    MSResponse<Long> getIdByCategoryId(@PathVariable("productCategoryId") Long productCategoryId);
