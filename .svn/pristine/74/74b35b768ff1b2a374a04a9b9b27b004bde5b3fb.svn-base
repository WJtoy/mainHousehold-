...
public class OrderFeeAdapter extends TypeAdapter<OrderFee> {
        ...
        while (in.hasNext()) {
            switch (in.nextName()) {
                ...
                case "engineerUrgentCharge":
                    ...
                    break;
                case "engineerDeposit"://2021/02/22
                    if(in.peek() == null){
                        in.nextNull();
                        fee.setEngineerDeposit(0.00);
                    }else{
                        fee.setEngineerDeposit(in.nextDouble());
                    }
                    break;
    ...
    public void write(final JsonWriter out, final OrderFee fee) throws IOException {
        ...
        out.name("engineerServiceCharge").value(fee.getEngineerServiceCharge())
                ...
                .name("engineerDeposit").value(fee.getEngineerDeposit())//2021/02/22
