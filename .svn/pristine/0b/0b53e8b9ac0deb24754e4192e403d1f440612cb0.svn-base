...
<ul id="navtabs" class="nav nav-tabs">
    ...
    <li class="active"><a href="javascript:void(0);" title="等配件的订单列表">等配件</a></li>
...
<form:form id="searchForm" modelAttribute="order" action="${ctx}/sd/order/servicePointOrderList/waitingAccessoryList"
