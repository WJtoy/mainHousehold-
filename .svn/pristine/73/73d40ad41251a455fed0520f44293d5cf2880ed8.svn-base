...
<ul id="navtabs" class="nav nav-tabs">
    <shiro:hasPermission name="sd:reminder:view">
        ...
        <li class="active"><a href="javascript:void(0);" title="工单完成催单列表">完成</a></li>
        <li><a href="${ctx}/sd/reminder/list/all" title="所有催单列表">所有</a></li>
    </shiro:hasPermission>
</ul>
<c:set var="currentuser" value="${fns:getUser() }"/>
<form:form id="searchForm" modelAttribute="reminder" action="${ctx}/sd/reminder/list/complete" method="post" class="breadcrumb form-search">
    ...
    <table id="contentTable" class="table table-striped table-bordered table-condensed table-hover" style="table-layout:fixed;">
        ...
        <c:forEach items="${page.list}" var="model">
            ...
            <tr>
                ...
                <td>
                    <c:if test="${model.handleTimeLiness>0}">
                        <c:set var="cutoffClass" value="normal"/>
                        <c:choose>
