...
<ul id="navtabs" class="nav nav-tabs">
    <shiro:hasPermission name="sd:servicepointpraise:view">
        <li class="active"><a href="javascript:void(0);" title="待处理">待审核</a></li>
...
<form:form id="searchForm" modelAttribute="praisePageSearchModel" action="${ctx}/servicePoint/receipt/praise/pendingReviewList" method="post" class="form-inline">
