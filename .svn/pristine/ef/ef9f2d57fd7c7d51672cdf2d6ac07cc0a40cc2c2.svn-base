...
<body>
	<ul class="nav nav-tabs">
		<li>
			<a href="${ctx}/md/urgentcustomer/list">列表</a>
		</li>
		<li class="active">
			<a href="javascript:void(0);">添加</a>
		</li>
	</ul><br>
	<form:form id="inputForm" modelAttribute="urgentCustomer" action="${ctx}/md/urgentcustomer/saveUrgentCustomers" method="post" class="form-horizontal">
