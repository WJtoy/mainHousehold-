...
<form:form id="searchForm" modelAttribute="order" action="${ctx}/sd/order/servicePointOrderList/completedList" method="post" class="breadcrumb form-search">
    ...
    <div>
        <label>订单号：</label>&nbsp;<input type=text class="input-small" id="orderNo" name="orderNo" value="${order.orderNo}" maxlength="20"/>
        <label>联系人：</label><input type=text class="input-small" id="userName" name="userName" value="${order.userName}" maxlength="20"/>
        <label>电 话：</label><input type=text class="input-small" id="userPhone" name="userPhone" value="${order.userPhone}" maxlength="20"/>
        <label>安维：</label>
    ...
    <div style="margin-top: 8px;">
        ...
        &nbsp;&nbsp;
        <label>完成时间：</label>
        <input id="completeDateRange" name="completeDateRange" type="text" style="width:185px;margin-left:4px" maxlength="25" class="input-xlarge Wdate"
