...
public interface MSMaterialFeign {
    ...
    @GetMapping("/material/findIdAndNameByCategoryId/{categoryId}")
    MSResponse<List<NameValuePair<Long,String>>> findIdAndNameByCategoryId(@PathVariable("categoryId") Long categoryId);

    @PostMapping("/material/save")
    MSResponse<Long> save(@RequestBody MDMaterial mdMaterial);
}
