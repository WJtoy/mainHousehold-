...
<html>
  <head>
	...
	<script type="text/javascript">
		...
		function editCustomerMaterial(type,id) {
			var text = "添加配件";
			var url = "${ctx}/md/customerMaterialNew/form";
			var area = ['1392px', '800px'];
			if(type == 20){
				text = "修改";
				url = "${ctx}/md/customerMaterialNew/form?id="+ id;
			}
			top.layer.open({
				type: 2,
				id:"completePic",
  ...
  <body>
	...
	<form:form id="searchForm" modelAttribute="customerMaterial" action="${ctx}/md/customerMaterialNew/list" method="post" class="breadcrumb form-search">
		...
		<c:forEach items="${page.list}" var="entity">
			<tr>
				...
				<shiro:hasPermission name="md:customermaterial:edit"><td>
					...
					&nbsp;&nbsp;
					<a href="#" onclick="deleteCustomerMaterials('${entity.id}','${entity.customer.id}','${entity.product.id}','${entity.material.id}','${entity.material.name}')">删除</a>
