...
public interface XYYPlusOrderFeign {
    ...
    MSResponse orderCancelApply(@RequestBody XYYOrderCancelApply orderCancelApply);
    ...
    MSResponse orderCancelAudit(@RequestBody XYYOrderCancelAudit orderCancelAudit);
    ...
    MSResponse orderStatus(@RequestBody XYYOrderStatus orderStatus);
    ...
    MSResponse orderCompleteApply(@RequestBody XYYOrderCompleteApply orderCompleteApply);
