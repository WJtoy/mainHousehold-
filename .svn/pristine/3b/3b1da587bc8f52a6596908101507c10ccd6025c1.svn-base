    ...
    <script type="text/javascript" language="javascript">
        $(document).ready(function () {
            ...
            $("#btnSubmit").click(function () {
                ...
                $("#searchForm").attr("action", "${ctx}/finance/rpt/customerCharge/customerChargeSummaryRpt");
                $("#searchForm").submit();
            });
...
<ul class="nav nav-tabs">
    ...
    <li>
        <a href="${ctx}/finance/rpt/customerCharge/customerChargeCompleteReport">完工单</a>
    </li>
    <li>
