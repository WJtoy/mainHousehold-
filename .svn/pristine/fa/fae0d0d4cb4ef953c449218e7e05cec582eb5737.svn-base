...
<ul id="navtabs" class="nav nav-tabs">
    <shiro:hasPermission name="sd:servicepointpraise:view">
        ...
        <li class="active"><a href="javascript:void(0);" title="已审核">驳回</a></li>
...
<form:form id="searchForm" modelAttribute="praisePageSearchModel" action="${ctx}/servicePoint/receipt/praise/rejectList" method="post" class="form-inline">
    ...
    <table id="contentTable" class="table table-bordered table-condensed table-hover">
        ...
        <c:forEach items="${page.list}" var="model">
            ...
            <tr>
                ...
                <td>${fns:getDictLabelFromMS(model.rejectionCategory,'praise_abnormal_type','Unknow')}</td>
                <td>${model.remarks}</td>
