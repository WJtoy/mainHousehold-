...
@Slf4j
@Component
public class B2BCenterModifyKKLOrderMQReceiver implements ChannelAwareMessageListener {
...
//                    b2BCenterModifyKKLOrderMQSender.sendRetry(modifyMessage, 1);
//                }
            }
        } catch (Exception e) {
            log.error("B2BCenterModifyKKLOrderMQReceiver - {}", e);
        }
    }
}
