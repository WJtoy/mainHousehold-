...
<form:form id="inputForm" modelAttribute="office" action="${ctx}/sys/office/save" method="post" class="form-horizontal">
    ...
    <div class="control-group">
        ...
        <div class="controls">
            ...
            <sys:areaSelectFourLevel id="area" name="area.id"  value="${office.area.id}" levelValue=""
                                     labelValue="${office.area.fullName}" labelName="area.fullName" title=""
    ...
    <div class="control-group">
        ...
        <div class="controls">
            <form:select path="type" class="input-medium">
                <form:options items="${fns:getDictListFromMS('sys_office_type')}" itemLabel="label" itemValue="value"
    ...
    <div class="control-group">
        ...
        <div class="controls">
            <form:select path="grade" class="input-medium">
                <form:options items="${fns:getDictListFromMS('sys_office_grade')}" itemLabel="label" itemValue="value"
                              htmlEscape="false"/><%-- 切换为微服务 --%>
            </form:select>
        </div>
    </div>
    <div class="control-group">
        ...
        <div class="controls">
            <form:select path="useable">
                <form:options items="${fns:getDictListFromMS('yes_no')}" itemLabel="label" itemValue="value"
                              htmlEscape="false"/><%--切换为微服务--%>
            </form:select>
        </div>
    </div>
    ...
    <c:if test="${empty office.id}">
        <div class="control-group">
            ...
            <div class="controls">
                <form:checkboxes path="childDeptList" items="${fns:getDictListFromMS('sys_office_common')}" itemLabel="label"
