...
public class MSEngineerFeignFallbackFactory implements FallbackFactory<MSEngineerFeign> {
    ...
    public MSEngineerFeign create(Throwable throwable) {
        return new MSEngineerFeign() {
             ...
             */
            @Override
            public MSResponse<Integer> reloadEngineerCacheById(Long id) {
                return new MSResponse<>(MSErrorCode.FALLBACK_FAILURE);
            }
             ...
             */
            @Override
            public MSResponse<MSPage<MDEngineerDto>> findEngineerListForSD(MDEngineerDto mdEngineerDto) {
                return new MSResponse<>(MSErrorCode.FALLBACK_FAILURE);
            }
             ...
             */
            @Override
            public MSResponse<MSPage<MDEngineerDto>> findEngineerListForAPI(MDEngineerDto mdEngineerDto) {
                return new MSResponse<>(MSErrorCode.FALLBACK_FAILURE);
            }
        };
    }
