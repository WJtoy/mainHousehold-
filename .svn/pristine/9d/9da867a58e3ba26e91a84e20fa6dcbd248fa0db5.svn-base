...
@Service
public class MSCustomerChargeRptService {
    ...
    public void checkRptExportTask(Long customerId,int selectedYear,int selectedMonth,User user) {
        ...
        reportExportTaskService.checkRptExportTask(RPTReportEnum.CUSTOMER_CHARGE_RPT, user, searchConditionJson);
    }
    ...
    public void createRptExportTask(Long customerId,int selectedYear,int selectedMonth,User user) {
        ...
        String searchConditionJson = RedisGsonUtils.toJson(searchCondition);
        reportExportTaskService.createRptExportTask(RPTReportEnum.CUSTOMER_CHARGE_RPT, RPTReportTypeEnum.FINANCE_REPORT, user, reportTitle, searchConditionJson);
    }
