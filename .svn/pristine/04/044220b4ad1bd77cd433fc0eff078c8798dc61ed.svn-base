...
public class WeberOrderService extends B2BOrderManualBaseService {
    ...
    public MSResponse processKKLOrder(B2BOrderProcessEntity processEntity) {
        ...
        try {
            ...
            B2BOrderProcessEntity.saveFailureLog(processEntity, "修改快可立工单", "WeberOrderService.processKKLOrder", e);
        }
    ...
    private boolean cancelKKLOrder(B2BOrderProcessEntity entity) {
        ...
        if (order != null && order.getOrderCondition() != null) {
            ...
            B2BOrderProcessEntity.saveFailureLog(entity, "读取工单失败", "WeberOrderService.cancelKKLOrder", null);
        }
        return result;
    }
