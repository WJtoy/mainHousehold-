...
import com.wolfking.jeesite.modules.finance.rpt.service.FiCompletedOrderRptService;
...
@Controller
@RequestMapping(value = "${adminPath}/finance/rpt/completedOrder/")
public class FiCompletedOrderRptController extends BaseRptController {

    @Autowired
    private FiCompletedOrderRptService fiCompletedOrderRptService;
     ...
     * @return
     */
    @RequiresPermissions("rpt:finance:completedOrderReport:view")
    ...
    public String completedOrderReport(RptSearchCondition rptSearchCondition, HttpServletRequest request, HttpServletResponse response, Model model) {
        ...
        if (rptSearchCondition.isSearching()) {
            ...
            if (productCategoryIds.isEmpty() &&
                ...
                page = fiCompletedOrderRptService.getCompletedOrderList(page, rptSearchCondition.getCustomerId(), paymentType,productCategoryIds, rptSearchCondition.getWarrantyStatus(),rptSearchCondition.getBeginDate(), rptSearchCondition.getEndDate());
            }
        }

        model.addAttribute("page", page);
        model.addAttribute("productCategoryList", productCategoryList);
        return "modules/finance/rpt/fiCompletedOrderReport";
    }


    @ResponseBody
    @RequiresPermissions("rpt:finance:completedOrderReport:export")
    ...
    public AjaxJsonEntity checkExportTask(RptSearchCondition rptSearchCondition) {
        ...
        try {
            ...
            fiCompletedOrderRptService.checkRptExportTask(rptSearchCondition.getCustomerId(), paymentType,productCategoryIds,rptSearchCondition.getWarrantyStatus(),rptSearchCondition.getBeginDate(), rptSearchCondition.getEndDate(), user);
    ...
    public AjaxJsonEntity export(RptSearchCondition rptSearchCondition) {
        ...
        try {
            ...
            fiCompletedOrderRptService.createRptExportTask(rptSearchCondition.getCustomerId(), paymentType,productCategoryIds,rptSearchCondition.getWarrantyStatus(),rptSearchCondition.getBeginDate(), rptSearchCondition.getEndDate(), user);
