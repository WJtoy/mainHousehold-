...
<ul id="navtabs" class="nav nav-tabs">
    ...
    <li class="active"><a href="javascript:void(0);">处理中</a></li>
    ...
    <li><a href="${ctx}/sd/order/servicepoint/allList" title="所有订单列表">所有</a></li>
</ul>
<c:set var="currentuser" value="${fns:getUser() }"/>
<form:form id="searchForm" modelAttribute="order" action="${ctx}/sd/order/servicepoint/processingList" method="post"
