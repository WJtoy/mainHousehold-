    ...
    function resend(){
        ...
        top.layer.confirm('确定重发吗？', {icon: 3, title:'系统确认'}, function(index){
            ...
            $.ajax({
                cache: false,
                type: "POST",
                url: "${ctx}/b2b/rpt/processlog/jdCancelRetry",
                dataType: 'json',
    ...
    function closeme(){
        ...
        top.layer.confirm('确定忽略本条信息吗？', {icon: 3, title:'系统确认'}, function(index){
            ...
            $.ajax({
                cache: false,
                type: "POST",
                url: "${ctx}/b2b/rpt/processlog/jdCancelCloseLog",
...
<body>
<form:form id="inputForm" modelAttribute="completedRetryBean" action="${ctx}/b2b/rpt/processlog/jdCancelForm" method="post" class="form-horizontal">
