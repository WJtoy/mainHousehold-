    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            $("#inputForm").validate({
                submitHandler: function(form){
                    ...
                    $.ajax({
                        url:"${ctx}/customer/md/customerProduct/save",
                        type:"POST",
                        data:$(form).serialize(),
                        dataType:"json",
        ...
        $(document).on('change',"#productId",function (e) {
            ...
            if (productId !=null && productId !='' && productId != '0') {
                ...
                if (customerId != null && customerId !='' && customerId !='0') {
                    $.ajax({
                        url: "${ctx}/customer/md/customerProduct/ajax/form",
                ...
                <div class="controls">
                    <c:choose>
                        <c:when test="${customerProduct.customerDto.id> 0}">
                            <input type="hidden" id="customerId" name="customer.id" value="${customerProduct.customerDto.id}">
