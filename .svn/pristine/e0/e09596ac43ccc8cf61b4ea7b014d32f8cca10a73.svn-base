...
@Service
public class FiFinancialReviewDetailsRptService {
    ...
    public void checkRptExportTask(Date beginDate, Date endDate, User user) {
        ...
        fiReportExportTaskService.checkRptExportTask(RPTReportEnum.FI_FINANCIAL_REVIEW_DETAILS_RPT, user, searchConditionJson);
    }
    ...
    public void createRptExportTask(Date beginDate, Date endDate,User user) {
        ...
        String searchConditionJson = RedisGsonUtils.toJson(search);
        fiReportExportTaskService.createRptExportTask(RPTReportEnum.FI_FINANCIAL_REVIEW_DETAILS_RPT, RPTReportTypeEnum.ORDER_REPORT, user, reportTitle, searchConditionJson);
    }
