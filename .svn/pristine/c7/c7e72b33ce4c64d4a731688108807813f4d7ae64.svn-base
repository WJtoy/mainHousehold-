    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $("#btnSubmit").on("click", function(){
                ...
                var url = "${ctx}/customer/fi/customerCurrency/customerofflinelist?firstSearch=" + firstSearch;
...
<form:form id="searchForm" modelAttribute="search" action="${ctx}/customer/fi/customerCurrency/customerofflinelist" method="post" class="breadcrumb form-search">
