package com.wolfking.jeesite.ms.joyoung.rpt.service;
...
public class JoyoungFailLogService {


    @Autowired
    private MSJoyoungFailLogRptFeign msFailLogRptFeign;
    ...
    //获取状态信息列表
    public Page<B2BOrderProcesslog> getFailLogList(Page<JDSearchModel> page, JoyoungSearchModel jdSearchModel){
