...
public class OrderCondition extends LongIDDataEntity<OrderCondition> {
    ...
    public static final int COMMON_KEFU_TYPE = 0; //大客服
    public static final int AUTOMATIC_KEFU_TYPE = 1;//自动客服
    public static final int RUSH_KEFU_TYPE = 2; //突击客服
    public static final int VIP_KEFU_TYPE = 3; //vip客服
    ...
    //客服类型 0:大客服 1:自动客服 2:突击客服
    private Integer kefuType = 0;

    @GsonIgnore
    private String verifyCode = ""; // 验证码：云米工单退单申请需要输入验证码
