...
<form:form id="searchForm" modelAttribute="rptSearchCondition" action="${ctx}/rpt/provider/exportTask/list"
            ...
            <tr>
                ...
                <td>
                    <c:if test="${item.status >= 40}">
                        <a class="btn btn-success" href="${ctx}/rpt/provider/exportTask/downloadReportExcel?taskId=${item.id}">下载</a>
                    </c:if>
                </td>
