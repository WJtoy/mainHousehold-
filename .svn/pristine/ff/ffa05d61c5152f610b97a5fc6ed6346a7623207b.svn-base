...
<head>
	...
	<%@ include file="/WEB-INF/views/modules/sd/kefuOrderList/service/tpl/orderDetailFollowUp.html" %>
							...
							<td class="tdbody">
								<c:if test="${order.orderCondition.servicePoint.mdDepositLevel!=null and order.orderCondition.servicePoint.mdDepositLevel.id>0}">
									...
									<span class="${depositLevelLabel}" style="padding: 4px 5px;">
                                        <a style="text-decoration:none;color: white" data-toggle="tooltipSouth" data-tooltip="${depositInfo}">
