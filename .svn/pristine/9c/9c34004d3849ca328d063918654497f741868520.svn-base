...
@Service
public class CtCustomerNewOrderMonthRptService {
    @Autowired
    private CtCustomerNewOrderMonthRptFeign ctCustomerNewOrderMonthRptFeign;
     ...
     * 从rpt微服务中获取客户每日下单数据
     */
    public Page<RPTCustomerNewOrderDailyRptEntity> getCustomerNewOrderMonthRptList(Page<RPTCustomerNewOrderDailyRptEntity> page, Long customerId, Long saleId, Integer selectedYear,Integer selectedMonth) {
        ...
        if (microServicesProperties.getReport().getEnabled()) {
            MSResponse<MSPage<RPTCustomerNewOrderDailyRptEntity>> customerNewOrderDailyRptList = ctCustomerNewOrderMonthRptFeign.getCustomerNewOrderMonthRptList(rptSearchCondtion);
    ...
    public void checkRptExportTask(Long customerId, Long saleId, Integer selectedYear,Integer selectedMonth, User user) {
        ...
        ctReportExportTaskService.checkRptExportTask(RPTReportEnum.CT_CUSTOMER_NEW_ORDER_MONTH_RPT, user, searchConditionJson);
    }
    ...
    public void createRptExportTask(Long customerId, Long saleId, Integer selectedYear,Integer selectedMonth, User user) {
        ...
        String searchConditionJson = RedisGsonUtils.toJson(searchCondition);
        ctReportExportTaskService.createRptExportTask(RPTReportEnum.CT_CUSTOMER_NEW_ORDER_MONTH_RPT, RPTReportTypeEnum.ORDER_REPORT, user, reportTitle, searchConditionJson);
    }
