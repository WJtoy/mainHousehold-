...
<ul class="nav nav-tabs">
    <li><a href="/provider/md/customerProductModel/getList">产品型号</a></li>
    <li class="active"><a href="javascript:void(0);">批量添加</a></li>
</ul>
<c:set var="currentuser" value="${fns:getUser()}"/>
<form:form id="searchForm" modelAttribute="customerProductModel" action="${ctx}/provider/md/customerProductModel/importForm" method="post" class="form-search"
