...
<head>
    ...
    <script type="text/javascript">
        ...
        $(document).on("click", "#btnClearSearch", function () {
            ...
            $("#customerOrderNo").val("");
            $("#reminderFlag").prop("checked",false);
            search();
            //page(1, 10);
        });
...
<form:form id="searchForm" modelAttribute="order" action="${ctx}/sd/finance/customerOrder/finishlist" method="post"
