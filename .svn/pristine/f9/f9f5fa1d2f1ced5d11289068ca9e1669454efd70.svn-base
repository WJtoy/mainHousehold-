...
<head>
    ...
    <style type="text/css">
        ...
        .table thead th, .table tbody td {text-align: center;vertical-align: middle;background-color: Transparent;}
    </style>
...
<ul id="navtabs" class="nav nav-tabs">
    ...
    <li class="active"><a href="javascript:void(0);">待完成</a></li>
...
<form:form id="searchForm" modelAttribute="order" action="${ctx}/sd/order/servicePointOrderList/servicedList" method="post" class="breadcrumb form-search">
        ...
        <tr>
            ...
            <td>
                <c:if test="${order.orderCondition.finishPhotoQty > 0 }">
                    <a href="javascript:void(0);" onclick="Order.photolistNew('${order.id}','${order.quarter}',${fns:isNewOrder(order.orderNo)});"
            ...
            <td>
                ...
                <a style="padding-left: 20px;" target="_blank" href="http://wpa.qq.com/msgrd?v=3&uin=${order.orderCondition.kefu.qq}&site=qq&menu=yes">
                    <img border="0" src="http://wpa.qq.com/pa?p=2:572202493:52" alt="点这发消息" title="联系客服QQ${order.orderCondition.kefu.qq}"/>
                </a>
