    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $(document).on('change',"#errorTypeId",function (e) {
                ...
                $.ajax({
                    url:"${ctx}/provider/md/customerErrorCode/ajax/findListByProductIdAndErrorTypeId?productId=" + productId+"&errorTypeId="+errorTypeId +"&customerId=" + customerId,
                    success:function (e) {
                        if(e.success){
                            $("#errorCodeId").empty();
                            var programme_sel=[];
            ...
            $("#btnAdd").on("click",function(){
                ...
                var url = "${ctx}/provider/md/customerErrorAction/save";
            ...
            $("#btnQuery").on("click",function(){
                ...
                $("#name").rules("remove");
                var url = "${ctx}/provider/md/customerErrorAction/findListForActionCode";
                $("#searchForm").attr("action",url);
                $("#searchForm").submit();
                return false;
            });
    ...
    <c:forEach items="${page.list}" var="entity">
        <tr>
            ...
            <td style="text-align: center;">
                <shiro:hasPermission name="md:customererroraction:edit">
                <a style="margin-left: 6px;" href="${ctx}/provider/md/customerErrorAction/deleteForActionCode?id=${entity.id}&productId=${entity.productId}&actionCodeId=${entity.actionCodeDto.id}&customerId=${entity.customerId}"
