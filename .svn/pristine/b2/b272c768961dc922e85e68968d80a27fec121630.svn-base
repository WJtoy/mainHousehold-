...
import com.wolfking.jeesite.modules.servicepoint.sd.dao.ProcessOrderListDao;
...
public class ServicePointProcessOrderListService extends OrderRegionService {

    @Resource
    private ProcessOrderListDao processOrderListDao;
     ...
     * 分页查询订单-待接单/待派单
     */
    public Page<Order> findKefuPlaningOrderList(OrderSearchModel entity, boolean getComplainFormStatus) {
        List<Order> list = processOrderListDao.findPlaningOrderList(entity);
        return getOrderItems(entity.getPage(), list, getComplainFormStatus, false);
    }

    /**
     * 分页查询订单-未预约
     */
    public Page<Order> findKefuNoAppointmentOrderList(OrderSearchModel entity,boolean getComplainFormStatus) {
        List<Order> list = processOrderListDao.findKefuNoAppointmentOrderList(entity);
        return getOrderItems(entity.getPage(), list, getComplainFormStatus, false);
    }
     ...
     * 分页查询订单-预约到期
     */
    public Page<Order> findKefuArriveAppointmentOrderList(OrderSearchModel entity, boolean getComplainFormStatus) {
        List<Order> list = processOrderListDao.findKefuArriveAppointmentOrderList(entity);
        return getOrderItems(entity.getPage(), list, getComplainFormStatus, false);
    }
     ...
     */
    public Page<Order> findKefuPassAppointmentOrderList(OrderSearchModel entity,
                                                        boolean getComplainFormStatus) {
        List<Order> list = processOrderListDao.findKefuPassAppointmentOrderList(entity);
        return getOrderItems(entity.getPage(), list, getComplainFormStatus, false);
    }
     ...
     * 分页查询客服负责的订单-停滞订单
     */
    public Page<Order> findKefuPendingOrderList(OrderSearchModel entity,boolean getComplainFormStatus) {
        List<Order> list = processOrderListDao.findKefuPendingOrderList(entity);
        return getOrderItems(entity.getPage(), list, getComplainFormStatus, false);
    }
     ...
     * 分页查询客服负责的订单-待回访
     */
    public Page<Order> findKefuServicedOrderList( OrderSearchModel entity,
                                                 boolean getComplainFormStatus) {
        List<Order> list = processOrderListDao.findKefuServicedOrderList(entity);
        return getOrderItems(entity.getPage(), list, getComplainFormStatus, false);
    }
     ...
     * 分页查询客服负责的订单-回访失败
     */
    public Page<Order> findKefuFollowUpFailOrderList(OrderSearchModel entity, boolean getComplainFormStatus) {
        List<Order> list = processOrderListDao.findKefuFollowUpFailOrderList(entity);
        return getOrderItems(entity.getPage(), list, getComplainFormStatus, false);
    }
     ...
     * 分页查询客服负责的订单-未完成
     */
    public Page<Order> findKefuUncompletedOrderList(OrderSearchModel entity, boolean getComplainFormStatus) {
        List<Order> list = processOrderListDao.findKefuUncompletedOrderList(entity);
        return getOrderItems(entity.getPage(), list, getComplainFormStatus, false);
    }
     ...
     * 分页查询客服负责的订单-所有订单
     */
    public Page<Order> findKefuAllOrderList(OrderSearchModel entity, boolean getComplainFormStatus) {
        List<Order> list = processOrderListDao.findKefuAllOrderList(entity);
        return getOrderItems(entity.getPage(), list, getComplainFormStatus, true);
    }

    /**
     * 分页查询客服负责的订单-完成订单
     */
    public Page<Order> findKefuCompletedOrderList(OrderSearchModel entity, boolean getComplainFormStatus) {
        List<Order> list = processOrderListDao.findKefuCompletedOrderList(entity);
        return getOrderItems(entity.getPage(), list, getComplainFormStatus, true);
    }
    ...
    public Page<Order> getBrokeAppointmentOrderlist(Page<OrderSearchModel> page, OrderSearchModel searchModel) {
        ...
        if (searchModel.getOrderNoSearchType() == 1 || searchModel.getIsPhone() == 1) {
            orderList = processOrderListDao.getBrokeAppointmentOrderlistNew(searchModel);
        } else {
            searchModel = getEngineerNameAndContactInfo(searchModel);  // add on 2019-10-29
            orderList = processOrderListDao.getBrokeAppointmentOrderlist(searchModel);
        }
        Page<Order> rtnPage = new Page<>(page.getPageNo(), page.getPageSize(), page.getCount());
        if (orderList != null && !orderList.isEmpty()) {
            setBrokenOrderProperties(orderList);
            setBrokenComplainFormStatus(orderList);
    ...
    private void setBrokenComplainFormStatus(List<Order> orderList) {
        if (orderList != null && !orderList.isEmpty()) {
    ...
    private void setBrokenOrderProperties(List<Order> orderList) {
        if (orderList != null && !orderList.isEmpty()) {
    ...
    public Page<TmallAnomalyRecourse> findKefuTmallAnomalyList(Page<TmallAnomalyRecourseSearchVM> page, TmallAnomalyRecourseSearchVM entity) {
        entity.setPage(page);
        List<TmallAnomalyRecourse> list = processOrderListDao.findKefuTmallAnomalyList(entity);
    ...
    public Page<TmallServiceMonitor> findKefuTmallServiceMonitorList(Page<TmallServiceMonitor> page, TmallServiceMonitorSearchVM entity) {
        ...
        List<TmallServiceMonitor> list = processOrderListDao.findKefuTmallServiceMonitorList(entity);
     ...
     * 分页查询客服负责的订单-突击中
     */
    public Page<Order> findKefuRushingOrderList( OrderSearchModel entity, boolean getComplainFormStatus) {
        List<Order> list = processOrderListDao.findKefuRushingOrderList(entity);
        return getOrderItems(entity.getPage(), list, getComplainFormStatus, false);
    }
     ...
     * 分页查询客服负责的订单-投诉单
     */
    public Page<Order> findKefuComplainOrderList(OrderSearchModel entity, boolean getComplainFormStatus) {
        List<Order> list = processOrderListDao.findKefuComplainOrderList(entity);
        return getOrderItems(entity.getPage(), list, getComplainFormStatus, false);
    }
     ...
     * 分页查询客服负责的订单-催单
     */
    public Page findReminderOrderLit(OrderSearchModel entity, boolean getComplainFormStatus) {
        List<Order> list = processOrderListDao.findReminderOrderLit(entity);
        Page<Order> rtnPage = getOrderItems(entity.getPage(), list, getComplainFormStatus, false);
        // 催单时效
    ...
    public Page getHistoryPlanListForKefu(Page page, OrderSearchModel searchModel) {
        ...
        List<HistoryPlanOrderModel> list = processOrderListDao.findHistoryPlaningOrderList(searchModel);
        if(list == null){
    ...
    private void setServicePointBalance(List<Order> orderList, Set<Long> servicePointIds) {
        if (!orderList.isEmpty() && !servicePointIds.isEmpty()) {
            List<ServicePointFinance> financeList = processOrderListDao.getBalanceInfoByServicePointIds(Lists.newArrayList(servicePointIds));
    ...
    private void setComplainFormStatus(List<Order> orderList, Map<String, List<Long>> complainOrderIdMap) {
        if (!orderList.isEmpty() && !complainOrderIdMap.isEmpty()) {
            ...
            for (Map.Entry<String, List<Long>> item : complainOrderIdMap.entrySet()) {
                complainStatusList = processOrderListDao.getComplainStatusByOrderIds(item.getKey(), item.getValue());
                if (complainStatusList != null && !complainStatusList.isEmpty()) {
    ...
    public void addDetailForFollowUp(OrderDetail detail) {
        ...
        try {
            ...
            if(isRemoteArea) {
                ...
                if (priceMap == null) {
                    throw new OrderException("网点[远程]价格读取失败，请重试");
                }
                if (CollectionUtils.isEmpty(priceMap)) {
                    throw new OrderException("网点[远程]价格读取失败，未维护网点价格");
                }
    ...
    public String loadAndCheckUserRegions(RegionSearchModel searchModel, User user) {
        ...
        //2.未选择区域
        com.google.common.base.Supplier<Stream<UserRegion>> streamSupplier = () -> regions.stream();
    ...
    public List<OrderInsurance> getOrderInsurance(Long orderId,String quarter){
        return kefuOrderListService.getOrderInsurance(orderId,quarter);
    }
}
