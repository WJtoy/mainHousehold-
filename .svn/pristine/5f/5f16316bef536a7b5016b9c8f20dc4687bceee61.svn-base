...
public class ServicePoint extends LongIDDataEntity<ServicePoint> {
    ...
    private Integer appFlag;   //网点手机接单  //add on 2020-6-11

    private Double deposit = 0.0D;       // 网点应缴质保金
    /**
     *质保金
     */
    private Integer depositFromOrderFlag = 0;//是否从工单扣除质保金标识,0-否,1-是

    private MDDepositLevel mdDepositLevel;

    private Integer remotePriceFlag; //偏远价格标识,0-标准,1-自定义

    private Integer remotePriceType; //偏远价格类型(轮次)

    private Integer remotePriceEnabledFlag; //偏远价格启用标识、
    private Integer remotePriceReference;   // 偏远价格参考
    ...
    @Length(max = 100, message = "营业执照附件路径长度不能超过100")
    ...
    public Integer getDepositFromOrderFlag() {
        return depositFromOrderFlag;
    }

    public void setDepositFromOrderFlag(Integer depositFromOrderFlag) {
        this.depositFromOrderFlag = depositFromOrderFlag;
    }

    public MDDepositLevel getMdDepositLevel() {
        return mdDepositLevel;
    }

    public void setMdDepositLevel(MDDepositLevel mdDepositLevel) {
        this.mdDepositLevel = mdDepositLevel;
    }
    ...
    public Integer getRemotePriceFlag() {
        return remotePriceFlag;
    }

    public void setRemotePriceFlag(Integer remotePriceFlag) {
        this.remotePriceFlag = remotePriceFlag;
    }

    public Integer getRemotePriceType() {
        return remotePriceType;
    }

    public void setRemotePriceType(Integer remotePriceType) {
        this.remotePriceType = remotePriceType;
    }

    public Integer getRemotePriceEnabledFlag() {
        return remotePriceEnabledFlag;
    }

    public void setRemotePriceEnabledFlag(Integer remotePriceEnabledFlag) {
        this.remotePriceEnabledFlag = remotePriceEnabledFlag;
    }
    ...
    public Integer getRemotePriceReference() {
        return remotePriceReference;
    }

    public void setRemotePriceReference(Integer remotePriceReference) {
        this.remotePriceReference = remotePriceReference;
    }
}
