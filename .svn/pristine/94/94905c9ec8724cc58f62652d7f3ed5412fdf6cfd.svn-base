...
<head>
    ...
    <script type="text/javascript">
        ...
        function editBrand(id, customerId, customerName, brandId, brandName) {
            var text = "添加品牌";
            var url = "${ctx}/customer/md/customerBrandCategory/form";
            if(id != null){
                text = "修改品牌";
                url = "${ctx}/customer/md/customerBrandCategory/form?id="+id+"&customerId="+customerId+"&customerName="+customerName+"&brandId="+brandId+"&brandName="+brandName;
            }
            var area = ['598px', '382px'];
            top.layer.open({
                type: 2,
                id:"brand",
                zIndex:19,
        ...
        function removeCustomerBrand(id, customerId, productCategoryId, productId, brandId){
            layer.confirm(
                '确认要删除吗？',
                {
                    ...
                    $.ajax({
                        url: "${ctx}/customer/md/customerBrandCategory/delete?id="+id+"&customerId="+customerId+"&productCategoryId="+productCategoryId+"&productId="+productId+"&brandId="+brandId,
...
<form:form id="searchForm" modelAttribute="customerBrandCategory" action="${ctx}/customer/md/customerBrandCategory/getList" method="post" class="form-search">
