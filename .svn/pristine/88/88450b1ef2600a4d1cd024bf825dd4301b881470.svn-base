...
@Controller
@RequestMapping("${adminPath}/servicePoint/rpt/spDetailedReconciliation/")
public class SpServicePointReconciliationPptController extends BaseRptController {

    @Autowired
    private SpServicePointReconciliationPptService spServicePointReconciliationPptService;
    ...
    @RequiresPermissions("rpt:servicePoint:getNetworkReconciliationNew:view")
    ...
    public String getNetworkReconciliationNew(RptSearchCondition rptSearchCondition, HttpServletRequest request, HttpServletResponse response, Model model) {
        ...
        if (user.isEngineer()) {
            ...
            return "modules/servicePoint/rpt/spServicePointDetaileRpt";
        }
        ...
        if (rptSearchCondition.isSearching()) {
            ...
            if (productCategoryIds.isEmpty() &&
                ...
                page = spServicePointReconciliationPptService.getNrPointWriteOff(page, productCategoryIds, rptSearchCondition.getServicePointId(),
    ...
    @ResponseBody
    @RequiresPermissions("rpt:servicePoint:getNetworkReconciliationNew:export")
    ...
    public AjaxJsonEntity checkExportTaskNew(RptSearchCondition rptSearchCondition) {
        ...
        try {
            ...
            spServicePointReconciliationPptService.checkRptExportTask(rptSearchCondition.getServicePointId(),
    ...
    public AjaxJsonEntity exportNew(RptSearchCondition rptSearchCondition) {
        ...
        try {
            ...
            spServicePointReconciliationPptService.createRptExportTask(rptSearchCondition.getServicePointName(),rptSearchCondition.getServicePointId(),
                    productCategoryIds,rptSearchCondition.getSelectedYear(), rptSearchCondition.getSelectedMonth(), user);
