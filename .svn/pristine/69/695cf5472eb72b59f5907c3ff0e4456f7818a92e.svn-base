...
<html>
  ...
  <body style="padding: 12px;">
	<form:form id="searchForm" modelAttribute="user" action="${ctx}/md/servicepoint/findUserListByContactInfo" method="post" class="form-search" cssStyle="margin-top: 24px">
		<label>联系电话：</label>
