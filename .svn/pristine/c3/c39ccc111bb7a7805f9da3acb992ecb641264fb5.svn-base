...
<ul class="nav nav-tabs">
    <li><a href="${ctx}/customer/md/customertimeliness/customerList">时效费用</a>
    <li class="active"><a href="javascript:void(0);">加急费用</a>
</ul>

<form:form id="searchForm" modelAttribute="urgentCustomer" action="${ctx}/customer/md/urgentcustomer/customerList" method="post" class="breadcrumb form-search">
...
<table id="treeTable" class="table table-striped table-bordered table-condensed table-hover">
    ...
    <tr>
        ...
        <c:forEach items="${urgentLevelList}" var="entity">
            <th width="100">${entity.remarks}</th>
        </c:forEach>
