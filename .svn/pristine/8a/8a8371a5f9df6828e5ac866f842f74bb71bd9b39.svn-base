            ...
            $("#btnExport").click(function () {+
                top.$.jBox.confirm("确认要导出数据吗？", "系统提示", function (v, h, f) {
                    if (v == "ok") {
                        ...
                        $.ajax({
                            type: "POST",
                            url: "${ctx}/rpt/provider/servicePointCoverage/export?" + (new Date()).getTime(),
...
<ul class="nav nav-tabs">
    <li class="active"><a href="javascript:void(0);">网点覆盖区域</a></li>
    <li><a href="${ctx}/rpt/provider/servicePointCoverage/servicePointNoCoverageReport">网点未覆盖区域</a></li>
</ul>

<form:form id="searchForm"  action="${ctx}/rpt/provider/servicePointCoverage/export" method="post" class="breadcrumb form-search">
    <div>
        &nbsp;&nbsp;
