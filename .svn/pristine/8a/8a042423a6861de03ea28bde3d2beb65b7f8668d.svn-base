...
<ul id="navtabs" class="nav nav-tabs">
    <shiro:hasPermission name="sd:abnormal:view">
        ...
        <li class="active"><a href="javascript:void(0);" title="app异常">app异常</a></li>
...
<form:form id="searchForm" modelAttribute="abnormalForm" action="${ctx}/servicePoint/sd/abnormalForm/appAbnormalList" method="post" class="breadcrumb form-search">
