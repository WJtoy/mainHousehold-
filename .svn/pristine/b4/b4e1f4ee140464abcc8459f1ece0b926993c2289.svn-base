...
<ul id="navtabs" class="nav nav-tabs">
    <li class="active"><a href="javascript:void(0);" title="催单的工单">催单<span id="spn_order_count" class="badge badge-info">${page !=null ?page.count:''}</span></a></li>
...
<table id="contentTable" class="table table-bordered table-condensed table-hover">
    ...
    <c:forEach items="${page.list}" var="order">
        ...
        <tr>
            ...
            <!-- reminder-->
            <td rowspan="${rowspan}">${order.reminderDate}</td>
            <td rowspan="${rowspan}">
...
<%--                <p class="reminder_${cutoffClass}">${order.cutOffTimeLiness}</p>--%>
