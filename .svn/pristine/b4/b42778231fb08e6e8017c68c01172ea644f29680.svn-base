...
public class Area extends LongIDTreeEntity<Area> {
	...
	public static final Integer STATUS_ENABLE  = 0;  // 正常
	public static final Integer STATUS_DISABLE = 1;  // 停用
	...
	private Integer statusFlag = 0;  //状态标志，0-正常，1-停用
	private Integer childrenCount = 0;  //下一阶孩子数量
