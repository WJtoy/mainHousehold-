...
import com.wolfking.jeesite.ms.providerrpt.fallback.MSCustomerFinanceRptFeignFallbackFactory;
 ...
 * RPT微服务调用
 */
@FeignClient(name = "provider-rpt", fallbackFactory = MSCustomerFinanceRptFeignFallbackFactory.class)
public interface MSCustomerFinanceRptFeign {
    /**
     * 获取数据
     * @return
     */
    @GetMapping("/customerFinance/getCustomerFinanceRptList")
