		...
		$(document).ready(function()
		{
			$("#inputForm").validate({
					submitHandler: function(form){
						...
						$.ajax({
							url:"${ctx}/md/customertimeliness/save",
							type:"POST",
							data:$(form).serialize(),
							dataType:"json",
...
<body>
	<form:form id="inputForm" modelAttribute="customerTimeliness" action="${ctx}/md/customertimeliness/save" method="post" class="form-horizontal">
	...
	<div style="height: 20px">
		...
		<div id="editBtn" class="line-row">
			<shiro:hasPermission name="md:urgentcustomer:edit">
				<input id="btnSubmit" class="btn btn-primary" type="submit" value="保 存" style="width: 96px;height: 40px;margin-left: 83%;margin-top: 10px;margin-bottom: 10px"/>
				&nbsp;</shiro:hasPermission>
