...
<%@ attribute name="disabled" type="java.lang.Boolean" required="true" description="是否可选择"%>
<%@ attribute name="cssClass" type="java.lang.String" required="false" description="css样式"%>
<%@ attribute name="width" type="java.lang.String" required="false" description="窗口宽度"%>
<%@ attribute name="height" type="java.lang.String" required="false" description="窗口高度"%>
<%@ attribute name="formid" type="java.lang.String" required="false" description="form的id,已#开头,页面有多个form且有相同属性时使用"%>
<%@ attribute name="callbackmethod" type="java.lang.String" required="false" description="回调方法"%>
...
<script type="text/javascript">
    ...
    $("#${id}Button").click(function(){
        ...
        var replyIdex = top.layer.open({
            ...
            zIndex:19891015,
            title:'${title}',
            content: "${ctx}/md/servicepoint/selectForDeposit?parentLayerIndex=" + parentLayerIndex,
            shade: ${noModal?0:0.3},
