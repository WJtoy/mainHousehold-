...
<body>
	<ul class="nav nav-tabs">
		...
		<li class="active"><a href="javascript:void(0);">覆盖服务管理</a></li>
	...
	<form:form id="searchForm" modelAttribute="mdB2bTmall" action="${ctx}/tmall/md/servicepoint/serviceStoreCoverServiceList" method="POST" class="breadcrumb form-search">
        ...
        <c:set var="ACTION_TYPE_DELETE" value="<%=B2BActionType.ACTION_TYPE_DELETE.value%>"/>
			<c:forEach items="${page.list}" var="item">
				...
				<tr id="${item.servicePoint.id}">
					...
					<td>
						<a class="btn btn-primary" href="${ctx}/tmall/md/servicepoint/processServiceStoreCoverService?id=${item.id}">同步 -
                            <c:choose>
