    ...
    <c:if test="${errorFlag == false}">
        ...
        <div class="accordion-group" style="margin-top:2px;">
            <div class="accordion-heading">
                ...
                <c:set var="ordermsg" value="${ordermsg} ~n联系人:${order.orderCondition.userName}  ${order.orderCondition.servicePhone}  ${order.orderCondition.area.name} ${order.orderCondition.serviceAddress} ~n服务明细:${msg} ~n服务描述:${order.description} ~n---(反馈):" />
                    ...
                    <tr>
                        ...
                        <td class="tdbody">
                            ...
                            <c:if test="${order.orderCondition.urgentLevel.id >0}">
                                <a data-toggle="tooltip" data-tooltip="${order.orderCondition.urgentLevel.remarks}<br/>加急费：${order.orderFee.customerUrgentCharge}元" class='label label-important'>加急</a>
                            </c:if>
                        </td>
                        <td class="tdlable">
    ...
    <div class="tabbable" style="margin:0px 20px">
        <ul class="nav nav-tabs">
            ...
            <c:if test="${order.orderCondition.status.value !='90' && order.orderCondition.status.value !='100' && order.orderCondition.serviceTimes>0}">
                ...
                <%--<c:if test="${order.orderCondition.trackingFlag eq 1}">--%>
