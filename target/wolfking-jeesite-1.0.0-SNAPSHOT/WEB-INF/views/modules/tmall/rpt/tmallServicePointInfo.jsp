...
<ul class="nav nav-tabs">
    ...
    <li class="active"><a href="javascript:void(0);">网点信息</a></li>
    <li>
        <a href="${ctx}/tmall/rpt/tmallorder/tmallServicePointServer">网点服务</a>
    </li>
    <li>
...
<form:form id="searchForm" modelAttribute="processlogSearchModel" action="${ctx}/tmall/rpt/tmallorder/tmallServicePointInfo" method="post" class="breadcrumb form-search">
