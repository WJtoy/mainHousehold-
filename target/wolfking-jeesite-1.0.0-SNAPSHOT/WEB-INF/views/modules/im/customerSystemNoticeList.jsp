    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $("#btnSubmit").click(function() {
                ...
                $("#searchForm").attr("action","${ctx}/provider/systemNotice/customerNoticeList");
                $("#searchForm").submit();
            });
        });
...
<form:form id="searchForm" modelAttribute="systemNotice" action="${ctx}/provider/systemNotice/customerNoticeList" method="post" class="breadcrumb form-search">
    <div>
            ...
            <tr>
                ...
                <c:if test="${currentuser.isCustomer()==true}">
                    <c:if test="${item.readFlag==0}">
                        <td>
                            <span class="label status_30">未读</span>
                        </td>
                    </c:if>
                    <c:if test="${item.readFlag==1}">
                        <td>
                            <span class="label status_50">已读</span>
                        </td>
                    </c:if>
                </c:if>
                <td>
