...
<body>
	...
	<form:form id="inputForm" modelAttribute="customerCurrency" action="${ctx}/fi/customercurrency/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<shiro:hasPermission name="fi:customercurrency:charge"><input id="btnSubmit" class="btn btn-primary" type="submit" value="保 存"  />&nbsp;</shiro:hasPermission>
