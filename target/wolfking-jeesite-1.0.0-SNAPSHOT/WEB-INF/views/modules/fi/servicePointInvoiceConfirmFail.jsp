...
<head>
		...
		$(document).ready(function() {
			$("#inputForm").validate({
				submitHandler: function(form){
					...
					loading('正在提交，请稍等...');
					var postUrl = "${ctx}/fi/servicepointinvoice/confirm/fail";
					$.ajax({
						type: "POST",
						url: postUrl,
						data: {withdrawId:$("#withdrawId").val(), servicePointId:$("#servicePointId").val(), bankIssueValue:$("#bankIssue").val()},
  ...
  <body>
    <form:form id="inputForm" class="form-horizontal">
		<input id="withdrawId" name="withdrawId" type="hidden" value="${withdrawId}"/>
