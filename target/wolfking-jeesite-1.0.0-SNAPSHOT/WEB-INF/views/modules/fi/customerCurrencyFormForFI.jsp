...
<ul class="nav nav-tabs">
    ...
    <li><a href="${ctx}/fi/customercurrency/list?directPage=fiManager">余额明细</a></li>
    <li class="active"><a href="javascript:void(0);">充值</a></li>
</ul><br/>
<form:form id="inputForm" modelAttribute="customerCurrency" action="${ctx}/fi/customercurrency/save?directPage=fiManager" method="post" class="form-horizontal">
    <form:hidden path="id"/>
    ...
    <div class="form-actions">
        <shiro:hasPermission name="fi:customercurrency:fimanager:charge"><input id="btnSubmit" class="btn btn-primary" type="submit" value="保 存"  />&nbsp;</shiro:hasPermission>
