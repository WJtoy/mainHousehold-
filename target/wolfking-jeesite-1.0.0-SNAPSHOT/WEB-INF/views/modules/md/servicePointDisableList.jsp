...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/provider/md/servicePointNew/list">服务网点</a></li>
...
<shiro:hasPermission name="md:servicepoint:view">
	<form:form id="searchForm" modelAttribute="servicePoint" action="${ctx}/md/servicepoint/disableList" method="POST"
...
<%--					<form:options items="${fns:getDictListFromMS('ServicePointLevel')}" itemLabel="label" itemValue="value" htmlEscape="false" />&lt;%&ndash;切换为微服务&ndash;%&gt;--%>
<%--				</form:select>--%>
<%--			</li>&ndash;%&gt;--%>
<%--			<li>--%>
...
<%--								mustSelectCounty="true" cssClass="required" cssStyle="width:140px;">--%>
<%--				</sys:areaselect>--%>
<%--			</li>--%>
<%--			<li>--%>
...
<%--					<form:option value="" label="所有" />--%>
<%--					<form:options items="${fns:getDictListFromMS('BankIssueType')}" itemLabel="label" itemValue="value" htmlEscape="false" />&lt;%&ndash; 切换为微服务 &ndash;%&gt;--%>
<%--				</form:select>--%>
<%--			</li>--%>
<%--			<li>--%>
<%--				<label>服务范围：</label>--%>
<%--				<select id="category" name="category" class="input-small" style="width:125px;">--%>
