...
<head>
    <title>九阳发送内容</title>
    <meta name="description" content="九阳发送内容">
    ...
    function resend(){
        ...
        top.layer.confirm('确定重发吗？', {icon: 3, title:'系统确认'}, function(index){
            ...
            $.ajax({
                cache: false,
                type: "POST",
                url: "${ctx}/b2b/rpt/processlog/joyoungCancelRetry",
                dataType: 'json',
    ...
    function closeme(){
        ...
        top.layer.confirm('确定忽略本条信息吗？', {icon: 3, title:'系统确认'}, function(index){
            ...
            $.ajax({
                cache: false,
                type: "POST",
                url: "${ctx}/b2b/rpt/processlog/joyoungCancelCloseLog",
...
<body>
<form:form id="inputForm" modelAttribute="completedRetryBean" action="${ctx}/b2b/rpt/processlog/joyoungCancelForm" method="post" class="form-horizontal">
    ...
    <div id="divMain">
        ...
        <div class="row-fluid" style="margin-top: 10px;min-height: 30px;">
            <label style="color:red;margin-left: 60px">失败原因:</label>
