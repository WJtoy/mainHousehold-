    ...
    <script type="text/javascript" language="javascript">
        $(document).ready(function () {
            ...
            $("#btnSubmit").click(function () {
                ...
                $("#searchForm").attr("action", "${ctx}/finance/rpt/customerRevenue/customerRevenueChart");
                $("#searchForm").submit();
            });
        });
    </script>
...
<ul class="nav nav-tabs">
    <li>
        <a href="${ctx}/finance/rpt/customerRevenue/customerRevenueReport">客户营收明细</a>
    </li>
    <li class="active"><a href="javascript:void(0);">客户营收排名</a></li>
</ul>
<form:form id="searchForm" modelAttribute="rptSearchCondition"
           action="${ctx}/finance/rpt/customerRevenue/customerRevenueChart" method="post"
    ...
    <div>
        ...
        &nbsp;&nbsp;
        <shiro:hasPermission name="rpt:finance:customerRevenueReport:view"><input id="btnSubmit" class="btn btn-primary" type="button" value="查询"/></shiro:hasPermission>
    </div>
