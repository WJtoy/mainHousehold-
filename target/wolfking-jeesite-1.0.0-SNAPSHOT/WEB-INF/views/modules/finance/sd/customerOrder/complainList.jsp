...
<ul id="navtabs" class="nav nav-tabs">
    <li><a href="${ctx}/sd/finance/customerOrder/materialList" data-toggle="tooltipnorth" data-tooltip="要发配件的订单">待发配件</a>
    </li>
...
<form:form id="searchForm" modelAttribute="order" action="${ctx}/sd/finance/customerOrder/complainlist" method="post"
    ...
    <div style="margin-top:5px">
        ...
        <input id="beginDate" name="beginDate" type="text" readonly="readonly"
               ...
               class="input-small Wdate" value="${fns:formatDate(order.beginDate,'yyyy-MM-dd')}" />
        <label>~</label>&nbsp;&nbsp;&nbsp;
    ...
    <table id="contentTable" class="table table-bordered table-condensed table-striped"
        ...
        <c:forEach items="${page.list}" var="o">
            ...
            <tr>
                ...
                <td>${o.orderCondition.customerOwner}<br/>${o.parentBizOrderId}</td>
                        ...
                        <c:if test="${ o.canEdit() || o.canCanceled()}">
                            <div class="btn-group">
                                ...
                                <ul class="dropdown-menu">
                                    <c:if test="${ o.canEdit() }">
                                        <shiro:hasPermission name="sd:order:edit">
                                            <li><a href="${ctx}/sd/order/edit?id=${o.id}&actiontype=cust_complain"><i class="icon-pencil"></i>修改</a>
                                            </li>
                                        </shiro:hasPermission>
                                    </c:if>
