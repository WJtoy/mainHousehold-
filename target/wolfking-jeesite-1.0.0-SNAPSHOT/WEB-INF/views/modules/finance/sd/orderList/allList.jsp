...
<ul id="navtabs" class="nav nav-tabs">
    <li><a href="${ctx}/finance/sd/orderList/reminderlist" title="催单的工单">催单</a></li>
    <li><a href="${ctx}/finance/sd/orderList/planinglist" title="待接派的工单列表">待接派单</a></li>
    <li><a href="${ctx}/finance/sd/orderList/noAppointmentList" title="未预约的工单">未预约</a></li>
    <li><a href="${ctx}/finance/sd/orderList/arriveAppointmentList" title="预约到期的工单">预约到期</a></li>
    <li><a href="${ctx}/finance/sd/orderList/passAppointmentList" title="预约超期的工单">预约超期</a></li>
    <li><a href="${ctx}/finance/sd/orderList/servicedList" title="待回访的工单">待回访</a></li>
    <li><a href="${ctx}/finance/sd/orderList/followUpFailList" title="回访失败的工单">回访失败</a></li>

    <li><a href="${ctx}/finance/sd/orderList/tmallAnomalyList" title="天猫一键求助">求助</a></li>
    <li><a href="${ctx}/finance/sd/orderList/tmallServiceMonitorList" title="天猫预警">预警</a></li>
    <li><a href="${ctx}/finance/sd/orderList/rushinglist" title="突击中的工单">突击单</a></li>
    <li><a href="${ctx}/finance/sd/orderList/complainlist" title="投诉的工单">投诉</a></li>
    <li><a href="${ctx}/finance/sd/orderList/pendinglist" title="需要等待的工单">停滞</a></li>
    <li><a href="${ctx}/finance/sd/orderList/uncompletedList" title="未完成的工单">未完成</a></li>
    <li><a href="${ctx}/finance/sd/orderList/completedList" title="已完成的工单">已完成</a></li>
    <li class="active"><a href="javascript:void(0);" title="所有工单">所有</a></li>
</ul>
<c:set var="currentuser" value="${fns:getUser() }"/>
<form:form id="searchForm" modelAttribute="order" action="${ctx}/finance/sd/orderList/alllist" method="post"
           class="form-inline">
