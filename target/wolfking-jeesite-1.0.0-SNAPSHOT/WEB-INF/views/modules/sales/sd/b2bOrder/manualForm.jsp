...
<head>
    ...
    <%@ include file="/WEB-INF/views/modules/sales/sd/b2bOrder/tpl/orderEditForm.html" %>
                    ...
                    layer.confirm(
                        ...
                        , function (index) {
                            ...
                            $.ajax({
                                cache: false,
                                type: "POST",
                                url: "${ctx}/sales/sd/b2bOrder/manual?_" + (new Date()).getTime(),
                                data: $(form).serialize(),
...
<form:form id="inputForm" modelAttribute="order" action="${ctx}/sales/sd/b2bOrder/manual" method="post"
