...
<form:form id="searchForm" modelAttribute="order" action="${ctx}/servicePoint/sd/orderList/servicedList" method="post" class="breadcrumb form-search">
        ...
        <tr>
            ...
            <td>
                <c:if test="${order.orderCondition.finishPhotoQty > 0 }">
                    <a href="javascript:void(0);" onclick="ServicePointOrderService.photoListNew('${order.id}','${order.quarter}',${fns:isNewOrder(order.orderNo)});"
