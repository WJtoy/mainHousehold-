        ...
        <tr>
            ...
            <td rowspan="${rowspan}">
                <c:choose>
                    ...
                    <c:otherwise>
                        <a href="javascript:void(0);" onclick="ServicePointOrderService.showProcessOrderDetail
                                ('${order.id}','${order.quarter}',${order.orderCondition.orderServiceType});">
