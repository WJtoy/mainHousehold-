            ...
            <td rowspan="${rowspan}">
                ...
                <c:choose>
                    <c:when test="${order.isNotAccept(30)}">
                        ...
                        <c:otherwise>
                            <a href="javascript:void(0);" style="color: red;" onclick="ServicePointOrderService.showFollowUpFailOrderDetail('${order.id}','${order.quarter}',${order.orderCondition.orderServiceType});">
                        </c:otherwise>
                        </c:choose>
                    ...
                    <c:when test="${order.orderCondition.appAbnormalyFlag == 1}">
                        <%--<a href="javascript:void(0);" style="color: red;" onclick="ServicePointOrderService.showProcessOrderDetail('${order.id}','${order.quarter}');">--%>
                        <c:choose>
                        <c:when test="${canFollowUp == 0}">
                        <a href="javascript:void(0);" style="color: red;" onclick="ServicePointOrderService.showProcessOrderDetail('${order.id}','${order.quarter}',${order.orderCondition.orderServiceType});">
                        </c:when>
                    ...
                    <c:when test="${not empty order.repeateNo}">
                        <%--<a href="javascript:void(0);" onclick="ServicePointOrderService.showProcessOrderDetail('${order.id}','${order.quarter}');">--%>
                    <c:choose>
                    <c:when test="${canFollowUp == 0}">
                        <a href="javascript:void(0);" style="color: red;" onclick="ServicePointOrderService.showProcessOrderDetail('${order.id}','${order.quarter}',${order.orderCondition.orderServiceType});">
                    </c:when>
