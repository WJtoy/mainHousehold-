...
<ul id="navtabs" class="nav nav-tabs">
    <shiro:hasPermission name="sd:abnormal:view">
        ...
        <li class="active"><a href="javascript:void(0);" title="短信异常">短信异常</a></li>
        <li><a href="${ctx}/servicePoint/sd/abnormalForm/oldAppAbnormalList" title="旧app异常">旧app异常</a></li>
        <li><a href="${ctx}/servicePoint/sd/abnormalForm/processedList" title="异常单已处理">已处理</a></li>
    </shiro:hasPermission>
</ul>
<c:set var="currentuser" value="${fns:getUser() }"/>
<form:form id="searchForm" modelAttribute="abnormalForm" action="${ctx}/servicePoint/sd/abnormalForm/smsAbnormalList" method="post" class="form-inline">
    ...
    <div class="control-group">
        ...
        <form:select path="subType" cssClass="input-small" cssStyle="width:180px;">
            ...
            <form:option value="30" label="客评短息"/>
            <form:option value="31" label="非客评短息"/>
        </form:select>&nbsp;
        <label>所属网点：</label>
