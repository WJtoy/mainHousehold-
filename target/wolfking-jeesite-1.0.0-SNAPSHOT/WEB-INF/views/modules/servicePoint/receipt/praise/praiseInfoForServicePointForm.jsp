  ...
  <head>
	...
	<script type="text/javascript">
        ...
        function imageViewer(){
			 viewer = $("#divUploadWarp").viewer('destroy').viewer(
                {
                    url: "data-original",
  ...
  <body>
	...
	<c:if test="${canAction==true}">
		...
		<form:form id="inputForm" modelAttribute="praise" action="" method="post" class="form-horizontal">
						...
						<div class="controls">
							...
							<div>
								...
								<span style="color: red;">支持jpg,jpeg,png格式,且大小不能超过2MB,建议尺寸600*800</span><br/>
									<%--<span style="color: red;margin-top: 5px">内容要求:</span>--%>
			...
			<c:if test="${praise.applyServicepointPraiseFee!=0.0}">
				<div class="row-fluid">
					<div class="span6">
						<div class="control-group">
							...
							<div class="controls">
								<c:choose>
									<c:when test="${praise.status==40}">
										<form:input  path="servicepointPraiseFee" readonly="true" cssClass="input-block-level"></form:input>
									</c:when>
									<c:otherwise>
		...
		<shiro:hasPermission name="sd:servicepointpraise:edit">
			<div style="position: fixed;bottom: 0; width: 100%;height: 60px;background-color: white">
				...
				<c:choose>
					<c:when test="${canSave==true}">
						<input id="btnSubmit" class="btn btn-primary" type="submit" value="修 改" style="margin-left: 620px;margin-top: 10px"/>
