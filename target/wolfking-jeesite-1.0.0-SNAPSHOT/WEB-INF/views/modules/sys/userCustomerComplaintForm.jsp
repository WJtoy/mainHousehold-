        ...
        $(document).ready(function() {
            ...
            $("#inputForm").validate({
                ...
                submitHandler: function(form){
                    ...
                    $.ajax({
                        url:"${ctx}/sys/customerComplaint/save",
                        type:"POST",
                        data:entity,
                        dataType:"json",
...
<body>
<form:form id="inputForm" modelAttribute="user" method="post"  class="form-horizontal" cssStyle="margin-top: 25px;margin-left: 50px">
        ...
        <div class="row-fluid">
            <div class="span6">
                <div class="control-group">
                    <label class="control-label" style="width: 104px"><span class="help-inline"><font color="red">*</font> </span>名&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;称：</label>
    ...
    <div style="width: 90%;padding: 30px;margin-top: -25px;padding-bottom: 10px;">
        <div class="row-fluid">
            <div class="control-group">
        ...
        <div class="row-fluid" style="margin-top: 10px;">
            <div class="control-group">
                ...
                <div class="controls" style="margin-left: 105px;margin-top: 3px">
                    <c:forEach items="${allRoles}" varStatus="i" var="role">
        ...
        <div class="row-fluid" id="divArea">
