...
<head>
    ...
    <script type="text/javascript">
        ...
        function search() {
            $("#pageNo").val(1);
            $("#searchForm").attr("action", "${ctx}/sys/user/salesList");
            $("#searchForm").submit();
            return false;
        }
        ...
        function editUser(id) {
            ...
            var text = "添加业务";
            var url = "${ctx}/sys/user/form?type=7";
            var height = (h-200);
...
<ul class="nav nav-tabs">
    ...
    <li><a href="${ctx}/sys/userServicePoint/list">网点</a></li>
</ul>
<form:form id="searchForm" modelAttribute="user" action="${ctx}/sys/user/salesList" method="post"
           class="form-inline">
    ...
    <div class="control-group" style="height: 45px;margin-top: 20px;border-bottom: 1px solid #EEEEEE;">
        ...
        <label class="margin_line">登录账号：</label>
