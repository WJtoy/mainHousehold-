			...
			$("#inputForm").validate({
				submitHandler: function(form){
					...
					$.ajax({
						...
						cache: false,
						type: "POST",
						url: "${ctx}/sd/complain/save?"+ (new Date()).getTime(),
						data:$(form).serialize(),
						beforeSend: function () {
			...
			<div class="span4">
				<div class="control-group">
					...
					<div class="controls">
						...
						<a href="javascript:void(0);" onclick="Order.viewOrderDetail('${complain.orderId}','${complain.quarter}');">${complain.orderNo}</a>
					</div>
				</div>
			</div>
			<div class="span4">
			...
			<div class="span12">
				<table id="tb_complain" class="table table-striped table-bordered table-condensed table-hover">
					...
					<tr>
						<td>${rowNumber}</td>
						<td>
							<a href="javascript:void(0);" onclick="Order.complain_view('${item.id}','${item.quarter}');">${item.complainNo}</a>
						</td>
