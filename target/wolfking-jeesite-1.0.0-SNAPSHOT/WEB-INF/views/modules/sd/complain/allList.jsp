...
<ul id="navtabs" class="nav nav-tabs">
    ...
    <li class="active"><a href="javascript:void(0);" title="所有投诉单列表">所有</a></li>
</ul>
<c:set var="currentuser" value="${fns:getUser() }"/>
<form:form id="searchForm" modelAttribute="complain" action="${ctx}/sd/complain/alllist" method="post" class="form-inline">
    ...
    <div class="control-group">
        ...
        <label>电话：</label>
        <input type=text class="input-small digits" id="userPhone" name="userPhone" value="${complain.userPhone}" placeholder="用户完整手机号码" maxlength="20" />
        <label>品类：</label>
        ...
        <form:select path="status.value" cssClass="input-small" cssStyle="width:125px;">
            ...
            <form:options items="${fns:getDictListFromMS('complain_status')}" itemLabel="label" itemValue="value" htmlEscape="false"/>
        </form:select>
    </div>
    <div class="control-group">
            ...
            <tr>
                ...
                <td>
                    <a href="javascript:void(0);" data-toggle="tooltip" data-tooltip="${model.completeRemark}">
                            ${fns:abbr(model.completeRemark,40)}
                    </a>
                </td>
                <td>
