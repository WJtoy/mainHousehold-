...
<form:form id="searchForm" modelAttribute="searchModel" method="post" action="${ctx}/sd/material/customer/tosendlist" class="breadcrumb form-search">
    ...
    <div style="margin-top:5px;">
        ...
        <input id="btnImportSubmit" class="btn btn-primary" type="button" value="批量发货"/>
    </div>
</form:form>
...
<table id="contentTable" class="table table-striped table-bordered table-condensed table-hover">
    ...
    <c:forEach items="${page.list}" var="master" varStatus="i" begin="0">
        ...
        <tr id="tr_${master.id}" data-index="${i.index}">
            ...
            <td rowspan="${rowspan}">
                <a href="javascript:void(0);" data-toggle="tooltip" data-tooltip="${master.approveRemark}">${fns:abbr(master.approveRemark,50)}</a>
            </td>
            <!-- 跟踪进度 -->
