...
<body>
	<form:form id="inputForm" modelAttribute="order" action="${ctx}/sd/order/servicePointOrderList/service/complete" method="post" class="form-horizontal">
        ...
        $(document).ready(function() {
            $("#inputForm").validate({
                submitHandler: function(form){
                    ...
                    // var option = $("[name='completeType'] option:selected");
                    ...
                    $.ajax({
                        ...
                        cache: false,
                        type: "POST",
                        url: "${ctx}/sd/order/servicePointOrderList/service/complete?"+ (new Date()).getTime(),
                        data:order,
                        beforeSend: function () {
