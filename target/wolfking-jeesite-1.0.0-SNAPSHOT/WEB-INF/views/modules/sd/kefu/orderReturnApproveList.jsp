  ...
  <body>
    <ul class="nav nav-tabs">
		...
		<c:if test="${isShowXYYOrderReturnApproveList == true}">
			<li><a href="${ctx}/sd/order/kefu/xyyOrderReturnApproveList" title="待厂商审核(B2B)">待厂商审核(B2B)</a></li>
		</c:if>
	</ul>
	<c:set var="currentuser" value="${fns:getUser() }" />
	<form:form id="searchForm" modelAttribute="order"  action="${ctx}/sd/order/kefu/orderReturnApproveList" method="post" class="breadcrumb form-search">
