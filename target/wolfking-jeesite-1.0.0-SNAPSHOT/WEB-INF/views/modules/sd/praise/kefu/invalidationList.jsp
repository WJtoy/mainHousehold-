...
<ul id="navtabs" class="nav nav-tabs">
   <%-- <li><a href="${ctx}/praise/orderPraise/pendingReviewList" title="待客服审核无费用的好评单">待审核</a></li>--%>
    ...
    <li class="active"><a href="javascript:void(0);" title="通过审核无效">无效</a></li>
</ul>
<form:form id="searchForm" modelAttribute="praisePageSearchModel" action="${ctx}/praise/orderPraise/invalidationList" method="post" class="breadcrumb form-search">
