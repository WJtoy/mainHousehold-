...
<ul id="navtabs" class="nav nav-tabs">
    ...
    <li><a href="${ctx}/sd/order/servicepoint/appointedList" title="已预约的订单列表">已预约</a></li>
    <li class="active"><a href="javascript:void(0);">等配件</a></li>
...
<form:form id="searchForm" modelAttribute="order" action="${ctx}/sd/order/servicepoint/waitingAccessoryList"
    ...
    <div style="margin-top: 8px;">
        <label>接单时间：</label>
        <input id="beginAcceptDate" name="beginAcceptDate" type="text" readonly="readonly"
        ...
        <input id="endAcceptDate" name="endAcceptDate" type="text" readonly="readonly" style="width:120px"
               maxlength="20"
