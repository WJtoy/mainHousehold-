...
<%--    <li><a href="${ctx}/sd/order/salesNew/returnlist" data-toggle="tooltipnorth" data-tooltip="退单列表">退单</a></li>--%>
    ...
    <li class="active"><a href="javascript:;" data-toggle="tooltipnorth" data-tooltip="投诉订单列表">投诉</a></li>
    <li><a href="${ctx}/sd/order/salesNew/reminderlist" data-toggle="tooltipnorth" data-tooltip="催单列表">催单</a></li>
</ul>
<c:set var="currentuser" value="${fns:getUser() }"/>
<form:form id="searchForm" modelAttribute="order" action="${ctx}/sd/order/salesNew/complainlist" method="post"
    ...
    <div style="margin-top:5px">
       ...
       <%-- <input type=text class="input-mini" id="creator" name="creator" value="${order.creator }" maxlength="20"
        ...
        <c:set var="statusList" value="${fns:getDictListFromMS('complain_status')}"/><%--切换为微服务--%>
        <label>投诉单状态：</label>
