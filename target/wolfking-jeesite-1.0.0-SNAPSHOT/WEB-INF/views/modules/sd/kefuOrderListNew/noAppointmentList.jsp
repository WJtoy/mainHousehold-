...
<ul id="navtabs" class="nav nav-tabs">
    ...
    <li class="active"><a href="javascript:void(0);" title="未预约的工单">未预约<span id="spn_order_count" class="badge badge-info">${page !=null ?page.count:''}</span></a></li>
    ...
    <div style="margin-top:0px; display:none;" id="div_search_customer">
        <div>
            ...
            <sd:servicePointSelect id="servicePoint" name="servicePoint.id" value="${order.servicePoint.id}"
                                 ...
                                 width="1200" height="780" allowClear="true" callbackmethod="" title="选择服务网点" areaId="" showArea="false"/>
        </div>
        ...
        <div style="margin-top:5px;">
            ...
            &nbsp;&nbsp;
            <label for="appointmentTimeoutFlag" title="派单2小时未预约">预约超时：</label>
            <input id="appointmentTimeoutFlag" name="appointmentTimeoutFlag"
                   <c:if test="${order.appointmentTimeoutFlag==1}">checked="checked"</c:if> type="checkbox" value="1"
                   class="input-small"/>
            &nbsp;&nbsp;
