...
<form:form id="searchForm" modelAttribute="entity" action="${ctx}/sd/order/kefuOrderListNew/tmallServiceMonitorList" method="post"
...
<table id="contentTable" class="table table-striped table-bordered table-condensed table-hover">
    ...
    <c:forEach items="${page.list}" var="vmodel">
        <tr>
            ...
            <td>
                <a href="javascript:void(0);" onclick="Order.showKefuOrderDetail('${vmodel.orderId}','${vmodel.quarter}',1);">
