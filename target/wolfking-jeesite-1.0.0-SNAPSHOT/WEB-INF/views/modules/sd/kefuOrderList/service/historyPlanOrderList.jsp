...
<table id="contentTable" class="table table-striped table-bordered table-condensed table-hover">
    ...
    <c:forEach items="${page.list}" var="order">
        ...
        <tr>
            ...
            <td rowspan="${rowspan}"><a href="javascript:void(0);" onclick="Order.showKefuHistoryOrderDetail('${order.orderId}','${order.quarter}','layer_orderdetailkefu');">${order.orderNo}</a></td>
            <td rowspan="${rowspan}">
