...
<body>
	...
	<form:form id="searchForm" modelAttribute="order" action="${ctx}/sd/order/engineer/allList" method="post" class="breadcrumb form-search">
		...
		<div>
			...
			<label>电 话：</label><input type=text
				class="input-small" id="userPhone" name="userPhone" value="${order.userPhone}" maxlength="20" />
			<label>安维姓名：</label>
		...
		<div style="margin-top: 8px;">
			...
			<label style="width:45px;text-align: center;"> ~ </label>&nbsp;&nbsp;&nbsp;<input id="endAcceptDate" name="endAcceptDate"
				type="text" readonly="readonly" style="width:120px" maxlength="20"
