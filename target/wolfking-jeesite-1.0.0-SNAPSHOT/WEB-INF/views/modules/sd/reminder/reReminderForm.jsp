                    ...
                    <shiro:hasPermission name="sd:reminder:complete">
                        <c:choose>
                            <c:when test="${reminderCheckFlag == 1}">
                                <a id="btnReject1" href="javascript:void(0);" class="btn btn-danger disabled"  data-toggle="tooltip" data-tooltip="${reminderCheckMsg}" style="margin-top:20px;padding: 5px;width:70px;" >再次催单</a>
                            </c:when>
                            <c:otherwise>
                                <input id="btnReject" class="btn btn-danger" type="button" style="margin-top: 20px;" value="再次催单"/>&nbsp;
                            </c:otherwise>
                        </c:choose>
                    </shiro:hasPermission>
                </div>--%>
