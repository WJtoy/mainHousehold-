...
<ul id="navtabs" class="nav nav-tabs">
    <shiro:hasPermission name="sd:reminder:view">
        ...
        <li><a href="${ctx}/sd/reminder/list/haveRepliedList" title="客服已回复列表">已回复</a></li>
...
<form:form id="searchForm" modelAttribute="reminder" action="${ctx}/sd/reminder/list/all" method="post" class="breadcrumb form-search">
