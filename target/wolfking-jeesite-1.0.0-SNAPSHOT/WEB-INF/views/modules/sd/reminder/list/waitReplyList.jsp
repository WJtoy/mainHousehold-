...
<form:form id="searchForm" modelAttribute="reminder" action="${ctx}/sd/reminder/list/process" method="post" class="breadcrumb form-search">
            ...
            <tr>
                ...
                <td>
                    <shiro:hasPermission name="sd:reminder:process">
                        <a href="javascript:void(0);" onclick="Order.reminderToReply('${model.id}','${model.quarter}','${model.itemId}');">${model.reminderNo}</a>
                    </shiro:hasPermission>
                    <shiro:lacksPermission name="sd:reminder:process">
