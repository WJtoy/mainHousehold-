    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $(document).on('change',"#productId",function (e) {
                ...
                setPage(0);
                $("#name").rules("remove");
                var url = "${ctx}/provider/md/errorCode/findList?productId="+productId;
            ...
            $("#btnSubmit").on("click",function(){
                ...
                var url = "${ctx}/provider/md/errorCode/save";
                $("#searchForm").attr("action",url);
                $("#searchForm").submit();
                return false;
            });
            ...
            $("#searchForm").validate({
                rules: {
                    name: {remote: {
                        url: "${ctx}/provider/md/errorCode/checkName",
                        type: "get",
                        data:{
                            productId: function() {
        ...
        function showErrorCode() {
            ...
            top.layer.open({
                ...
                zIndex:19891015,
                title:'故障分类添加',
                content: "${ctx}/provider/md/errorType/findList?productId=" + productId,
                ...
                success:function (e) {
                    if(e.success){
                        if (e.data>0) {
                            ...
                            var url = "${ctx}/provider/md/errorCode/delete?id="+id+"&productId="+productId + "&customerId="+customerId;
                            $("#searchForm").attr("action",url);
                            $("#searchForm").submit();
                            return false;
                        }
...
<form:form id="searchForm" modelAttribute="errorCode" action="${ctx}/provider/md/errorCode/findList" method="post" class="form-horizontal">
    ...
    <div class="control-group">
        ...
        <div class="controls">
            ...
            <div style="float:left;margin-left: 20px;line-height: 80px;">
                <shiro:hasPermission name="md:errorcode:edit">
