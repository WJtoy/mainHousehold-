    ...
    <script type="text/javascript" language="javascript">
        $(document).ready(function () {
            ...
            $("#btnSubmit").click(function () {
                ...
                $("#searchForm").attr("action", "${ctx}/customer/rpt/customerOrderPlan/customerOrderPlanDailyReport");
                $("#searchForm").submit();
            });
            $("#btnExport").click(function () {
                ...
                $.ajax({
                    type: "POST",
                    url: "${ctx}/customer/rpt/customerOrderPlan/checkExportTask?"+ (new Date()).getTime(),
                        ...
                        if(data && data.success == true){
                            ...
                            top.$.jBox.confirm("确认要导出数据吗？", "系统提示", function (v, h, f) {
                                if (v == "ok") {
                                    ...
                                    $.ajax({
                                        type: "POST",
                                        url: "${ctx}/customer/rpt/customerOrderPlan/export?"+ (new Date()).getTime(),
                                        data:$(searchForm).serialize(),
                                        success: function (data) {
                                            if(ajaxLogout(data)){
                                                return false;
...
<ul class="nav nav-tabs">
    ...
    <li>
        <a href="${ctx}/customer/rpt/customerOrderPlan/customerOrderPlanDailyChart">客户每日下单图表</a>
    </li>
</ul>
...
<form:form id="searchForm" modelAttribute="rptSearchCondition" method="post" class="breadcrumb form-search">
    <div style="width: 90%;">
        ...
        &nbsp;&nbsp;
        <shiro:hasPermission name="rpt:customer:customerOrderPlanDaily:export"><input id="btnExport" class="btn btn-primary" type="button" value="导出" /></shiro:hasPermission>
    </div>
