    ...
    <script type="text/javascript" language="javascript">
        $(document).ready(function () {
            ...
            $("#btnSubmit").click(function () {
                ...
                $("#searchForm").attr("action", "${ctx}/customer/rpt/customerCharge/customerChargeWriteOffRpt");
                $("#searchForm").submit();
            });
...
<ul class="nav nav-tabs">
    <li><a href="${ctx}/customer/rpt/customerCharge/customerChargeSummaryRpt">订单|消费|充值</a>
    </li>
    <li><a href="${ctx}/customer/rpt/customerCharge/customerChargeCompleteReport">完工单</a>
    </li>
    <li><a href="${ctx}/customer/rpt/customerCharge/returnedOrderCancelledRpt">退单/取消单</a>
    </li>
...
<form:form id="searchForm" modelAttribute="rptSearchCondition" action="${ctx}/customer/rpt/customerCharge/customerChargeWriteOffRpt" method="post" class="breadcrumb form-search">
