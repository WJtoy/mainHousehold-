    ...
    <script type="text/javascript" language="javascript">
        $(document).ready(function() {
            ...
            $("#btnSubmit").click(function(){
                ...
                $("#pageNo").val(1);
                $("#searchForm").attr("action","${ctx}/customer/rpt/customerCharge/returnedOrderCancelledRpt");
                $("#searchForm").submit();
            });
...
<ul class="nav nav-tabs">
    ...
    <li><a href="${ctx}/customer/rpt/customerCharge/customerChargeWriteOffRpt">退补单</a>
    </li>
</ul>
<c:set var="currentuser" value="${fns:getUser() }" />
<c:set var="mdcustomerID" value="${currentuser.getCustomerAccountProfile().getCustomer().getId()}"></c:set>
<form:form id="searchForm" modelAttribute="rptSearchCondition" action="${ctx}/customer/rpt/customerCharge/returnedOrderCancelledRpt" method="post" class="breadcrumb form-search">
