    ...
    <script type="text/javascript">
        $(document).on('change',"#customer\\.id",function (e) {
            ...
            if (customerId !=null || customerId !='' || customerId != '0') {
                $.ajax({
                    url: "${ctx}/customer/md/customerProduct/ajax/customerProductList",
        ...
        function delCustomerProduct(id,customerId,productId,productName) {
            layer.confirm('确定要删除<font color=\'blue\'>'+productName+'</font>安装规范吗？',{icon: 3, title:'提示'}, function(){
                ...
                $.ajax({
                    url:"${ctx}/customer/md/customerProduct/ajax/removeFixSpec?id=" + id +"&customer.id="+customerId+"&product.id="+productId,
                    type:"POST",
                    dataType:"json",
...
<form:form id="searchForm" modelAttribute="customerProduct" action="${ctx}/customer/md/customerProduct" method="post" class="breadcrumb form-search">
