    ...
    <script type="text/javascript" language="javascript">
        $(document).ready(function() {
            ...
            $("#btnSubmit").click(function(){
                ...
                $("#pageNo").val(1);
                $("#searchForm").attr("action","${ctx}/rpt/provider/customerCharge/customerChargeCompleteReport");
                $("#searchForm").submit();
            });
...
<ul class="nav nav-tabs">
    <li>
        <a href="${ctx}/rpt/provider/customerCharge/customerChargeSummaryRpt">订单|消费|充值</a>
    </li>
    <li class="active"><a href="javascript:void(0);">完工单</a></li>
    <li>
        <a href="${ctx}/rpt/provider/customerCharge/returnedOrderCancelledRpt">退单/取消单</a>
    </li>
    <li>
        <a href="${ctx}/rpt/provider/customerCharge/customerChargeWriteOffRpt">退补单</a>
    </li>
