    ...
    <script type="text/javascript" language="javascript">
        $(document).ready(function () {
            ...
            $("#btnSubmit").click(function () {
                ...
                $("#pageNo").val(1);
                $("#searchForm").attr("action", "${ctx}/rpt/provider/servicePointCharge/servicePointPaySummaryReport");
                $("#searchForm").submit();
            });
            ...
            $("#btnExport").click(function () {
                ...
                $.ajax({
                    type: "POST",
                    url: "${ctx}/rpt/provider/servicePointCharge/checkPaySummaryExportTask?" + (new Date()).getTime(),
                        ...
                        if (data && data.success == true) {
                            ...
                            top.$.jBox.confirm("确认要导出数据吗？", "系统提示", function (v, h, f) {
                                if (v == "ok") {
                                    ...
                                    $.ajax({
                                        type: "POST",
                                        url: "${ctx}/rpt/provider/servicePointCharge/paySummaryExport?" + (new Date()).getTime(),
                                        data: $(searchForm).serialize(),
                                        success: function (data) {
                                            if (ajaxLogout(data)) {
                                                return false;
...
<form:form id="searchForm" modelAttribute="rptSearchCondition" action="${ctx}/rpt/provider/servicePointCharge/servicePointPaySummaryReport" method="post" class="breadcrumb form-search">
    <div style="width: 90%">
        ...
        <div style="position: relative" class="parent">
            ...
            <div style="text-align:right;position: absolute;width: 250px;height: 100px;right:1px;top:31px;" class="target">
                <div style="text-align:left;background-color: #1B1E24;border-radius: 5px;opacity: 0.8;padding: 10px;font-size:14px;color:white;min-width:100px;max-width:400px;">
                    ...
                    统计方式：审单时间<br/>
                    栏位说明：<br/>
                    【本月应付合计】本月完工单金额+时效奖励+厂商时效费+加急费+扣点+好评费+平台服务费(入账)+师傅质保金额+本月互助基金+本月退补金额<br/>
            ...
            $("#contentTable").toSuperTable({
                ...
                colWidths:
                    [70,
                        ...
                        100,
                        100, 100, 150, 100, 100, 100,100, 100, 130,160,100,100,100, 130,100,130,
...
<div id="divGrid" style="overflow: auto;">
    <table id="contentTable" class="table table-bordered table-condensed table-hover" style="table-layout:fixed;margin-top: 0px;border-top-width: 0px;" cellspacing="0" width="100%">
        ...
        <c:set var="rechargeDeposit" value="0"/>
        ...
        <c:forEach items="${page.list}" var="item">
            ...
            <c:set var="rechargeDeposit" value="${rechargeDeposit + item.rechargeDeposit}"/>
        ...
        <c:if test="${page.list.size()> 0}">
            <tr style="color: red;">
                ...
                <td><fmt:formatNumber pattern="0.00" value="${rechargeDeposit}"/></td>
