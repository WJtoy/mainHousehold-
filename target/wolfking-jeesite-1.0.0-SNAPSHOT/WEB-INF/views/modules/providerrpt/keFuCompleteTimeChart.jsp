    ...
    <script type="text/javascript" language="javascript">
        $(document).ready(function () {
            $("#btnSubmit").click(function () {
                ...
                $("#searchForm").attr("action", "${ctx}/rpt/provider/keFuCompleteTime/keFuCompleteTimeChart");
                $("#searchForm").submit();
            });
        });
    </script>
...
<ul id="navtabs" class="nav nav-tabs">
    <li>
        <a href="${ctx}/rpt/provider/keFuCompleteTime/keFuCompleteTimeReport">完成时效统计</a>
    </li>
    <li class="active"><a href="javascript:void(0);">完成时效图表</a></li>

</ul>
<c:set var="currentuser" value="${fns:getUser() }" />
<form:form id="searchForm" modelAttribute="rptSearchCondition" action="${ctx}/rpt/provider/keFuCompleteTime/keFuCompleteTimeChart"
...
<script type="text/javascript">
    ...
    setTimeout(function () {
        option = {
            ...
            legend: {
                data: ['订单完成', '24小时完成', '48小时完成', '72小时完成', '72小时外完成', '取消', '未完成']
            },
            series: [
                {
                    name: '单量',
...
<script type="text/javascript">
    ...
    var strCancenums = ${fns:toGson(strCancenums)};
    ...
    setTimeout(function () {
        ...
        option = {
            ...
            legend: {
                data: ['下单', '24小时完成', '48小时完成', '72小时完成', '72小时外完成', '取消', '未完成']
            },
            grid: {
                left: '3%',
                right: '4%',
...
<script type="text/javascript">
    ...
    var strCancelNumRates = ${fns:toGson(strCancelNumRates)};
    ...
    setTimeout(function () {
        option = {
            ...
            legend: {
                data: ['24小时完成', '48小时完成', '72小时完成', '72小时外完成', '取消', '未完成']
            },
            grid: {
                left: '3%',
                right: '4%',
