    ...
    <script type="text/javascript" language="javascript">
        ...
        $(document).ready(function () {
            ...
            $("#btnSubmit").click(function () {
                ...
                $("#pageNo").val(1);
                $("#searchForm").attr("action", "${ctx}/rpt/provider/kaReminderResponseTime/kaReminderResponseTimeReport");
                $("#searchForm").submit();
            });
            ...
            $("#btnExport").click(function () {
                ...
                $.ajax({
                    type: "POST",
                    url: "${ctx}/rpt/provider/kaReminderResponseTime/checkExportTask?" + (new Date()).getTime(),
                        ...
                        if (data && data.success == true) {
                            ...
                            top.$.jBox.confirm("确认要导出数据吗？", "系统提示", function (v, h, f) {
                                if (v == "ok") {
                                    ...
                                    $.ajax({
                                        type: "POST",
                                        url: "${ctx}/rpt/provider/kaReminderResponseTime/export?" + (new Date()).getTime(),
                                        data: $(searchForm).serialize(),
                                        success: function (data) {
                                            if (ajaxLogout(data)) {
                                                return false;
...
<ul class="nav nav-tabs">
    <li class="active"><a href="javascript:void(0);">KA回复时效</a></li>
    <li>
        <a href="${ctx}/rpt/provider/reminderResponseTime/reminderResponseTimeReport">催单回复时效</a>
    </li>
</ul>

<form:form id="searchForm" modelAttribute="rptSearchCondition"
           action="${ctx}/rpt/provider/kaReminderResponseTime/kaReminderResponseTimeReport" method="post"
