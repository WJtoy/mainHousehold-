...
var AreaLevelUtils = {
    ...
    showCities:function(i) {
        ...
        if($("input.current2",self.document).attr("data-checkselect") == "true"){
            ...
            $("input.current2",self.document).nextAll().last().val(0);
        }else{
            $("input.current2",self.document).prev().val(self.province.id);
        }
    ...
    showCounties:function(i){
        ...
        if($("input.current2",self.document).attr("data-checkselect") == "true"){
            ...
            $("input.current2",self.document).nextAll().last().val(1);
        }
    ...
    addrInputAll:function(cuntryId){
        ...
        $("input.current2",this.document).nextAll().last().val(2); //add on 2020-8-11
...
window.AreaLevelUtils = top.window.AreaLevelUtils || parent.window.AreaLevelUtils || AreaLevelUtils;
window.AreaLevelUtils.init();