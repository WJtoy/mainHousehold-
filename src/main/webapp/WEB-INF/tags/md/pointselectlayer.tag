...
<script type="text/javascript">
    $("#${id}Button").click(function(){
        ...
        var replyIdex = top.layer.open({
            ...
            zIndex:19891015,
            title:'选择${title}',
            content: "${ctx}/md/servicepoint/select?dialogType=layer&area.id=${areaId}&showArea=${showArea}&noSubEnginner=${noSubEnginner}&noblackList=${noblackList}&hidePhone=${hidePhone}",
            shade: 0.3,
