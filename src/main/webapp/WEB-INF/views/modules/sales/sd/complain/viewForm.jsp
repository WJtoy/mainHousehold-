...
<head>
	...
	<%@ include file="/WEB-INF/views/modules/sales/sd/complain/tpl/attacheView.html" %>
    <%@ include file="/WEB-INF/views/modules/sales/sd/complain/tpl/complainList.html" %>
	<script type="text/javascript">
		...
		function closeme(){
		 ...
		 $(document).ready(function() {
		     //加载投日志列表
            SalesOrderService.showComplainLogList('${complain.id}','${complain.quarter}');
			...
			<div class="span4">
				<div class="control-group">
					...
					<div class="controls">
						...
						<%--onclick="SalesOrderService.showComplainOrderDetail('${complain.orderId}','${complain.quarter}');--%>
						<a style="line-height: 30px" class="input-block-level"  href="javascript:void(0);">${complain.orderNo}</a>
					</div>
				</div>
			</div>
			<div class="span4">
