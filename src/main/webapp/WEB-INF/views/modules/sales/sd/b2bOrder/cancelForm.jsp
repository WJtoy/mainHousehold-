...
<form:form id="inputForm" modelAttribute="order" method="post" class="form-horizontal">
    ...
    <div class="form-actions">
        <c:if test="${canAction == true }">
            <shiro:hasPermission name="b2b:sales:order:transfer"><input id="btnSubmit" class="btn btn-primary" type="submit" value="保 存"/>&nbsp;</shiro:hasPermission>
        </c:if>
                ...
                layer.confirm(
                    ...
                    ,function(index){
                        ...
                        $.ajax({
                            ...
                            cache: false,
                            type: "POST",
                            url: "${ctx}/sales/sd/b2bOrder/cancelOrderTransition",
                            data:$(form).serialize(),
                            beforeSend: function () {
