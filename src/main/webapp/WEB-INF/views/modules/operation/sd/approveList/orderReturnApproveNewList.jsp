  ...
  <body>
    <ul class="nav nav-tabs">
		...
		<c:if test="${isShowXYYOrderReturnApproveList == true}">
			<li><a href="${ctx}/operation/sd/orderList/xyyOrderReturnApproveList" title="待厂商审核(B2B)">待厂商审核(B2B)</a></li>
		</c:if>
	</ul>
	<c:set var="currentuser" value="${fns:getUser() }" />
	<form:form id="searchForm" modelAttribute="order"  action="${ctx}/operation/sd/orderList/orderReturnApproveList" method="post" class="breadcrumb form-search">
