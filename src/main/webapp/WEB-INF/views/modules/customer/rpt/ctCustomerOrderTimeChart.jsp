    ...
    <script type="text/javascript" language="javascript">
        $(document).ready(function() {
            $("#btnSubmit").click(function() {
                ...
                $("#searchForm").attr("action","${ctx}/customer/rpt/customerOrderTime/customerOrderTimeChart");
                $("#searchForm").submit();
            });
        });
    </script>
...
<ul id="navtabs" class="nav nav-tabs">
    <li>
        <a href="${ctx}/customer/rpt/customerOrderTime/customerOrderTimeReport">工单时效统计</a>
    </li>
    <li class="active"><a href="javascript:void(0);">工单时效图表</a></li>

</ul>
<c:set var="currentuser" value="${fns:getUser() }" />
<form:form id="searchForm" modelAttribute="rptSearchCondition" action="${ctx}/customer/rpt/customerOrderTime/customerOrderTimeChart" method="post" class="breadcrumb form-search">
    <div>
