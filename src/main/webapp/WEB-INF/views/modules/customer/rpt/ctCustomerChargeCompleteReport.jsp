    ...
    <script type="text/javascript" language="javascript">
        $(document).ready(function() {
            ...
            $("#btnSubmit").click(function(){
                ...
                $("#pageNo").val(1);
                $("#searchForm").attr("action","${ctx}/customer/rpt/customerCharge/customerChargeCompleteReport");
                $("#searchForm").submit();
            });
...
<ul class="nav nav-tabs">
    <li>
        <a href="${ctx}/customer/rpt/customerCharge/customerChargeSummaryRpt">订单|消费|充值</a>
    </li>
...
<form:form id="searchForm" modelAttribute="rptSearchCondition" action="${ctx}/customer/rpt/customerCharge/customerChargeCompleteReport" method="post" class="breadcrumb form-search">
