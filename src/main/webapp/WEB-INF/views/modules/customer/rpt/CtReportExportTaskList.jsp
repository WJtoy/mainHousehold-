...
<form:form id="searchForm" modelAttribute="rptSearchCondition" action="${ctx}/customer/rpt/exportTask/listCustomer"
    ...
    <div>
        ...
        <input id="endDate" name="endDate" type="text" readonly="readonly" style="width:98px" maxlength="20" class="input-small Wdate"
               ...
               onclick="WdatePicker({dateFmt:'yyyy-MM-dd',isShowClear:false});"/>
        &nbsp;&nbsp;
        <shiro:hasPermission name="rpt:customer:download:view"><input id="btnSubmit" class="btn btn-primary" type="button" value="查询"/></shiro:hasPermission>
        &nbsp;&nbsp;
    </div>
</form:form>
    ...
    <table id="contentTable"
        ...
        <c:forEach items="${page.list}" var="item">
            ...
            <tr>
                ...
                <td>
                    <shiro:hasPermission name="rpt:customer:download:export">
                    <c:if test="${item.status >= 40}">
                        <a class="btn btn-success" href="${ctx}/customer/rpt/exportTask/downloadServicePointReportExcel?taskId=${item.id}&reportId=${item.reportId}">下载</a>
                    </c:if>
                    </shiro:hasPermission>
                </td>
            </tr>
