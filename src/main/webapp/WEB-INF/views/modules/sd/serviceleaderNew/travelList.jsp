...
<head>
    <title>异常工单-远程单列表</title>
    <meta name="description" content="远程费超过20">
...
<ul id="navtabs" class="nav nav-tabs">
    ...
    <li class="active"><a href="javascript:void(0);" title="远程费超20的工单">远程单</a></li>
</ul>
<c:set var="currentuser" value="${fns:getUser() }"/>
<form:form id="searchForm" modelAttribute="order" action="${ctx}/sd/order/serviceLeaderNew/travellist" method="post" class="form-inline">
...
<table id="contentTable" class="table table-striped table-bordered table-condensed table-hover">
    ...
    <c:forEach items="${page.list}" var="order">
        ...
        <tr>
            ...
            <c:choose>
                <c:when test="${order.isNotAccept(30)}">
                    <td rowspan="${rowspan}">
                        ...
                        <img src="${ctxStatic}/images/${empty order.orderCondition.engineer? "people": (order.orderCondition.engineer.appLoged==1?"phone":"people")}.png">
            ...
            <td rowspan="${rowspan}">${fns:formatDouble(order.orderFee.engineerTravelCharge + order.orderFee.engineerOtherCharge,2)}</td>
