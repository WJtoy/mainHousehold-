...
<script type="text/javascript">
    ...
    $(document).on("click", "#btnExport", function () {
        ...
        layer.confirm('确定导出配件列表吗?', {icon: 3, title: '系统确认'}, function (index, layero) {
            ...
            jQuery('<form id="exportForm" action="${ctx}/sd/kefuOrderMaterial/closelist/export" method="post" style="display:none;">'+ html + '</form>')
...
<ul id="navtabs" class="nav nav-tabs">
	...
	<li class="active"><a href="javascript:void(0);" title="已完成配件单">已完成<span id="spn_count" class="badge badge-info">${page !=null ?page.count:''}</span></a></li>
...
<form:form id="searchForm" modelAttribute="searchModel" method="post" action="${ctx}/sd/kefuOrderMaterial/closelist" class="breadcrumb form-search">
