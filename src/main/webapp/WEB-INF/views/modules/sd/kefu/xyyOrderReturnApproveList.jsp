...
//		$(document).on("click", "#btnReject", returnaction);
  ...
  <body>
    <ul class="nav nav-tabs">
		<li><a href="${ctx}/sd/order/kefu/orderReturnApproveList" title="待审核列表">待审核列表</a></li>
		<li class="active"><a href="javascript:void(0);">待厂商审核(B2B)</a></li>
	</ul>
	<c:set var="currentuser" value="${fns:getUser() }" />
	<form:form id="searchForm" modelAttribute="order"  action="${ctx}/sd/order/kefu/xyyOrderReturnApproveList" method="post" class="breadcrumb form-search">
