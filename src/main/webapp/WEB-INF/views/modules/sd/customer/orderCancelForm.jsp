...
<body>
	<form:form id="inputForm" modelAttribute="order" method="post" class="form-horizontal">
		...
		<div class="form-actions">
			...
			<shiro:hasPermission name="sd:order:cancel"><input id="btnSubmit" class="btn btn-primary" type="submit" value="保 存"/>&nbsp;</shiro:hasPermission>
			</c:if>
                    ...
                    layer.confirm(
                        ...
                        ,function(index){
							...
							$.ajax({
                                ...
                                cache: false,
								type: "POST",
								url: "${ctx}/sd/order/cancel?"+ (new Date()).getTime(),
								data:$(form).serialize(),
                                beforeSend: function () {
