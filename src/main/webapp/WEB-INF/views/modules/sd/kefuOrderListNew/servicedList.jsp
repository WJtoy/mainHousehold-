...
<ul id="navtabs" class="nav nav-tabs">
    ...
    <li class="active"><a href="javascript:void(0);" title="待回访的工单">待回访<span id="spn_order_count" class="badge badge-info">${page !=null ?page.count:''}</span></a></li>
...
<form:form id="searchForm" modelAttribute="order" method="post" class="form-inline">
    ...
    <div style="margin-top:0px; display:none;" id="div_search_customer">
        <div>
            ...
            <label>区域：</label>
            <%--
            <sys:treeselect id="area" name="area.id" value="${order.area.id}" levelValue="${order.areaLevel}"
                            nodeLevel="true"
        ...
        <div style="margin-top:5px;">
            ...
            &nbsp;&nbsp;
            <%--<label for="appointmentFlag" title="有预约">预约：</label>--%>
            <%--<input id="appointmentFlag" name="appointmentFlag"--%>
                   <%--<c:if test="${order.appointmentFlag==1}">checked="checked"</c:if> type="checkbox" value="1"--%>
                   <%--class="input-small"/> &nbsp;&nbsp;--%>
    ...
    <c:forEach items="${page.list}" var="order">
        ...
        <tr>
            ...
            <td rowspan="${rowspan}">
                <c:choose>
                    ...
                    <c:when test="${not empty order.repeateNo}">
                        <a href="javascript:void(0);" onclick="Order.showFollowUpFailOrderDetail('${order.id}','${order.quarter}',${order.orderCondition.orderServiceType});">
            ...
            <td rowspan="${rowspan}">
                ...
                <img src="${ctxStatic}/images/visit.png" title="等待客评" style="width: 13px;height: 13px">
            </td>
