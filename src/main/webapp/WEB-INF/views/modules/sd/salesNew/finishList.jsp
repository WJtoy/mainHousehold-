...
<ul id="navtabs" class="nav nav-tabs">
    ...
    <li class="active"><a href="javascript:void(0);" data-toggle="tooltipnorth" data-tooltip="已完成订单列表">已完成</a></li>
...
<form:form id="searchForm" modelAttribute="order" action="${ctx}/sd/order/salesNew/finishlist" method="post"
    ...
    <div style="margin-top:5px">
        ...
        <input id="partsFlag" name="partsFlag"
               ...
               class="input-small"/>
        &nbsp<label for="reminderFlag" title="有催单申请">催单：</label>
    ...
    <table id="contentTable" class="table table-bordered table-condensed table-striped"
        ...
        <c:forEach items="${page.list}" var="o" varStatus="i" begin="0">
            <tr>
                <td>${i.index+1}</td>
                <td>
                    <a href="javascript:void(0);" onclick="SalesOrderService.viewOrderDetail('${o.id}','${o.quarter}');"><abbr
                ...
                <td>
                    ...
                    <c:if test="${(o.orderCondition.status.value == '80' || o.orderCondition.status.value == '85') && (o.writeOff==1 || o.writeOff==3)}"><br/><span
