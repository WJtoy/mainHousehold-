...
<ul id="navtabs" class="nav nav-tabs">
    ...
    <li><a href="${ctx}/sd/order/salesNew/list" data-toggle="tooltipnorth" data-tooltip="&nbsp;&nbsp;处理中订单列表">处理中</a>
    </li>
...
<form:form id="searchForm" modelAttribute="order" action="${ctx}/sd/order/salesNew/alllist" method="post"
                ...
                <td>
                    <c:if test="${o.orderCondition.replyFlagKefu == 1 }">
                        <a href="javascript:void(0);" style="color: red;"
                           onclick="SalesOrderService.viewOrderDetail('${o.id}','${o.quarter}');"><abbr
