            ...
            $("#inputForm").validate({
                submitHandler: function (form) {
                    ...
                    $.ajax({
                        ...
                        cache: false,
                        type: "POST",
                        url: "${ctx}/sd/order/servicepointplan?" + (new Date()).getTime(),
                        data: $(form).serialize(),
                        beforeSend: function () {
...
<body>
<form:form id="inputForm" modelAttribute="order" action="${ctx}/sd/order/servicepointplan" method="post"
    ...
    <div class="row-fluid">
        <div class="span10">
            <div class="control-group">
                ...
                <div class="controls">
                    <md:engselectlayer id="engineer" name="orderCondition.engineer.id" value=""
