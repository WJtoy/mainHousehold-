...
<ul id="navtabs" class="nav nav-tabs">
    ...
    <li><a href="${ctx}/sd/customer/reminder/list/all" title="所有催单列表">所有</a></li>
</ul>
<c:set var="currentuser" value="${fns:getUser() }"/>
<form:form id="searchForm" modelAttribute="reminder" action="${ctx}/sd/customer/reminder/list/process" method="post" class="breadcrumb form-search">
