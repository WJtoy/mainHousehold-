<%@ taglib prefix="shifo" uri="http://shiro.apache.org/tagss" %>
<!DOCTYPE html>
<%@ page contentType="text/html;charset=UTF-8" %>
<%@ include file="/WEB-INF/views/include/taglib.jsp" %>
<html style="overflow-x:hidden;overflow-y:auto;">
<head>
    <title>催单列表-已处理</title>
    <meta name="description" content="跟单已处理">
...
<ul id="navtabs" class="nav nav-tabs">
    <shiro:hasPermission name="sd:reminder:view">
        ...
        <li class="active"><a href="javascript:void(0);" title="跟单已处理列表">已处理</a></li>
...
<form:form id="searchForm" modelAttribute="reminder" action="${ctx}/sd/reminder/list/haveConfirmedList" method="post" class="breadcrumb form-search">
    ...
    <table id="contentTable" class="table table-striped table-bordered table-condensed table-hover" style="table-layout:fixed;">
        ...
        <c:forEach items="${page.list}" var="model">
            ...
            <tr>
                ...
                <td>${model.orderNo}</td>
                <td>
                    <a href="javascript:void(0);" onclick="Order.reReminder('${model.id}','','${model.quarter}','','${model.itemNo}');">${model.reminderNo}</a>
                </td>
