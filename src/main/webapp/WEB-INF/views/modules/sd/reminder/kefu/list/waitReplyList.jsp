...
<ul id="navtabs" class="nav nav-tabs">
    <shiro:hasPermission name="sd:reminder:view">
        <li class="active"><a href="javascript:void(0);" title="待客服回复列表">待回复</a></li>
...
<form:form id="searchForm" modelAttribute="reminder" action="${ctx}/sd/kefu/reminder/list/process" method="post" class="breadcrumb form-search">
    ...
    <table id="contentTable" class="table table-striped table-bordered table-condensed table-hover">
        ...
        <c:forEach items="${page.list}" var="model">
            ...
            <tr>
                ...
                <td>${model.orderNo}</td>
                <td>
                    <a href="javascript:void(0);" onclick="Order.reminderToProcess('${model.id}','${model.quarter}','${model.itemId}');">${model.reminderNo}</a>
                </td>
