...
<form:form id="searchForm" modelAttribute="reminder" action="${ctx}/sd/kefu/reminder/list/haveRepliedList" method="post" class="breadcrumb form-search">
                ...
                <td>
                    ...
                    <c:choose>
                        <c:when test="${model.status==4}">
                            <c:if test="${model.orderCompleteTimeliness>24}">
                                <c:set var="cutoffClass" value="timeout"/>
                            </c:if>
                        </c:when>
                        <c:otherwise>
