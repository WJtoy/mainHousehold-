...
<ul id="navtabs" class="nav nav-tabs">
    <shiro:hasPermission name="sd:abnormal:view">
       <%-- <li class="active"><a href="javascript:void(0);" title="异常单待处理">待处理</a></li>--%>
        ...
        <li><a href="${ctx}/sd/abnormalForm/waitProcessList" title="审单异常">审单异常</a></li>
...
<form:form id="searchForm" modelAttribute="abnormalForm" action="${ctx}/sd/abnormalForm/oldAppAbnormalList" method="post" class="form-inline">
