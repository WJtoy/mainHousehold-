...
<head>
    ...
    <meta name="description" content="处理中">
...
<ul id="navtabs" class="nav nav-tabs">
    <shiro:hasPermission name="sd:complain:judge">
        ...
        <li  class="active"><a href="javascript:void(0);" title="处理中投诉单列表">处理中</a></li>
...
<form:form id="searchForm" modelAttribute="complain" action="${ctx}/sd/complain/dealinglist" method="post" class="form-inline">
            ...
            <tr>
                ...
                <td>
                    <c:choose>
                        <c:when test="${model.status.value eq '0' || model.status.value eq '1'}">
                            <shiro:hasPermission name="sd:complain:judge">
                                <a href="javascript:void(0);" class="btn btn-mini btn-warning" onclick="Order.complain_judgeNew('${model.id}','${model.quarter}');">判定</a>
                            </shiro:hasPermission>
                        </c:when>
                        <c:when test="${model.status.value eq '1'}">
                            <shiro:hasPermission name="sd:complain:complete">
