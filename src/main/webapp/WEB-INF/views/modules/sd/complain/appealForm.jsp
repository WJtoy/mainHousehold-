		...
		$(document).ready(function() {
			...
			$("#inputForm").validate({
				submitHandler: function(form){
					var complainContent = $("#content").val();
					...
					$.ajax({
                        ...
                        cache: false,
						type: "POST",
						url: "${ctx}/sd/complain/ajax/appealSave?"+ (new Date()).getTime(),
						data:$(form).serialize(),
                        beforeSend: function () {
...
<body>
	<form:form id="inputForm" modelAttribute="complainlog" action="${ctx}/sd/complain/saveAppeal" method="post" class="form-horizontal">
