...
<head>
	...
	<script type="text/javascript">
        function search1(){
            $("#pageNo").val(1);
            $("#searchForm").attr("action","${ctx}/fi/servicepointwithdraw");
            $("#searchForm").submit();
            return false;
        }
  ...
  <body>
	...
	<form:form id="searchForm" action="${ctx}/fi/servicepointwithdraw/list" method="post" class="breadcrumb form-search">
		...
		<div style="margin-top:8px">
			...
			<label>　~　</label>&nbsp;&nbsp;&nbsp;<input id="payEndDate" name="payEndDate" type="text" readonly="readonly" style="width:127px" maxlength="20" class="input-small Wdate"
									value="${payEndDate}" onclick="WdatePicker({dateFmt:'yyyy-MM-dd',isShowClear:true});"/>
			<label>付款状态：</label>
			<select id="withdrawStatus" name="withdrawStatus" class="input-small" style="width:250px;">
