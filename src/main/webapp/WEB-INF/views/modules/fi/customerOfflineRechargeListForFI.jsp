    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $("#btnSubmit").on("click", function(){
                ...
                var url = "${ctx}/fi/customercurrency/customerofflinelist?firstSearch=" + firstSearch + "&directPage=fiManager";
...
<form:form id="searchForm" modelAttribute="search" action="${ctx}/fi/customercurrency/customerofflinelist?directPage=fiManager" method="post" class="breadcrumb form-search">
