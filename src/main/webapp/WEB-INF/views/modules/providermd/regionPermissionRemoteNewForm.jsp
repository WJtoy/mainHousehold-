    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $("#btnSubmit").click(function () {
                ...
                var loadingIndex;
                var options = {
                    url: "${ctx}/provider/md/regionPermissionNew/saveNew",  //默认是form的action， 如果申明，则会覆盖
        ...
        function load(){
            ...
            $.ajax({
                url: "${ctx}/provider/md/regionPermissionNew/findRegionPermissionNew",
                type: 'post',
                data : data,
                    ...
                    <c:choose>
                        <c:when test="${i.index == 0}">
                            ...
                            <c:choose>
                                ...
                                <td style="display: flex;width: 96.5%;line-height: 35px;justify-content: flex-start;flex-wrap: wrap;" class="left-td">
                                    <c:forEach items="${areaCounty.subAreas}" var="subArea" varStatus="j">
                                        <div style="margin-bottom:10px;line-height: 28px;padding-left: 30px;position: relative;width: 20%;text-align: left;">
                                            <input type="checkbox" name="subArea" lay-filter="subArea" data-countyid="${areaCounty.id}"
                                                   value="${subArea.id}" lay-skin='primary'>
                                                    ${subArea.name}
                                        </div>
                                    </c:forEach>
                                </td>
...
<div id="editBtn">
<shiro:hasPermission name="md:regionPermissionArea:edit"><input id="btnSubmit" class="btn btn-primary layui-btn" type="button" lay-submit lay-filter="formSave" value="保 存"
           style="margin-left: 410px;margin-top: 10px;width: 85px;background: #0096DA;border-radius: 4px;"/></shiro:hasPermission>
