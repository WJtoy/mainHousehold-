					...
					$(document).ready(function() {
						$("#inputForm").validate({
							submitHandler: function(form){
								...
								$.ajax({
									url:"${ctx}/provider/md/customerBrand/ajaxSave",
									type:"POST",
									data:$(form).serialize(),
									dataType:"json",
									success: function(data){
										...
										if (data.success) {
											...
											if(pframe!=undefined){
												pframe.document.location="${ctx}/provider/md/customerBrand/getList?customerId="+customerId;
											}
										}else{
											setTimeout(function () {
												clickTag = 0;
...
<body>
<form:form id="inputForm" modelAttribute="customerBrand" action="${ctx}/provider/md/customerBrand/ajaxSave" method="post" class="form-horizontal">
