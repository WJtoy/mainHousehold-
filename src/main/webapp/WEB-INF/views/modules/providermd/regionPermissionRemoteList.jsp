...
<ul class="nav nav-tabs">
    <li class="active"><a href="javascript:void(0);">远程街道</a></li>
</ul>

<form:form id="searchForm" modelAttribute="regionPermission" action="${ctx}/provider/md/regionPermissionNew/regionPermissionRemoteList" method="post" class="b-form form-search">
