...
<html>
	...
	<meta name="decorator" content="default"/>
      ...
      <script type="text/javascript">
          ...
          function editCustomerShop(type,id) {
              var text = "添加店铺";
              var url = "${ctx}/md/customerShop/form";
              if(type == 2){
                  text = "修改店铺"
                  url = "${ctx}/md/customerShop/form?id=" + id;
              }
              top.layer.open({
                  type: 2,
                  id:"customerShop",
          ...
          function del(id, dataSource, customerId) {
              layer.confirm('确定要删除吗？', {
                  ...
                  $.ajax({
					  url:"${ctx}/md/customerShop/delete?id="+ id +"&dataSource="+ dataSource +"&customerId=" + customerId,
                      type:"POST",
                      dataType:"json",
  ...
  <body>
	...
	<form:form id="searchForm" modelAttribute="b2BCustomerMapping" action="${ctx}/md/customerShop/getList" method="post" class="breadcrumb form-search">
	...
	<shiro:hasPermission name="md:customershop:edit">
	...
	<table id="contentTable" class="table table-striped table-bordered table-condensed table-hover">
		<thead>
			<tr>
				...
				<th>备注</th>
				<shiro:hasPermission name="md:customershop:edit"><th width="100">操作</th></shiro:hasPermission>
			</tr>
		</thead>
		<tbody>
		...
		<c:forEach items="${page.list}" var="entity">
			<tr>
				...
				<shiro:hasPermission name="md:customershop:edit"><td>
