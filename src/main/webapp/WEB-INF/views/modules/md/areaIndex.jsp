...
<div id="content" class="row-fluid">
    ...
    <div id="right">
        <iframe id="areaContent" src="${ctx}/md/planradius/list?area.id=-1&area.parentIds=" width="100%" height="91%" frameborder="0"></iframe>
    </div>
</div>
<script type="text/javascript">
    var setting = {data:{simpleData:{enable:true,idKey:"id",pIdKey:"pId",rootPId:'0'}},
        callback:{onClick:function(event, treeId, treeNode){
                ...
                var id = treeNode.id;
                $('#areaContent').attr("src","${ctx}/md/planradius/list?area.id="+id);
