...
<html>
  ...
  <body>
	<form:form id="searchForm" modelAttribute="servicePointDto" action="${ctx}/md/servicepoint/findListByAreaIds" method="post" class="breadcrumb form-search" cssStyle="margin-top: 24px">
