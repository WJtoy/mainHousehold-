		...
		$(document).ready(function() {
			$("#inputForm").validate({
                submitHandler: function (form) {
                    ...
                    var options = {
                        url: "${ctx}/md/customer/price/saveNew?qCustomerId=${customerId}&qCustomerName=${customerName}&qProductCategoryId=${productCategoryId}&qProductCategoryName=${productCategoryName}&qProductId=${productId}&qProductName=${productName}&qFirstSearch=${qFirstSearch}",
                        type: 'post',
                        dataType: 'json',
                        data:$(form).serialize(),
	...
	<form:form id="inputForm" modelAttribute="customerPrice" action="" method="post" class="form-horizontal">
		...
		<div id="main">
			...
			<div class="control-group">
				...
				<div class="controls lineBot">
					<form:textarea path="remarks" htmlEscape="false" rows="3" maxlength="255" class="input-xlarge" cssStyle="width: 513px;height: 56px;"/>
				</div>
			</div>
