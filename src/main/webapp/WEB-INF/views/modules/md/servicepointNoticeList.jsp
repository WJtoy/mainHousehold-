    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $("#btnSubmit").click(function() {
                ...
                $("#searchForm").attr("action","${ctx}/md/sysNotice/servicePointNoticeList");
                $("#searchForm").submit();
            });
        });
...
<form:form id="searchForm" modelAttribute="systemNotice" action="${ctx}/md/sysNotice/" method="post" class="breadcrumb form-search">
    <div>
