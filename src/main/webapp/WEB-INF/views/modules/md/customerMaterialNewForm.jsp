...
<head>
	...
	<script type="text/javascript">
				...
				submitHandler: function(form){
                    ...
                    if($("#treeTable input[type='checkbox'][name='checkedRecords']:checkbox:checked").length == 0){
                        ...
                        var confirmIndex = layer.confirm('您没有选择配件确定要继续提交吗', {
                            ...
                            $.ajax({
                                url:"${ctx}/md/customerMaterialNew/save",
                                type:"POST",
                                data: entity,
                                dataType:"json",
		...
		function changeProduct(){
			...
			$.ajax({
						url:"${ctx}/md/customerMaterialNew/ajax/getMaterialListByProductId?productId="+productId +"&customerId=" + customerId,
						success:function (e) {
							if(e.success == true){
								var material_sel=[];
...
<form:form id="inputForm" modelAttribute="customerMaterial" action="${ctx}/md/customerMaterialNew/save" method="post" class="form-horizontal">
