...
<form:form id="inputForm" modelAttribute="dict" action="${ctx}/sys/dict/save" method="post" class="form-horizontal">
    ...
    <div class="control-group">
        ...
        <div class="controls">
            <c:choose>
            <c:when test="${dict.id == null}">
                <form:input path="type" htmlEscape="false" maxlength="50" class="required abc"/>
            </c:when>
            <c:otherwise>
                <form:input path="type" readonly="true" htmlEscape="false" maxlength="50" class="required"/>
            </c:otherwise>
        </c:choose>
        </div>
    </div>
    ...
    <div class="control-group">
        ...
        <div class="controls">
            <c:choose>
                ...
                <c:otherwise>
                    <form:input path="value" readonly="true" htmlEscape="false" maxlength="50" class="required"/>
                </c:otherwise>
            </c:choose>
        </div>
    </div>
