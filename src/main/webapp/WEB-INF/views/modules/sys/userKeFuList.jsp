...
<head>
    ...
    <script type="text/javascript">
        ...
        function search() {
            $("#pageNo").val(1);
            $("#searchForm").attr("action", "${ctx}/sys/userKeFu/list");
            $("#searchForm").submit();
            return false;
        }
...
<body>
    <ul class="nav nav-tabs">
        ...
        <li class="active"><a href="javascript:void(0);">客服</a></li>
        <li><a href="${ctx}/sys/userServicePoint/list">网点</a></li>

    </ul>
    <form:form id="searchForm" modelAttribute="user" action="${ctx}/sys/userKeFu/list" method="post"
               class="form-inline">
    ...
    <table id="contentTable" class="table table-striped table-bordered table-condensed table-hover">
        ...
        <c:forEach items="${page.list}" var="user">
            ...
            <tr id="tr_${user.id}">
                ...
                <td>
                    <c:choose>
                        <c:when test="${user.managerFlag == 1}">
                            客服主管
                        </c:when>
                        <c:when test="${user.managerFlag == 0}">
                            普通客服
                        </c:when>
                        <c:when test="${user.managerFlag == 2}">
                            客服助理
                        </c:when>
                    </c:choose>
