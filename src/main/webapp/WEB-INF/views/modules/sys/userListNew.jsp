...
<head>
    ...
    <script type="text/javascript">
        ...
        function editUser(id) {
            ...
            var  text = "添加用户";
            var  url = "${ctx}/sys/user/form?type=1";
        ...
        function removeUser(userId,userName){
            var typeName = ('用户');
            layer.confirm(
                '确认要删除用户' +'<label style="color:#63B9E6">'+ userName +'</label>吗？',
                {
                    btn: ['确定','取消'], //按钮
                    title:'提示'
                }, function(index){
