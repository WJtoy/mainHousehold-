    ...
    <script type="text/javascript" language="javascript">
        $(document).ready(function () {
            $("#btnSubmit").click(function() {
                ...
                $("#searchForm").attr("action","${ctx}/rpt/provider/keFuCompletedMonth/keFuCompletedMonthChart");
                $("#searchForm").submit();
            });
        });
    </script>
...
<ul class="nav nav-tabs">
    <li>
        <a href="${ctx}/rpt/provider/keFuCompletedMonth/keFuCompletedMonthRpt">每月完工单情况</a>
    </li>
