    ...
    <script type="text/javascript" language="javascript">
        $(document).ready(function () {
            ...
            $("#btnSubmit").click(function () {
                ...
                $("#searchForm").attr("action", "${ctx}/rpt/provider/gradedOrder/areaCompleteOrderRpt");
                $("#searchForm").submit();
            });
                        ...
                        if(data && data.success == true){
                            ...
                            top.$.jBox.confirm("确认要导出数据吗？", "系统提示", function (v, h, f) {
                                if (v == "ok") {
                                    ...
                                    $.ajax({
                                        type: "POST",
                                        url: "${ctx}/rpt/provider/gradedOrder/areaCompletedExport?"+ (new Date()).getTime(),
                                        data:$(searchForm).serialize(),
                                        success: function (data) {
                                            if(ajaxLogout(data)){
                                                return false;
...
<ul class="nav nav-tabs">
    ...
    <li class="active"><a href="javascript:void(0);">区/县每日完成统计</a></li>

</ul>
<c:set var="currentuser" value="${fns:getUser()}"/>
<form:form id="searchForm" modelAttribute="rptSearchCondition"
           action="${ctx}/rpt/provider/gradedOrder/areaCompleteOrderRpt" method="post" class="breadcrumb form-search">
    <div style="width: 90%">
                    ...
                    <c:when test="${rowIndex < list.size()}">
                        <tr>
                            ...
                            <c:forEach var="i" begin="1" end="${rptSearchCondition.days}" step="1">
                                ...
                                <td>
                                    <fmt:formatNumber maxFractionDigits="0">${aItem[colname]}</fmt:formatNumber>
                                </td>
                            </c:forEach>
                            <td>
