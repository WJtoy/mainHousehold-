    ...
    <script type="text/javascript" language="javascript">
        $(document).ready(function () {
            $("#btnSubmit").click(function () {
                ...
                $("#searchForm").attr("action", "${ctx}/rpt/provider/customerOrderPlan/customerOrderPlanDailyChart");
                $("#searchForm").submit();
            });
        });
    </script>
...
<ul class="nav nav-tabs">
    <li>
        <a href="${ctx}/rpt/provider/customerOrderPlan/customerOrderPlanDailyReport">客户每日下单</a>
    </li>
