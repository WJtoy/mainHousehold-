    ...
    <script type="text/javascript" language="javascript">
        $(document).ready(function () {
            ...
            $("#btnSubmit").click(function () {
                ...
                $("#searchForm").attr("action", "${ctx}/rpt/provider/crushCoverage/crushCoverageReport");
                $("#searchForm").submit();
            });
            ...
            $("#btnExport").click(function () {+
                top.$.jBox.confirm("确认要导出数据吗？", "系统提示", function (v, h, f) {
                    if (v == "ok") {
                        ...
                        $.ajax({
                            type: "POST",
                            url: "${ctx}/rpt/provider/crushCoverage/export?" + (new Date()).getTime(),
...
<ul class="nav nav-tabs">
    <li class="active"><a href="javascript:void(0);">突击区域报表</a></li>
</ul>

<form:form id="searchForm" modelAttribute="rptSearchCondition" action="${ctx}/rpt/provider/crushCoverage/crushCoverageReport" method="post" class="breadcrumb form-search">
        <div>
            ...
            &nbsp;&nbsp;
            <shiro:hasPermission name="rpt:crushCoverageReport:view"><input id="btnSubmit" class="btn btn-primary" type="button" value="查询"/></shiro:hasPermission>
            &nbsp;&nbsp;
            <shiro:hasPermission name="rpt:crushCoverageReport:export"><input id="btnExport" class="btn btn-primary" type="button" value="导出"/></shiro:hasPermission>
    </div>
</form:form>
