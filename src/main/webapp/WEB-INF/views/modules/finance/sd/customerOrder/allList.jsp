...
<form:form id="searchForm" modelAttribute="order" action="${ctx}/sd/finance/customerOrder/alllist" method="post"
                ...
                <c:if test="${ o.canEdit() || o.canCanceled()}">
                    <div class="btn-group">
                        ...
                        <ul class="dropdown-menu">
                            <c:if test="${ o.canEdit() }">
                                <shiro:hasPermission name="sd:order:edit">
                                    <li><a href="${ctx}/sd/order/edit?id=${o.id}&actiontype=cust_all"><i class="icon-pencil"></i>修改</a>
                                    </li>
                                </shiro:hasPermission>
                            </c:if>
