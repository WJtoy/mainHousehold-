...
<ul id="navtabs" class="nav nav-tabs">
    <shiro:hasPermission name="sd:salespraise:view">
        <li><a href="${ctx}/sd/finance/praise/pendingReviewList" title="待审核">待审核</a></li>
        <li><a href="${ctx}/sd/finance/praise/approvedList" title="已审核">已审核</a></li>
        <li class="active"><a href="javascript:void(0)" title="所有">所有</a></li>
    </shiro:hasPermission>
</ul>
<form:form id="searchForm" modelAttribute="praisePageSearchModel" action="${ctx}/sd/finance/praise/findAllList" method="post" class="breadcrumb form-search">
    ...
    <div style="margin-top: 8px">
        ...
        <label>状&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;态：</label>
        <form:select path="status" cssClass="input-small" cssStyle="width:134px;">
            <form:option value="0" label="所有"/>
            <form:option value="20" label="待审核"/>
        ...
        <c:forEach items="${page.list}" var="model">
            ...
            <tr>
               ...
               <%-- <td>${model.customerPraiseFee}</td>--%>
                ...
                <c:choose>
                    <c:when test="${model.status == 10 || model.status == 20}">
                        <td></td>
                        <td></td>
                    </c:when>
                    <c:otherwise>
