...
<ul id="navtabs" class="nav nav-tabs">
    ...
    <li class="active"><a href="javascript:void(0);" data-toggle="tooltipnorth" data-tooltip="催单列表">催单</a></li>
    <li><a href="${ctx}/sd/finance/customerOrder/praiseList" data-toggle="tooltipnorth" data-tooltip="好评单列表">好评</a></li>
</ul>

<form:form id="searchForm" modelAttribute="order" action="${ctx}/sd/finance/customerOrder/reminderList" method="post"
    ...
    <div style="margin-top:5px">
        ...
        <input id="completeBegin" name="completeBegin" type="text" readonly="readonly"
               ...
               onclick="WdatePicker({minDate:'#F{$dp.$D(\'completeEnd\',{M:-1})}',maxDate:'#F{$dp.$D(\'completeEnd\')}',dateFmt:'yyyy-MM-dd',isShowClear:false});"/>
        <label>~</label>&nbsp;&nbsp;&nbsp;
        <input id="completeEnd" name="completeEnd" type="text" readonly="readonly" style="width:95px" maxlength="20"
               ...
               onclick="WdatePicker({minDate:'#F{$dp.$D(\'completeBegin\')}',maxDate:'#F{$dp.$D(\'completeBegin\',{M:1})}',dateFmt:'yyyy-MM-dd',isShowClear:false});"/>
        <label>加急：</label>
                            ...
                            <div class="btn-group">
                                ...
                                <ul class="dropdown-menu">
                                    <c:if test="${ o.canEdit() }">
                                        <shiro:hasPermission name="sd:order:edit">
                                            <li><a
                                                    href="${ctx}/sd/order/edit?id=${o.id}&actiontype=cust_"><i class="icon-pencil"></i>修改</a>
                                            </li>
                                        </shiro:hasPermission>
                                    </c:if>
