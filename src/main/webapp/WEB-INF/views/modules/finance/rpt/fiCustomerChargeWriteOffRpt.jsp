    ...
    <script type="text/javascript" language="javascript">
        $(document).ready(function () {
            ...
            $("#btnSubmit").click(function () {
                ...
                $("#searchForm").attr("action", "${ctx}/finance/rpt/customerCharge/customerChargeWriteOffRpt");
                $("#searchForm").submit();
            });
...
<ul class="nav nav-tabs">
    <li><a href="${ctx}/finance/rpt/customerCharge/customerChargeSummaryRpt">订单|消费|充值</a>
    </li>
    <li><a href="${ctx}/finance/rpt/customerCharge/customerChargeCompleteReport">完工单</a>
    </li>
    <li><a href="${ctx}/finance/rpt/customerCharge/returnedOrderCancelledRpt">退单/取消单</a>
    </li>
