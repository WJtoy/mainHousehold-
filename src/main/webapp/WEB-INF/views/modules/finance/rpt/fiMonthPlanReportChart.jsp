    ...
    <script type="text/javascript" language="javascript">
        $(document).ready(function() {
            $("#btnSubmit").click(function() {
                ...
                $("#searchForm").attr("action","${ctx}/finance/rpt/customerMonthPlan/customerOrderMonthPlanDailyChart");
                $("#searchForm").submit();
            });
        });
    </script>
...
<ul class="nav nav-tabs">
    <li>
        <a href="${ctx}/finance/rpt/customerMonthPlan/customerMonthPlanDailyReport">客户月下单报表</a>
    </li>
    <li class="active"><a href="javascript:void(0);">客户月下单图表</a></li>
</ul>
<c:set var="currentuser" value="${fns:getUser()}" />
<form:form id="searchForm" modelAttribute="rptSearchCondition" action="${ctx}/finance/rpt/customerMonthPlan/customerOrderMonthPlanDailyChart" method="post" class="breadcrumb form-search">
    <div>
