    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $("#btnSubmit").click(function() {
                ...
                $("#searchForm").attr("action","${ctx}/finance/rpt/depositRecharge/depositRechargeSummary");
                $("#searchForm").submit();
            });
            ...
            $("#btnExport").click(function () {
                ...
                $.ajax({
                    type: "POST",
                    url: "${ctx}/finance/rpt/depositRecharge/checkExportTask?"+ (new Date()).getTime(),
                        ...
                        if(data && data.success == true){
                            ...
                            top.$.jBox.confirm("确认要导出数据吗？", "系统提示", function (v, h, f) {
                                if (v == "ok") {
                                    ...
                                    $.ajax({
                                        type: "POST",
                                        url: "${ctx}/finance/rpt/depositRecharge/export?"+ (new Date()).getTime(),
                                        data:$(searchForm).serialize(),
                                        success: function (data) {
                                            if(ajaxLogout(data)){
                                                return false;
...
<ul class="nav nav-tabs">
    ...
    <li>
        <a href="${ctx}/finance/rpt/depositRecharge/depositRechargeDetails">质保金明细</a>
    </li>
</ul>
<form:form id="searchForm" modelAttribute="rptSearchCondition" action="${ctx}/finance/rpt/depositRecharge/depositRechargeSummary" method="post" class="breadcrumb form-search"  >
    <div style="width: 90%">
        ...
        &nbsp;
        &nbsp;&nbsp;
        <shiro:hasPermission name="rpt:finance:depositRecharge:view"><input id="btnSubmit" class="btn btn-primary" type="submit" value="查询"/></shiro:hasPermission>
        &nbsp;&nbsp;
