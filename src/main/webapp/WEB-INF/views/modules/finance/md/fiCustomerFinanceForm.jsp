                ...
                $(document).ready(function() {
                    $("#inputForm").validate({
                        submitHandler: function(form){
                            ...
                            $.ajax({
                                url:"${ctx}/fi/md/customer/saveCustomerFinance?financeType=" + ${financeType},
                                type:"POST",
                                data:$(form).serialize(),
                                dataType:"json",
...
<form:form id="inputForm" modelAttribute="customerFinance" action="${ctx}/fi/md/customer/customerFinanceForms" method="post" class="form-horizontal">
