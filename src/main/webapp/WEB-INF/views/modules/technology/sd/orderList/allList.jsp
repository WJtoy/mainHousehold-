...
<ul id="navtabs" class="nav nav-tabs">
    ...
    <li><a href="${ctx}/technology/sd/orderList/rushinglist" title="突击中的工单">突击单</a></li>
...
<form:form id="searchForm" modelAttribute="order" action="${ctx}/technology/sd/orderList/alllist" method="post"
           class="form-inline">
