    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $("#btnSubmit").click(function() {
                ...
                $("#searchForm").attr("action","${ctx}/servicePoint/rpt/spPraiseDetails/servicePointPraiseDetailsRptData");
                $("#searchForm").submit();
            });
            ...
            $("#btnExport").click(function () {
                ...
                $.ajax({
                    type: "POST",
                    url: "${ctx}/servicePoint/rpt/spPraiseDetails/checkExportTask?"+ (new Date()).getTime(),
                        ...
                        if(data && data.success == true){
                            ...
                            top.$.jBox.confirm("确认要导出数据吗？", "系统提示", function (v, h, f) {
                                if (v == "ok") {
                                    ...
                                    $.ajax({
                                        type: "POST",
                                        url: "${ctx}/servicePoint/rpt/spPraiseDetails/export?"+ (new Date()).getTime(),
                                        data:$(searchForm).serialize(),
                                        success: function (data) {
                                            if(ajaxLogout(data)){
                                                return false;
...
<form:form id="searchForm" modelAttribute="rptSearchCondition" action="${ctx}/servicePoint/rpt/spPraiseDetails/servicePointPraiseDetailsRptData" method="post" class="breadcrumb form-search">
    ...
    <div style="width: 90%">
        ...
        &nbsp;&nbsp;
        <shiro:hasPermission name="rpt:servicePoint:servicePointPraiseDetails:view"><input id="btnSubmit" class="btn btn-primary" type="submit" value="查询" /></shiro:hasPermission>
        &nbsp;&nbsp;
        <shiro:hasPermission name="rpt:servicePoint:servicePointPraiseDetails:export"><input id="btnExport" class="btn btn-primary" type="button" value="导出"/></shiro:hasPermission>
    </div>
