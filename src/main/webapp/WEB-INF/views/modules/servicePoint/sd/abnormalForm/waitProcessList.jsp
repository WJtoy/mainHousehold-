...
<form:form id="searchForm" modelAttribute="abnormalForm" action="${ctx}/servicePoint/sd/abnormalForm/waitProcessList" method="post" class="form-inline">
