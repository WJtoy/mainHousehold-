            ...
            <td rowspan="${rowspan}">
                <c:choose>
                    ...
                    <c:when test="${not empty order.repeateNo}">
                        <a href="javascript:void(0);" onclick="ServicePointOrderService.showFollowUpFailOrderDetail('${order.id}','${order.quarter}',${order.orderCondition.orderServiceType});">
