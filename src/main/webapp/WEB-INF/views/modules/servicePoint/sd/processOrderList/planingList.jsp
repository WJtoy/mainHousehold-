...
<c:set var="processTimeout" value="${fns:getDictSingleValueFromMS('order_process_timeout', '48')}"/>
            ...
            <td rowspan="${rowspan}">
                <c:choose>
                    <c:when test="${order.isNotAccept(30)}">
                        <a href="javascript:void(0);" style="color: red;" onclick="ServicePointOrderService.showKefuOrderDetailForPlan('${order.id}','${order.quarter}',${order.orderCondition.orderServiceType});">
                    ...
                    <c:when test="${not empty order.repeateNo}">
                        <a href="javascript:void(0);" onclick="ServicePointOrderService.showKefuOrderDetailForPlan('${order.id}','${order.quarter}',${order.orderCondition.orderServiceType});">
