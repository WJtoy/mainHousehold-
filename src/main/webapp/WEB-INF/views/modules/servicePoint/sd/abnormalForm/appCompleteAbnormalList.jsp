...
<ul id="navtabs" class="nav nav-tabs">
    <shiro:hasPermission name="sd:abnormal:view">
        ...
        <li class="active"><a href="javascript:void(0);" title="app完工异常">app完工异常</a></li>
        <li><a href="${ctx}/servicePoint/sd/abnormalForm/processedList" title="异常单已处理">已处理</a></li>
    </shiro:hasPermission>
</ul>
<c:set var="currentuser" value="${fns:getUser()}"/>
<form:form id="searchForm" modelAttribute="abnormalForm" action="${ctx}/servicePoint/sd/abnormalForm/appCompleteAbnormalList" method="post" class="breadcrumb form-search">
    ...
    <div>
        ...
        <form:select path="subType" cssClass="input-small" cssStyle="width:180px;">
            ...
            <form:option value="20" label="安装异常"/>
            <form:option value="21" label="维修异常"/>
        </form:select>&nbsp;
        <label>所属网点：</label>
