...
<form:form id="searchForm" modelAttribute="order" action="${ctx}/servicePoint/sd/processOrderList/reservationlist" method="post" class="form-inline">
