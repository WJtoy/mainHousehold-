...
<html>
  <head>
	...
	<script type="text/javascript">
		...
		$(document).ready(function() {
            ...
            if($("#applyServicepointPraiseFee").val()==0.0){
                $("#servicePointFeeDiv").hide();
            }
		});
        ...
        $(document).on("click", "#btnSubmit", function () {
            ...
            var loadingIndex;
            var options = {
                url: "${ctx}/servicePoint/receipt/praise/applyPraise",                 //默认是form的action， 如果申明，则会覆盖
            ...
            top.layer.confirm('亲，请确认提交的是好评照片，否则会被考核的哟！', {icon: 3, title:'系统确认',cancel: function(index, layero){
                    clickTag = 0;
                    $btnSubmit.removeAttr('disabled');
                }}, function(index){
  ...
  <body>
    <ul class="nav nav-tabs" style="margin-left: 24px;margin-top: 24px">
	  <li><a href="${ctx}/servicePoint/sd/orderItemComplete/orderAttachmentForm?orderId=${praise.orderId}&quarter=${praise.quarter}">完工图片</a></li>
	...
	<c:if test="${canAction==true}">
		...
		<form:form id="inputForm" modelAttribute="praise" action="" method="post" class="form-horizontal">
			...
			<div class="row-fluid" id="servicePointFeeDiv">
				<div class="span12">
					<div class="control-group">
