    ...
    function resend(){
        ...
        top.layer.confirm('确定重发吗？', {icon: 3, title:'系统确认'}, function(index){
            ...
            $.ajax({
                cache: false,
                type: "POST",
                url: "${ctx}/b2b/rpt/processlog/canboAppointmentRetryData",
                dataType: 'json',
    ...
    function closeme(){
        ...
        top.layer.confirm('确定忽略本条信息吗？', {icon: 3, title:'系统确认'}, function(index){
            ...
            $.ajax({
                cache: false,
                type: "POST",
                url: "${ctx}/b2b/rpt/processlog/canboAppointmentCloseLog",
...
<body>
<form:form id="inputForm" modelAttribute="completedRetryBean" action="${ctx}/b2b/rpt/processlog/canboAppointment" method="post" class="form-horizontal">
    ...
    <div class="row-fluid">
        <div class="span4" style="margin-top: 20px">
            <div class="control-group">
                ...
                <label class="control-label" style="margin-left: 2px;min-height: 30px;">
