 ...
 */
@Slf4j
public class OnSiteServiceExecutor extends ServicePointExecutor {

    private OrderServicePointMessageMapper messageMapper;

    public OnSiteServiceExecutor(OrderServicePointService service) {
    ...
    public void process(MQOrderServicePointMessage.ServicePointMessage message){
        ...
        try {
            ...
            log.error("上门服务更新安维派单serviceFlag错误 orderId:{} ,servicePoint:{} ,engineer:{} ,update:{}",
                    message.getOrderId(),
