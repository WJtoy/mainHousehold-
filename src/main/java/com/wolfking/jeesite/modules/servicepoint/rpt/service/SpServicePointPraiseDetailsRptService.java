...
@Service
public class SpServicePointPraiseDetailsRptService {


    @Autowired
    private SpServicePointPraiseDetailsRptFeign spServicePointPraiseDetailsRptFeign;
    ...
    public Page<RPTKeFuPraiseDetailsEntity> getPraiseOrderList(Page<RPTKeFuPraiseDetailsEntity> page, Integer status,Long servicePointId,Date beginDate, Date endDate) {
        ...
        if ( beginDate != null && endDate != null) {
            ...
            if (microServicesProperties.getReport().getEnabled()) {
                MSResponse<MSPage<RPTKeFuPraiseDetailsEntity>> msResponse = spServicePointPraiseDetailsRptFeign.getServicePointPraiseDetailsList(search);
    ...
    public void checkRptExportTask(Integer status,Long servicePointId,Date beginDate, Date endDate, User user) {
        ...
        spReportExportTaskService.checkRptExportTask(RPTReportEnum.SP_SERVICEPOINT_PRAISE_DETAILS_RPT, user, searchConditionJson);
    }
    ...
    public void createRptExportTask(Integer status, Long servicePointId,Date beginDate, Date endDate,User user) {
        ...
        String searchConditionJson = RedisGsonUtils.toJson(searchCondition);
        spReportExportTaskService.createRptExportTask(RPTReportEnum.SP_SERVICEPOINT_PRAISE_DETAILS_RPT, RPTReportTypeEnum.ORDER_REPORT, user, reportTitle, searchConditionJson);
    }
