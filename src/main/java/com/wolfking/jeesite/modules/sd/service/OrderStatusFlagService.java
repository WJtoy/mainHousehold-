...
public class OrderStatusFlagService extends LongIDBaseService {
    ...
    public OrderStatusFlag getByOrderId(long orderId,String quarter){
        return dao.getById(orderId,quarter,false);
    }

    public OrderStatusFlag getByOrderId(long orderId,String quarter,Boolean fromMaster){
        if(orderId <= 0){
            return null;
        }
        return dao.getById(orderId,quarter,fromMaster);
    }
