...
public class OrderServicePointFee implements Serializable {
    ...
    private Double insuranceCharge = 0.00;//互助基金 20201-03-01 保险费 -> 互助基金
    ...
    private Double deposit = 0.00;//网点质保金(应付 扣减项) 2021-02-22
    ...
    @DecimalMin(value = "0.0",message = "互助基金不能小于0")
