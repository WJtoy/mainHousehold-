 ...
 * @date 2020/12/26
 * 移除can_rush
 * 客服增加自动客服(sub_flag=4),只查看orderCondition.kefu_type=1的单；
 */
@Controller
@RequestMapping(value = "${adminPath}/sd/order/kefuOrderListNew/")
@Slf4j
public class KefuOrderListNewController extends BaseController {
    ...
    @Autowired
    private KefuOrderListNewService kefuOrderListNewService;
    ...
    private static final String VIEW_NAME_PLANNING_LIST = "modules/sd/kefuOrderListNew/planingList";
    private static final String VIEW_NAME_NOAPPOINTMENT_LIST = "modules/sd/kefuOrderListNew/noAppointmentList";
    private static final String VIEW_NAME_ARRIVEAPPOINTMENT_LIST = "modules/sd/kefuOrderListNew/arriveAppointmentList";
    private static final String VIEW_NAME_PASSAPPOINTMENT_LIST = "modules/sd/kefuOrderListNew/passAppointmentList";
    private static final String VIEW_NAME_PENDING_LIST = "modules/sd/kefuOrderListNew/pendingList";
    private static final String VIEW_NAME_SERVICED_LIST = "modules/sd/kefuOrderListNew/servicedList";
    private static final String VIEW_NAME_FOLLOWUP_FAIL_LIST = "modules/sd/kefuOrderListNew/followUpFailList";
    private static final String VIEW_NAME_UMCOMPLETED_LIST = "modules/sd/kefuOrderListNew/uncompletedList";
    private static final String VIEW_NAME_ALL_LIST = "modules/sd/kefuOrderListNew/allList";
    private static final String VIEW_NAME_COMPLETED_LIST = "modules/sd/kefuOrderListNew/completedList";
    private static final String VIEW_NAME_REMINDER_LIST = "modules/sd/kefuOrderListNew/reminderList";

    private static final String VIEW_NAME_TMALLANOMALY_LIST = "modules/sd/kefuOrderListNew/tmallAnomalyList";
    private static final String VIEW_NAME_TMALLSERVICEMONITOR_LIST = "modules/sd/kefuOrderListNew/tmallServiceMonitorList";
    private static final String VIEW_NAME_RUSHING_LIST = "modules/sd/kefuOrderListNew/rushingList";
    private static final String VIEW_NAME_COMPLAIN_LIST = "modules/sd/kefuOrderListNew/complainList";
    ...
    private OrderSearchModel setSearchModel(User user,OrderSearchModel searchModel,Model model ,
        ...
        String checkRegion = kefuOrderListNewService.loadAndCheckUserRegions(searchModel,user);
    ...
    public String planingList(OrderSearchModel order, HttpServletRequest request, HttpServletResponse response, Model model) {
        ...
        try {
            page = kefuOrderListNewService.findKefuPlaningOrderList(new Page<>(request, response, DEFAULT_PAGE_SIZE), order, true);
        } catch (Exception e) {
    ...
    public String noAppointmentList(OrderSearchModel order, HttpServletRequest request, HttpServletResponse response, Model model) {
        ...
        try {
            ...
            page = kefuOrderListNewService.findKefuNoAppointmentOrderList(new Page<>(request, response, DEFAULT_PAGE_SIZE), order, true);
        } catch (Exception e) {
            addMessage(model, "错误：" + e.getMessage());
        }
        model.addAttribute(MODEL_ATTR_PAGE, page);
    ...
    public String arriveAppointmentList(OrderSearchModel order, HttpServletRequest request, HttpServletResponse response, Model model) {
        ...
        try {
            //加急
            loadUrgentLevels(order);
            page = kefuOrderListNewService.findKefuArriveAppointmentOrderList(new Page<>(request, response, DEFAULT_PAGE_SIZE), order, true);
        } catch (Exception e) {
            addMessage(model, "错误：" + e.getMessage());
        }
        model.addAttribute(MODEL_ATTR_PAGE, page);
    ...
    public String passAppointmentList(OrderSearchModel order, HttpServletRequest request, HttpServletResponse response, Model model) {
        ...
        try {
            //加急
            loadUrgentLevels(order);
            page = kefuOrderListNewService.findKefuPassAppointmentOrderList(new Page<>(request, response, DEFAULT_PAGE_SIZE), order, true);
        } catch (Exception e) {
            addMessage(model, "错误：" + e.getMessage());
        }
        model.addAttribute(MODEL_ATTR_PAGE, page);
    ...
    public String pendinglist(OrderSearchModel order, HttpServletRequest request, HttpServletResponse response, Model model) {
        ...
        try {
            loadUrgentLevels(order);
            page = kefuOrderListNewService.findKefuPendingOrderList(new Page<>(request, response, DEFAULT_PAGE_SIZE), order, true);
        } catch (Exception e) {
            addMessage(model, "错误：" + e.getMessage());
        }
        model.addAttribute(MODEL_ATTR_PAGE, page);
    ...
    public String servicedList(OrderSearchModel order, HttpServletRequest request, HttpServletResponse response, Model model) {
        ...
        try {
            //加急
            loadUrgentLevels(order);
            page = kefuOrderListNewService.findKefuServicedOrderList(new Page<>(request, response, DEFAULT_PAGE_SIZE), order, true);
        } catch (Exception e) {
            addMessage(model, "错误：" + e.getMessage());
        }
        model.addAttribute(MODEL_ATTR_PAGE, page);
    ...
    public String followUpFailList(OrderSearchModel order, HttpServletRequest request, HttpServletResponse response, Model model) {
        ...
        try {
            //加急
            loadUrgentLevels(order);
            page = kefuOrderListNewService.findKefuFollowUpFailOrderList(new Page<>(request, response, DEFAULT_PAGE_SIZE), order, true);
        } catch (Exception e) {
            addMessage(model, "错误：" + e.getMessage());
        }
        model.addAttribute(MODEL_ATTR_PAGE, page);
    ...
    public String uncompletedList(OrderSearchModel order, HttpServletRequest request, HttpServletResponse response, Model model) {
        ...
        try {
            //加急
            loadUrgentLevels(order);
            page = kefuOrderListNewService.findKefuUncompletedOrderList(new Page<>(request, response, DEFAULT_PAGE_SIZE), order, true);
        } catch (Exception e) {
            addMessage(model, "错误：" + e.getMessage());
        }
        model.addAttribute(MODEL_ATTR_PAGE, page);
    ...
    public String allList(OrderSearchModel order, HttpServletRequest request, HttpServletResponse response, Model model) {
        ...
        if (request.getMethod().equalsIgnoreCase("post") || findNoticeMessage) {
            ...
            try {
                ...
                page = kefuOrderListNewService.findKefuAllOrderList(new Page<>(request, response, DEFAULT_PAGE_SIZE), order, true);
            } catch (Exception e) {
                addMessage(model, "错误：" + e.getMessage());
            }
        } else {
    ...
    public String completedList(OrderSearchModel order, HttpServletRequest request, HttpServletResponse response, Model model) {
        ...
        if (request.getMethod().equalsIgnoreCase("post")) {
            ...
            try {
                page = kefuOrderListNewService.findKefuCompletedOrderList(new Page<>(request, response, DEFAULT_PAGE_SIZE), order, true);
            } catch (Exception e) {
                addMessage(model, "错误：" + e.getMessage());
            }
        } else {
    ...
    public String tmallAnomalyList(TmallAnomalyRecourseSearchVM searchEntity, HttpServletRequest request, HttpServletResponse response, Model model) {
        ...
        String checkRegion = kefuOrderListNewService.loadAndCheckUserRegions(searchEntity,user);
        if(StringUtils.isNotEmpty(checkRegion)){
            addMessage(model, checkRegion);
            model.addAttribute("page", page);
            model.addAttribute("searchEntity", searchEntity);
       ...
       /* if (isServiceSupervisor) {
        ...
        if(user.isKefu()) {
            KefuTypeEnum kefuTypeEnum = KefuTypeEnum.fromCode(user.getSubFlag());
            if(kefuTypeEnum!=null){
                searchEntity.setCustomerType(kefuTypeEnum.getCustomerType());
                searchEntity.setKefuType(kefuTypeEnum.getKefuType());
            }else{
                addMessage(model, "错误：读取客服类型错误,请检查");
                model.addAttribute("page", page);
                model.addAttribute("searchEntity", searchEntity);
                return VIEW_NAME_TMALLANOMALY_LIST;
            }
        ...
        try {
            //查询
            page = kefuOrderListNewService.findKefuTmallAnomalyList(new Page<>(request, response, DEFAULT_PAGE_SIZE), searchEntity);
        } catch (Exception e) {
    ...
    public String tmallServiceMonitorList(TmallServiceMonitorSearchVM tmallServiceMonitor, HttpServletRequest request, HttpServletResponse response, Model model) {
        ...
        String checkRegion = kefuOrderListNewService.loadAndCheckUserRegions(tmallServiceMonitor,user);
        if(StringUtils.isNotEmpty(checkRegion)){
            addMessage(model, checkRegion);
            model.addAttribute("page", page);
            model.addAttribute("entity", tmallServiceMonitor);
        ...
        if(user.isKefu()) {
            KefuTypeEnum kefuTypeEnum = KefuTypeEnum.fromCode(user.getSubFlag());
            if(kefuTypeEnum!=null){
                tmallServiceMonitor.setCustomerType(kefuTypeEnum.getCustomerType());
                tmallServiceMonitor.setKefuType(kefuTypeEnum.getKefuType());
            }else{
                addMessage(model, "错误：读取客服类型错误,请检查");
                model.addAttribute("page", page);
                model.addAttribute("entity", tmallServiceMonitor);
            ...
            tmallServiceMonitor.setKefuType(null);
        }
        //2.by 区域
        if (isServiceSupervisor) {
        ...
        page = kefuOrderListNewService.findKefuTmallServiceMonitorList(new Page<>(request, response, DEFAULT_PAGE_SIZE), tmallServiceMonitor);
        model.addAttribute("entity", tmallServiceMonitor);
        model.addAttribute(MODEL_ATTR_PAGE, page);
        return VIEW_NAME_TMALLSERVICEMONITOR_LIST;
    }
    ...
    public String rushingList(OrderSearchModel order, HttpServletRequest request, HttpServletResponse response, Model model) {
        ...
        try {
            //加急
            loadUrgentLevels(order);
            page = kefuOrderListNewService.findKefuRushingOrderList(new Page<>(request, response, DEFAULT_PAGE_SIZE), order, true);
        } catch (Exception e) {
            addMessage(model, "错误：" + e.getMessage());
        }
        model.addAttribute(MODEL_ATTR_PAGE, page);
    ...
    public String complainList(OrderSearchModel order, HttpServletRequest request, HttpServletResponse response, Model model) {
        ...
        try {
            //加急
            loadUrgentLevels(order);
            page = kefuOrderListNewService.findKefuComplainOrderList(new Page<>(request, response, DEFAULT_PAGE_SIZE), order, true);
        } catch (Exception e) {
            addMessage(model, "错误：" + e.getMessage());
        }
        model.addAttribute(MODEL_ATTR_PAGE, page);
    ...
    public String reminderList(OrderSearchModel order, HttpServletRequest request, HttpServletResponse response, Model model) {
        ...
        try {
            ...
            page = kefuOrderListNewService.findReminderOrderLit(new Page<OrderSearchModel>(request, response, DEFAULT_PAGE_SIZE), order,true);
            //加急
            loadUrgentLevels(order);
        } catch (Exception e) {
            addMessage(model, "错误：" + e.getMessage());
    ...
    public String historyPlanList(OrderSearchModel order, HttpServletRequest request, HttpServletResponse response, Model model) {
        ...
        User user = UserUtils.getUser();
        page.setPageSize(20);
        String checkRegion = kefuOrderListNewService.loadAndCheckUserRegions(order,user);
        ...
        page = kefuOrderListNewService.getHistoryPlanListForKefu(page, order);
        model.addAttribute("page", page);
    ...
    public String orderReturnApproveList(OrderSearchModel order, HttpServletRequest request, HttpServletResponse response, Model model) {
        String viewForm = "modules/sd/kefu/orderReturnApproveNewList";
        ...
        try {
            ...
            page = kefuOrderListNewService.getOrderReturnApproveList(new Page<>(request, response), order);
        } catch (Exception e) {
            addMessage(model, "错误：" + e.getMessage());
        }
        model.addAttribute(MODEL_ATTR_PAGE, page);
    ...
    public String xyyOrderReturnApproveList(OrderSearchModel order, HttpServletRequest request, HttpServletResponse response, Model model) {
        String viewForm = "modules/sd/kefu/xyyOrderReturnApproveNewList";
        Page<Order> page = new Page<>();
        User user = UserUtils.getUser();
        order = setSearchModel(user,order,model,1,true,90,false,0);
        if(!order.getValid()){
    ...
    public String exceptionHandlingList(OrderPendingSearchModel order, HttpServletRequest request, HttpServletResponse response, Model model) {
        String viewForm = "modules/sd/kefu/exceptionHandlingNewList";
        Page<Order> page = new Page<>();
        User user = UserUtils.getUser();
        try {
            ...
            if(StringUtils.isNoneBlank(order.getProductName()) && productIds.size() == 0){
                ...
                //查询
                page = kefuOrderListNewService.getExceptionHandlingList(new Page<>(request, response), order);
            }
        } catch (Exception e) {
            addMessage(model, "错误："+e.getMessage());
        }
