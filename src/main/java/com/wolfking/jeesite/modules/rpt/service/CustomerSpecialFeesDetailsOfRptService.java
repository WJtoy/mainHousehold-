...
@Service
public class CustomerSpecialFeesDetailsOfRptService {
    @Resource
    CustomerSpecialFeesDetailsOfRptDao customerSpecialFeesDetailsOfRptDao;
    ...
    public List<SpecialFeesDetailsOfRptEntity> getSpecialOrderFeeOfChargeDate(Integer selectedYear, Integer selectedMonth, Integer selectedDay,
                                                                              Long provinceId, Integer chargeFlag, List<Long> productCategoryIds,Long customerId) {
        ...
        if (chargeFlag == 1) {
            list = customerSpecialFeesDetailsOfRptDao.getCustomerRemoteOfOrderChargeDate(startDate, endDate, provinceId, productCategoryIds,customerId);
        } else if (chargeFlag == 2) {
            list = customerSpecialFeesDetailsOfRptDao.getCustomerOtherCostsOfTheOrderChargeDate(startDate, endDate, provinceId, productCategoryIds,customerId);
        }
