...
//    private String manufactlicense = "";     //生产许可证
    ...
    private int reminderFlag = 1; //催单标志  // add on 2019-8-26
    ...
    private Integer customizePriceFlag =0; //0-使用参考价格,1-使用自定义价格   // add on 2020-07-14
    private Integer materialFlag = 0;
    private Integer errorFlag = 0;
    private Integer vip = 0; //vip等级
    private String vipName = "";
    private Integer offlineOrderFlag = 0; //线下下单
    private Integer autoCompleteOrder; //自动完工
    ...
    public Integer getOfflineOrderFlag() {
        return offlineOrderFlag;
    }

    public void setOfflineOrderFlag(Integer offlineOrderFlag) {
