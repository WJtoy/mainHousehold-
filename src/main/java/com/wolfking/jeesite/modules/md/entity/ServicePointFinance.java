...
public class ServicePointFinance implements Serializable {
    ...
    private double deposit = 0;//质保金(对帐后生成)
    ...
    public double getDepositRecharge() { return depositRecharge; }

    public void setDepositRecharge(double depositRecharge) { this.depositRecharge = depositRecharge; }
