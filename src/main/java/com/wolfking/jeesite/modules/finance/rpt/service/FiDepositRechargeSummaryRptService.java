...
@Service
public class FiDepositRechargeSummaryRptService {
    ...
    public void checkRptExportTask( Long customerId, Integer selectedYear, Integer selectedMonth, User user) {
        ...
        fiReportExportTaskService.checkRptExportTask(RPTReportEnum.FI_DEPOSIT_CHARGE_SUMMARY_RPT, user, searchConditionJson);
    }
    ...
    public void createRptExportTask(Long customerId, Integer selectedYear, Integer selectedMonth, User user) {
        ...
        String searchConditionJson = RedisGsonUtils.toJson(searchCondition);
        fiReportExportTaskService.createRptExportTask(RPTReportEnum.FI_DEPOSIT_CHARGE_SUMMARY_RPT, RPTReportTypeEnum.ORDER_REPORT, user, reportTitle, searchConditionJson);
    }
    ...
    public void checkExportTask(Integer actionType, Date beginDate,Date endDate,Long customerId, User user) {
        ...
        String searchConditionJson = RedisGsonUtils.toJson(searchCondition);
        fiReportExportTaskService.checkRptExportTask(RPTReportEnum.FI_DEPOSIT_CHARGE_DETAILS_RPT, user, searchConditionJson);
    }
    ...
    public void createExportTask(Integer actionType, Date beginDate,Date endDate,Long customerId,User user) {
        ...
        String searchConditionJson = RedisGsonUtils.toJson(searchCondition);
        fiReportExportTaskService.createRptExportTask(RPTReportEnum.FI_DEPOSIT_CHARGE_DETAILS_RPT, RPTReportTypeEnum.ORDER_REPORT, user, reportTitle, searchConditionJson);
    }
