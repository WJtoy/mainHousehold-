...
import com.wolfking.jeesite.modules.finance.rpt.service.FiFinancialReviewDetailsRptService;
...
@Controller
@RequestMapping(value = "${adminPath}/finance/rpt/financialReview/")
public class FiFinancialReviewDetailsRptController extends BaseRptController  {

    @Autowired
    private FiFinancialReviewDetailsRptService fiFinancialReviewDetailsRptService;
    ...
    public String financialReviewDetailsRptData(RptSearchCondition rptSearchCondition, HttpServletRequest request, HttpServletResponse response, Model model) {
        ...
        if (rptSearchCondition.isSearching()) {
            ...
            page = fiFinancialReviewDetailsRptService.getFinancialReviewList(page,rptSearchCondition.getBeginDate(), rptSearchCondition.getEndDate());

        }

        model.addAttribute("page", page);
        return "modules/finance/rpt/fiAbnormalDetailsReport";
    }
    ...
    public AjaxJsonEntity checkExportTask(RptSearchCondition rptSearchCondition) {
        ...
        try {
            ...
            fiFinancialReviewDetailsRptService.checkRptExportTask(rptSearchCondition.getBeginDate(), rptSearchCondition.getEndDate(),user);
    ...
    public AjaxJsonEntity export(RptSearchCondition rptSearchCondition) {
        ...
        try {
            ...
            fiFinancialReviewDetailsRptService.createRptExportTask(rptSearchCondition.getBeginDate(), rptSearchCondition.getEndDate(),user);
