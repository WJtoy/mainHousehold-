...
import com.wolfking.jeesite.modules.finance.rpt.service.FiCustomerMonthPlanService;
...
@Controller
@RequestMapping(value = "${adminPath}/finance/rpt/customerMonthPlan/")
public class FiCustomerMonthPlanRptController {

    @Autowired
    private FiCustomerMonthPlanService fiCustomerMonthPlanService;
     ...
     *   客户每月下单明细
     */
    @RequiresPermissions("rpt:finance:customerMonthPlan:view")
    ...
    public String customerMonthPlanReport(RptSearchCondition rptSearchCondition, Model model){
        ...
        if (rptSearchCondition.isSearching()) {
            ...
            if (productCategoryIds.isEmpty() &&
                ...
                list = fiCustomerMonthPlanService.getCustomerMonthPlanDailyList(rptSearchCondition.getSelectedYear(), salesId,customerId,productCategoryIds);
            }
        }
        ...
        return "modules/finance/rpt/fiMonthPlanReportRpt";
    }
    ...
    public String customerOrderPlanDailyChart(RptSearchCondition rptSearchCondition, Model model) {
        ...
        if (productCategoryIds.isEmpty() &&
            ...
            map = fiCustomerMonthPlanService.getCustomerOrderPlanDailyChartList(rptSearchCondition.getSelectedYear(),salesId,customerId,productCategoryIds);
        }
        model.addAttribute("list", map.get("list"));
        model.addAttribute("monthSums", map.get("monthSums"));
        model.addAttribute("createDates", map.get("createDates"));
        model.addAttribute("productCategoryList", productCategoryList);
        return "modules/finance/rpt/fiMonthPlanReportChart";
    }

    @ResponseBody
    @RequiresPermissions("rpt:finance:customerMonthPlan:export")
    ...
    public AjaxJsonEntity checkExportTask(RptSearchCondition rptSearchCondition) {
        ...
        try {
            ...
            fiCustomerMonthPlanService.checkRptExportTask(selectedYear,salesId,customerId,productCategoryIds,user);
    ...
    public AjaxJsonEntity export(RptSearchCondition rptSearchCondition) {
        ...
        try {
            ...
            fiCustomerMonthPlanService.createRptExportTask(selectedYear,salesId,customerId,productCategoryIds,user);
