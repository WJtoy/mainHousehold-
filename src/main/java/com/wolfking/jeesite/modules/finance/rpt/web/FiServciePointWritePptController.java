...
import com.wolfking.jeesite.modules.finance.rpt.service.FiServciePointWritePptService;
...
@Controller
@RequestMapping("${adminPath}/finance/rpt/detailedReconciliation/")
public class FiServciePointWritePptController extends BaseRptController {

    @Autowired
    private FiServciePointWritePptService fiServciePointWritePptService;
    ...
    @RequiresPermissions("rpt:finance:getNetworkReconciliation:view")
    ...
    public String getNetworkReconciliation(RptSearchCondition rptSearchCondition, HttpServletRequest request, HttpServletResponse response, Model model) {
        ...
        if (rptSearchCondition.isSearching()) {
            ...
            page = fiServciePointWritePptService.getNrPointWriteOff(page, productCategoryIds, rptSearchCondition.getServicePointId(),
                        rptSearchCondition.getSelectedYear(), rptSearchCondition.getSelectedMonth());

        }
        model.addAttribute("page",page);
        model.addAttribute("productCategoryList", productCategoryList);
        return "modules/finance/rpt/fiServicePointDetailedRpt";

    }

    @ResponseBody
    @RequiresPermissions("rpt:finance:getNetworkReconciliation:export")
    ...
    public AjaxJsonEntity checkExportTask(RptSearchCondition rptSearchCondition) {
        ...
        try {
            ...
            fiServciePointWritePptService.checkRptExportTask(rptSearchCondition.getServicePointId(),
    ...
    public AjaxJsonEntity export(RptSearchCondition rptSearchCondition) {
        ...
        try {
            ...
            fiServciePointWritePptService.createRptExportTask(rptSearchCondition.getServicePointName(),rptSearchCondition.getServicePointId(),
                    productCategoryIds,rptSearchCondition.getSelectedYear(), rptSearchCondition.getSelectedMonth(), user);
