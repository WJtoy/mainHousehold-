...
import com.wolfking.jeesite.modules.finance.rpt.service.FiCompletedOrderNewRptService;
...
@Controller
@RequestMapping(value = "${adminPath}/finance/rpt/completedOrderNew/")
public class FiCompletedOrderNewRptController extends BaseRptController {

    @Autowired
    private FiCompletedOrderNewRptService fiCompletedOrderNewRptService;
     ...
     * @return
     */
    @RequiresPermissions("rpt:finance:completedOrderNewReport:view")
    ...
    public String completedOrderReport(RptSearchCondition rptSearchCondition, HttpServletRequest request, HttpServletResponse response, Model model) {
        ...
        if (rptSearchCondition.isSearching()) {
            ...
            if (productCategoryIds.isEmpty() &&
                ...
                page = fiCompletedOrderNewRptService.getCompletedOrderList(page, rptSearchCondition.getCustomerId(), paymentType,productCategoryIds, rptSearchCondition.getBeginDate(), rptSearchCondition.getEndDate());
            }
        }

        model.addAttribute("page", page);
        model.addAttribute("productCategoryList", productCategoryList);
        return "modules/finance/rpt/fiCompletedOrderNewReport";
    }


    @ResponseBody
    @RequiresPermissions("rpt:finance:completedOrderNewReport:export")
    ...
    public AjaxJsonEntity checkExportTask(RptSearchCondition rptSearchCondition) {
        ...
        try {
            ...
            fiCompletedOrderNewRptService.checkRptExportTask(rptSearchCondition.getCustomerId(), paymentType,productCategoryIds,rptSearchCondition.getBeginDate(), rptSearchCondition.getEndDate(), user);
    ...
    public AjaxJsonEntity export(RptSearchCondition rptSearchCondition) {
        ...
        try {
            ...
            fiCompletedOrderNewRptService.createRptExportTask(rptSearchCondition.getCustomerId(), paymentType,productCategoryIds,rptSearchCondition.getBeginDate(), rptSearchCondition.getEndDate(), user);
