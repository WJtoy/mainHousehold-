...
@Service
public class FiCustomerRechargeSummaryRptService {
    ...
    public void checkRptExportTask( Long customerId, Integer selectedYear, Integer selectedMonth, User user) {
        ...
        fiReportExportTaskService.checkRptExportTask(RPTReportEnum.FI_CUSTOMER_RECHARGE_SUMMARY_RPT, user, searchConditionJson);
    }
    ...
    public void createRptExportTask(Long customerId, Integer selectedYear, Integer selectedMonth, User user) {
        ...
        String searchConditionJson = RedisGsonUtils.toJson(searchCondition);
        fiReportExportTaskService.createRptExportTask(RPTReportEnum.FI_CUSTOMER_RECHARGE_SUMMARY_RPT, RPTReportTypeEnum.ORDER_REPORT, user, reportTitle, searchConditionJson);
    }
