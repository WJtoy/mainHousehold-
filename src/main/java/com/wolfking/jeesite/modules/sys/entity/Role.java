...
import com.wolfking.jeesite.modules.sys.entity.adapter.RoleAdapter;
...
public class Role extends LongIDDataEntity<Role> {
	...
	private Integer dataScope = 0;// 数据范围
	@GsonIgnore
	private String dataScopeName = ""; //数据范围名称，为切换微服务新增
	@GsonIgnore
	private String oldName; 	// 原角色名称
	@GsonIgnore
	private String oldEnname;	// 原英文名称
//	private String sysData; 		//是否是系统数据
	private Integer useable = 1; 		//是否是可用
	@GsonIgnore
...
//	private List<User> userList = Lists.newArrayList(); // 拥有用户列表
	...
	public Role() {
		...
		this.useable= Integer.valueOf(Global.YES);
	}
