package com.wolfking.jeesite.ms.jinran.sd.feign;
...
import com.wolfking.jeesite.ms.jinran.sd.fallback.JinRanOrderFeignFallbackFactory;
 ...
 * 金燃B2B微服务接口调用
 */
@FeignClient(name = "kklplus-b2b-jinran", fallbackFactory = JinRanOrderFeignFallbackFactory.class)
public interface JinRanOrderFeign {
    ...
    MSResponse orderCompleted(@RequestBody MqiOrderCompleted mqiOrderCompleted);
    ...
    MSResponse orderCancelled(@RequestBody MqiOrderCancelled mqiOrderCancelled);
