package com.wolfking.jeesite.ms.jinran.sd.service;
...
@Slf4j
public class JinRanOrderService extends B2BOrderManualBaseService {
    ...
    public MSResponse cancelOrderTransition(B2BOrderTransferResult b2BOrderTransferResult) {
        return jinRanOrderFeign.cancelOrderTransition(b2BOrderTransferResult);
    }
    ...
    public MSResponse checkB2BOrderProcessFlag(List<B2BOrderTransferResult> b2bOrderNos) {
        return jinRanOrderFeign.checkWorkcardProcessFlag(b2bOrderNos);
    }
    ...
    public MSResponse sendB2BOrderConversionProgressUpdateCommandToB2B(List<B2BOrderTransferResult> progressList) {
        return jinRanOrderFeign.updateTransferResult(Lists.newArrayList(progressList));
    }
    ...
    public MSResponse sendOrderStatusUpdateCommandToB2B(MQB2BOrderStatusUpdateMessage.B2BOrderStatusUpdateMessage message) {
        ...
        if (message.getStatus() == B2BOrderStatusEnum.PLANNED.value) {
            ...
            response = orderVisit(message.getMessageId(), message.getB2BOrderId(), message.getB2BOrderNo(), message.getEngineerName(), message.getEffectiveDt(), message.getRemarks(), message.getUpdaterId(), message.getUpdateDt());
            ...
            List<MqiOrderCompleted.CompletedItem> completedItemList = Lists.newArrayList();
            if (messageCompletedItemList != null && messageCompletedItemList.size() > 0) {
                MqiOrderCompleted.CompletedItem completedItem = null;
                for (MQB2BOrderStatusUpdateMessage.CompletedItem item : messageCompletedItemList) {
                    completedItem = new MqiOrderCompleted.CompletedItem();
            ...
            LogUtils.saveLog("B2B工单状态变更消息的状态错误", "JinRanOrderService.sendOrderStatusUpdateCommandToB2B", msgJson, null, null);
        }
        return response;
    }
    ...
    private MSResponse orderPlanned(Long messageId, Integer dataSource, Long b2bOrderId, String b2bOrderNo, String engineerName, String engineerMobile, long createById, long createDt) {
        MqiOrderPlanned planned = new MqiOrderPlanned();
        ...
        return jinRanOrderFeign.orderPlanned(planned);
    }
    ...
    private MSResponse orderAppointed(Long messageId, Integer dataSource, Long b2bOrderId, String b2bOrderNo, String operator, Long appointmentDt, String remark, long createById, long createDt) {
        MqiOrderAppointed appointed = new MqiOrderAppointed();
        ...
        return jinRanOrderFeign.orderAppointed(appointed);
    }

    /**
     * 上门
     */
    private MSResponse orderVisit(Long messageId, Long b2bOrderId, String b2bOrderNo, String visitedMan, Long visitedDt, String remarks,
                                  long createById, long createDt) {
        MqiOrderVisited visited = new MqiOrderVisited();
        ...
        return jinRanOrderFeign.orderVisited(visited);
    }

    /**
     * 完成
     */
    private MSResponse orderCompleted(Long messageId, Integer dataSource, Long b2bOrderId, String b2bOrderNo, List<MqiOrderCompleted.CompletedItem> completedItems, long createById, long createDt) {
        MqiOrderCompleted completed = new MqiOrderCompleted();
        ...
        return jinRanOrderFeign.orderCompleted(completed);
    }
    ...
    private MSResponse orderCancelled(Long messageId, Integer dataSource, Long b2bOrderId, String b2bOrderNo, String operator, Long cancelDt, String remark, long createById, long createDt) {
        MqiOrderCancelled cancelled = new MqiOrderCancelled();
        ...
        return jinRanOrderFeign.orderCancelled(cancelled);
    }
    ...
    public MSResponse processKKLOrder(B2BOrderProcessEntity processEntity) {
        ...
        try {
            ...
            B2BOrderProcessEntity.saveFailureLog(processEntity, "修改快可立工单", "JinRanOrderService.processKKLOrder", e);
        }
    ...
    private boolean cancelKKLOrder(B2BOrderProcessEntity entity) {
        ...
        if (order != null && order.getOrderCondition() != null) {
            ...
            B2BOrderProcessEntity.saveFailureLog(entity, "读取工单失败", "JinRanOrderService.cancelKKLOrder", null);
        }
        return result;
    }
...
//                }
    ...
    public MSResponse checkProductSN(String b2bOrderNo, String productSn) {
        return jinRanOrderFeign.getProductData(b2bOrderNo, productSn);
    }
    ...
    public MSResponse updateFlag(Long b2bConsultingId, Long kklConsultingId) {
        MSResponse msResponse = jinRanOrderFeign.updateFlag(b2bConsultingId, kklConsultingId);
        return msResponse;
    }
    ...
    public MSResponse reminderProcess(MQB2BOrderReminderProcessMessage.B2BOrderReminderProcessMessage message) {
        MqiConsultingOrderProcess consultingOrderProcess = new MqiConsultingOrderProcess();
    ...
    public MSResponse process(MqiConsultingOrderProcess consultingOrderProcess) {
        return jinRanOrderFeign.process(consultingOrderProcess);
    }
