...
public interface CanboOrderFeign {
    ...
    MSResponse orderCompleted(@RequestBody CanboOrderCompleted canboOrderCompleted);
    ...
    MSResponse orderCancelled(@RequestBody CanboOrderCancelled canboOrderCancelled);
    ...
    MSResponse saveLog(@RequestBody CanboOrderLog canboOrderLog);
}
