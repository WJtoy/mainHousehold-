...
public interface B2BCustomerMappingFeign {
     ...
     * @return
     */
    @GetMapping("/b2BCustomerMapping/getCustomerAccountIdByShopIdAndDataSource")
    MSResponse<Long> getCustomerAccountIdByShopIdAndDataSource(@RequestParam("dataSource") Integer dataSource,
