...
@Service
public class MSCustomerOrderTimeRptService {
    @Autowired
    private MSCustomerOrderTimeRptFeign msCustomerOrderTimeRptFeign;
     ...
     */
    public List<RPTCustomerOrderTimeEntity> getCustomerOrderTimeList(Date endDate, Integer areaType, Long areaId, Long salesId, Long customerId, Long keFuId, Long servicePointId, Integer orderServiceType, List<Long> productCategoryIds,Integer subFlag) {
        ...
        if (endDate != null) {
            ...
            if (microServicesProperties.getReport().getEnabled()) {
                MSResponse<List<RPTCustomerOrderTimeEntity>> msResponse = msCustomerOrderTimeRptFeign.getCustomerOrderTimeRptList(search);
     ...
     */
    public Map<String, Object> getCustomerOrderTimeChartList(Date endDate, Integer areaType, Long areaId, Long salesId, Long customerId, Long keFuId, Long servicePointId, Integer orderServiceType, List<Long> productCategoryIds,Integer subFlag) {
        ...
        if (endDate != null) {
            ...
            search.setSubFlag(subFlag);
            if (microServicesProperties.getReport().getEnabled()) {
                MSResponse<Map<String, Object>> msResponse = msCustomerOrderTimeRptFeign.getCustomerOrderTimeChartList(search);
                if (MSResponse.isSuccess(msResponse)) {
    ...
    public void checkRptExportTask(Date endDate, Integer areaType, Long areaId, Long salesId, Long customerId, Long keFuId, Long servicePointId,
                                   Integer orderServiceType, List<Long> productCategoryIds, User user,Integer subFlag) {

        RPTCustomerOrderTimeSearch searchCondition = setSearchCondition(endDate, areaType, areaId,salesId, customerId, keFuId,servicePointId,orderServiceType,productCategoryIds,subFlag);
        String searchConditionJson = RedisGsonUtils.toJson(searchCondition);
        reportExportTaskService.checkRptExportTask(RPTReportEnum.CUSOTMER_ORDER_TIME_RPT, user, searchConditionJson);
    }
    ...
    public void createRptExportTask(Date endDate, Integer areaType, Long areaId, Long salesId, Long customerId, Long keFuId, Long servicePointId,
        ...
        String searchConditionJson = RedisGsonUtils.toJson(searchCondition);
        reportExportTaskService.createRptExportTask(RPTReportEnum.CUSOTMER_ORDER_TIME_RPT, RPTReportTypeEnum.ORDER_REPORT, user, reportTitle, searchConditionJson);
    }
    ...
    public RPTCustomerOrderTimeSearch setSearchCondition(Date endDate, Integer areaType, Long areaId, Long salesId, Long customerId, Long keFuId,
                                                        Long servicePointId, Integer orderServiceType, List<Long> productCategoryIds,Integer subFlag) {
