...
@Service
public class MSUncompletedOrderRptService {
    @Autowired
    private MSUncompletedOrderRptFeign msUncompletedOrderRptFeign;
    ...
    public Page<RPTUncompletedOrderEntity> getUnCompletedOrderList(Page<RPTUncompletedOrderEntity> page, Long customerId, Date endDate) {
        ...
        if (customerId != null && customerId > 0 && endDate != null) {
            ...
            if (microServicesProperties.getReport().getEnabled()) {
                MSResponse<MSPage<RPTUncompletedOrderEntity>> msResponse = msUncompletedOrderRptFeign.getUnCompletedOrderList(search);
    ...
    public void checkRptExportTask(Long customerId,Date endDate,User user) {
        ...
        reportExportTaskService.checkRptExportTask(RPTReportEnum.UNCOMPLETED_ORDER_RPT, user, searchConditionJson);
    }
    ...
    public void createRptExportTask(Long customerId,Date endDate,User user) {
        ...
        String searchConditionJson = RedisGsonUtils.toJson(searchCondition);
        reportExportTaskService.createRptExportTask(RPTReportEnum.UNCOMPLETED_ORDER_RPT, RPTReportTypeEnum.ORDER_REPORT, user, reportTitle, searchConditionJson);
    }
