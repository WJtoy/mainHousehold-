...
@Controller
@RequestMapping(value = "${adminPath}/rpt/provider/keFuCompleteTime/")
public class MSKeFuCompleteTimeRptController extends BaseRptController {

    @Autowired
    private MSKeFuCompleteTimeRptService msKeFuCompleteTimeRptService;
    ...
    @RequestMapping(value = "keFuCompleteTimeReport")
    public String KeFuCompleteTimeReport(RptSearchCondition rptSearchCondition, Model model) {
        ...
        if (rptSearchCondition.isSearching()) {
            ...
            if (productCategoryIds.isEmpty() &&
                ...
                list = msKeFuCompleteTimeRptService.getKeFuCompleteTimeList(rptSearchCondition.getSubFlag(),rptSearchCondition.getEndDate(), type, rptSearchCondition.getAreaId(), rptSearchCondition.getSalesId(), rptSearchCondition.getCustomerId(), rptSearchCondition.getKefuId(), rptSearchCondition.getServicePointId(), rptSearchCondition.getOrderServiceType(), productCategoryIds);
            }
        }
        ...
        return "modules/providerrpt/keFuCompleteTimeReport";
    }


    @RequestMapping(value = "keFuCompleteTimeChart")
    public String KeFuCompleteTimeChart(RptSearchCondition rptSearchCondition, Model model) {
        ...
        if (!map.isEmpty()) {
            ...
            model.addAttribute("strCancenums", map.get("strCancenums"));
            ...
            model.addAttribute("strCancelNumRates", map.get("strCancelNumRates"));
            model.addAttribute("strUnfulfilledOrderRates", map.get("strUnfulfilledOrderRates"));
        }

        model.addAttribute("productCategoryList", productCategoryList);
        model.addAttribute("keFuTypeEnumList", MSRptUtils.getAllKeFuTypeList());
        return "modules/providerrpt/keFuCompleteTimeChart";
    }
    ...
    public AjaxJsonEntity checkExportTask(RptSearchCondition rptSearchCondition) {
        ...
        try {
            ...
            msKeFuCompleteTimeRptService.checkRptExportTask(rptSearchCondition.getSubFlag(),rptSearchCondition.getEndDate(), type, rptSearchCondition.getAreaId(), rptSearchCondition.getSalesId(), rptSearchCondition.getCustomerId(), rptSearchCondition.getKefuId(), rptSearchCondition.getServicePointId(), rptSearchCondition.getOrderServiceType(), productCategoryIds, user);
