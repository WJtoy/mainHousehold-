...
@Component
@Slf4j
public class MSCustomerPraiseDetailsRptFeignFallbackFactory implements FallbackFactory<MSCustomerPraiseDetailsRptFeign> {
    @Override
    public MSCustomerPraiseDetailsRptFeign create(Throwable throwable) {
        ...
        return new MSCustomerPraiseDetailsRptFeign() {
            @Override
