...
@Service
public class MSServicePointInvoiceRptService {
    ...
    public void checkRptExportTask(Long servicePointId, String withdrawNo, Integer paymentType, Integer bank,
        ...
        reportExportTaskService.checkRptExportTask(RPTReportEnum.SERVICEPOINT_INVOICE_RPT, user, searchConditionJson);
    }
    ...
    public void createRptExportTask(Long servicePointId, String withdrawNo, Integer paymentType, Integer bank,
        ...
        String searchConditionJson = RedisGsonUtils.toJson(searchCondition);
        reportExportTaskService.createRptExportTask(RPTReportEnum.SERVICEPOINT_INVOICE_RPT, RPTReportTypeEnum.ORDER_REPORT, user, reportTitle, searchConditionJson);
    }
