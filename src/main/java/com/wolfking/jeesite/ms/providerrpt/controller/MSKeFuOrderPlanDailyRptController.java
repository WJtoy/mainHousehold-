...
import com.wolfking.jeesite.ms.providerrpt.service.MSKeFuOrderPlanDailyRptService;
...
@Controller
@RequestMapping(value = "${adminPath}/rpt/provider/keFuOrderPlan/")
public class MSKeFuOrderPlanDailyRptController {

    @Autowired
    private MSKeFuOrderPlanDailyRptService msKeFuOrderPlanDailyRptService;
    ...
    @RequestMapping(value = "keFuOrderPlanDailyReport")
    public String keFuOrderPlanDailyReport(RptSearchCondition rptSearchCondition, Model model) {

        List<RPTKeFuOrderPlanDailyEntity> list = Lists.newArrayList();
        ...
        if (rptSearchCondition.isSearching()) {
            ...
            if (productCategoryIds.isEmpty() &&
                ...
                list = msKeFuOrderPlanDailyRptService.getKeFuOrderPlanDailyList(rptSearchCondition.getSubFlag(),rptSearchCondition.getSelectedYear(),
        ...
        return "modules/providerrpt/keFuOrderPlanDailyReport";
    }
    ...
    public AjaxJsonEntity checkExportTask(RptSearchCondition rptSearchCondition) {
        ...
        try {
            ...
            msKeFuOrderPlanDailyRptService.checkRptExportTask(rptSearchCondition.getSubFlag(),selectedYear,selectedMonth,rptSearchCondition.getKefuId(),productCategoryIds,user);
    ...
    public AjaxJsonEntity export(RptSearchCondition rptSearchCondition) {
        ...
        try {
            ...
            msKeFuOrderPlanDailyRptService.createRptExportTask(rptSearchCondition.getSubFlag(),selectedYear,selectedMonth,rptSearchCondition.getKefuId(),productCategoryIds,user);
