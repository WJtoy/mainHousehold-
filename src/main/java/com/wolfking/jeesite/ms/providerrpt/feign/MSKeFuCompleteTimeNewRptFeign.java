...
import com.wolfking.jeesite.ms.providerrpt.fallback.MSKeFuCompleteTimeNewRptFeignFallbackFactory;
...
@FeignClient(name = "provider-rpt", fallbackFactory = MSKeFuCompleteTimeNewRptFeignFallbackFactory.class)
public interface MSKeFuCompleteTimeNewRptFeign {

    /**
     * 获取客服完工时效
     */
    @PostMapping("/keFuCompleteTimeNew/getKeFuCompleteTimeNewRptList")
    MSResponse<List<RPTKeFuCompleteTimeEntity>> getKeFuCompleteTimeRptList(@RequestBody RPTKeFuCompleteTimeSearch search);

    /**
     * 获取客服完工时效图表数据
     */
    @PostMapping("/keFuCompleteTimeNew/getKeFuCompleteTimeNewChartList")
