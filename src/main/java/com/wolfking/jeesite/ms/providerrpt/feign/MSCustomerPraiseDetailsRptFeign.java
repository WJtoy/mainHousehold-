...
@FeignClient(name = "provider-rpt", fallbackFactory = MSCustomerPraiseDetailsRptFeignFallbackFactory.class)
public interface MSCustomerPraiseDetailsRptFeign {

    @PostMapping("/customerPraise/getCustomerPraiseDetailsList")
