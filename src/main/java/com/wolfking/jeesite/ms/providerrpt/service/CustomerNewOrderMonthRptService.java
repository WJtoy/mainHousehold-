...
public class CustomerNewOrderMonthRptService {
     ...
     * 从rpt微服务中获取客户每日下单数据
     */
    public Page<RPTCustomerNewOrderDailyRptEntity> getCustomerNewOrderMonthRptList(Page<RPTCustomerNewOrderDailyRptEntity> page, Long customerId, Long saleId,Integer subFlag, Integer selectedYear,Integer selectedMonth) {
