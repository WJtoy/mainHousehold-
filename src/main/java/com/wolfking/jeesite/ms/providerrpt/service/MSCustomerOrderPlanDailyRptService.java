...
@Service
public class MSCustomerOrderPlanDailyRptService {
     ...
     */
    public List<RPTCustomerOrderPlanDailyEntity> getCustomerOrderPlanDailyList(Integer selectedYear, Integer selectedMonth, Long salesId, Long customerId, List<Long> productCategoryIds,Integer subFlag) {
     ...
     */
    public Map<String, Object> getCustomerOrderPlanDailyChartList(Integer selectedYear, Integer selectedMonth, Long salesId, Long customerId, List<Long> productCategoryIds,Integer subFlag) {
     ...
     * 检查报表导出
     */
    public void checkRptExportTask(Integer selectedYear, Integer selectedMonth, Long salesId, Long customerId, List<Long> productCategoryIds, User user,Integer subFlag) {

        RPTCustomerOrderPlanDailySearch searchCondition = setSearchCondition(selectedYear, selectedMonth, salesId, customerId, productCategoryIds,subFlag);
        String searchConditionJson = RedisGsonUtils.toJson(searchCondition);
        reportExportTaskService.checkRptExportTask(RPTReportEnum.CUSTOMER_PLAN_ORDER_RPT, user, searchConditionJson);
    }

    /**
     * 创建报表导出任务
     */
    public void createRptExportTask(Integer selectedYear, Integer selectedMonth, Long salesId, Long customerId, List<Long> productCategoryIds, User user,Integer subFlag) {
        ...
        String searchConditionJson = RedisGsonUtils.toJson(searchCondition);
        reportExportTaskService.createRptExportTask(RPTReportEnum.CUSTOMER_PLAN_ORDER_RPT, RPTReportTypeEnum.ORDER_REPORT, user, reportTitle, searchConditionJson);
    }
     ...
     * 设置筛选项的值
     */
    public RPTCustomerOrderPlanDailySearch setSearchCondition(Integer selectedYear, Integer selectedMonth, Long salesId, Long customerId, List<Long> productCategoryIds,Integer subFlag) {
