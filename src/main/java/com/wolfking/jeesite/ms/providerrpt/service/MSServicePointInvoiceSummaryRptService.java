...
@Service
public class MSServicePointInvoiceSummaryRptService {
    ...
    public void checkRptExportTask( Integer paymentType, Integer bank,Integer selectedYear,Integer selectedMonth, User user) {
        ...
        reportExportTaskService.checkRptExportTask(RPTReportEnum.SERVICEPOINT_PAYMENT_SUMMARY_RPT, user, searchConditionJson);
    }
    ...
    public void createRptExportTask( Integer paymentType, Integer bank,Integer selectedYear,Integer selectedMonth, User user) {
        ...
        String searchConditionJson = RedisGsonUtils.toJson(searchCondition);
        reportExportTaskService.createRptExportTask(RPTReportEnum.SERVICEPOINT_PAYMENT_SUMMARY_RPT, RPTReportTypeEnum.ORDER_REPORT, user, reportTitle, searchConditionJson);
    }
