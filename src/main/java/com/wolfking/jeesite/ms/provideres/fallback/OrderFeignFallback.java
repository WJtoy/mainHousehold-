...
public class OrderFeignFallback implements FallbackFactory<OrderFeign> {
    ...
    public OrderFeign create(Throwable throwable) {
        ...
        return new OrderFeign() {
            ...
            @Override
            public MSResponse<MSPage<ServicePointStation>> getNearByServicePointMatchSubAreaId(long productCategoryId, long subAreaId, String name, String no, Integer autoPlanFlag, String phone, String stationName, String stationAddress, int pageNo, int pageSize) {
                return new MSResponse<>(MSErrorCode.FALLBACK_FAILURE);
            }
        };
    }
