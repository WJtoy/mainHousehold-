...
public class MSCustomerFeignFallbackFactory implements FallbackFactory<MSCustomerFeign> {
    ...
    public MSCustomerFeign create(Throwable throwable) {
        return new MSCustomerFeign() {
            ...
            @Override
            public MSResponse<List<MDCustomer>> findAllListWithIdAndName() {
                return new MSResponse<>(MSErrorCode.FALLBACK_FAILURE);
            }

            @Override
            public MSResponse<List<MDCustomer>> findCustomersWithSales(MDCustomer customer) {
                return new MSResponse<>(MSErrorCode.FALLBACK_FAILURE);
            }
            ...
            @Override
            public MSResponse<List<MDCustomer>> findVipListBySalesId(Integer salesId) {
                return new MSResponse<>(MSErrorCode.FALLBACK_FAILURE);
            }

            @Override
            public MSResponse<List<MDCustomer>> findNotVipListBySalesId(Integer salesId) {
                return new MSResponse<>(MSErrorCode.FALLBACK_FAILURE);
            }

            @Override
            public MSResponse<List<MDCustomer>> findVipListByMerchandiserId(Long merchandiserId) {
                return new MSResponse<>(MSErrorCode.FALLBACK_FAILURE);
            }

            @Override
            public MSResponse<List<MDCustomer>> findNotVipListByMerchandiserId(Long merchandiserId) {
                return new MSResponse<>(MSErrorCode.FALLBACK_FAILURE);
            }
             ...
             */
            @Override
            public MSResponse<List<MDCustomer>> findVipListByCustomerIdsFromCacheForRPT(List<Long> customerIds) {
                return new MSResponse<>(MSErrorCode.FALLBACK_FAILURE);
            }
             ...
             */
            @Override
            public MSResponse<List<MDCustomer>> findNotVipListByCustomerIdsFromCacheForRPT(List<Long> customerIds) {
                return new MSResponse<>(MSErrorCode.FALLBACK_FAILURE);
            }
            ...
            @Override
            public MSResponse<List<MDCustomer>> findListByNotVipCustomer() {
                return new MSResponse<>(MSErrorCode.FALLBACK_FAILURE);
            }
            ...
            @Override
            public MSResponse<Integer> updateAuthorizedCustomers(Long id, Integer type, List<Long> customerIds) {
                return new MSResponse<>(MSErrorCode.FALLBACK_FAILURE);
            }

            @Override
            public MSResponse<List<Long>> findIdListByOfflineOrderFlagFromCacheForSD() {
                return new MSResponse<>(MSErrorCode.FALLBACK_FAILURE);
            }
        };
    }
