...
public interface MSEngineerFeign {
     ...
     * @return
     */
    @GetMapping("/engineer/reloadEngineerCacheById/{id}")
    MSResponse<Integer> reloadEngineerCacheById(@PathVariable("id") Long id);
     ...
     * @return
     */
    @PostMapping("/engineer/findEngineerListForSD")
    MSResponse<MSPage<MDEngineerDto>> findEngineerListForSD(@RequestBody MDEngineerDto mdEngineerDto);
     ...
     * @return
     */
    @PostMapping("/engineer/findEngineerListForAPI")
    MSResponse<MSPage<MDEngineerDto>> findEngineerListForAPI(@RequestBody MDEngineerDto mdEngineerDto);
}
