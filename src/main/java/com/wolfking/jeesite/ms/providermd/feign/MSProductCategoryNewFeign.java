...
public interface MSProductCategoryNewFeign {
     ...
     * @return
     */
    @GetMapping("productCategoryNew/findIdAndNameListByCustomerId/{customerId}")
    MSResponse<List<NameValuePair<Long,String>>> findIdAndNameListByCustomerId(@PathVariable("customerId") Long customerId);
     ...
     * @return
     */
    @GetMapping("productCategoryNew/findIdAndNameListByCustomerIdForMD/{customerId}")
    MSResponse<List<NameValuePair<Long,String>>> findIdAndNameListByCustomerIdForMD(@PathVariable("customerId") Long customerId);
}
