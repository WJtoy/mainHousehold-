...
public interface MSCustomerFeign {
     ...
     * @param id
     * @return
     * id, useDefaultPrice, customizePriceFlag
     */
     ...
     * @return
     */
    @GetMapping("/customer/findAllListWithIdAndName")
    MSResponse<List<MDCustomer>> findAllListWithIdAndName();
     ...
     * @return
     */
    @PostMapping("/customer/findCustomersWithSales")
    MSResponse<List<MDCustomer>> findCustomersWithSales(@RequestBody MDCustomer customer);
     ...
     * @return
     */
    @GetMapping("customer/findVipListBySalesIdFromCacheForRPT/{salesId}")
    MSResponse<List<MDCustomer>> findVipListBySalesId(@PathVariable("salesId") Integer salesId );
     ...
     * @return
     */
    @GetMapping("customer/findNotVipListBySalesIdFromCacheForRPT/{salesId}")
    MSResponse<List<MDCustomer>> findNotVipListBySalesId(@PathVariable("salesId") Integer salesId );
     ...
     * id,name
     */
    @GetMapping("customer/findVipListByMerchandiserIdFromCacheForRPT")
    MSResponse<List<MDCustomer>> findVipListByMerchandiserId(@RequestParam("merchandiserId") Long merchandiserId );
     ...
     * id,name
     */
    @GetMapping("customer/findNameAndIdWithNotVipFromCacheForRPT")
    MSResponse<List<MDCustomer>> findNotVipListByMerchandiserId(@RequestParam("merchandiserId") Long merchandiserId );
     ...
     * @return
     */
    @PostMapping("customer/findVipListByCustomerIdsFromCacheForRPT")
    MSResponse<List<MDCustomer>> findVipListByCustomerIdsFromCacheForRPT(@RequestBody List<Long> customerIds);
     ...
     * @return
     */
    @PostMapping("customer/findNotVipListByCustomerIdsFromCacheForRPT")
    MSResponse<List<MDCustomer>> findNotVipListByCustomerIdsFromCacheForRPT(@RequestBody List<Long> customerIds);
     ...
     */
    @GetMapping("customer/findNameAndIdWithNotVipFromCacheForRPT")
    MSResponse<List<MDCustomer>> findListByNotVipCustomer();
     ...
     * @return
     */
    @PutMapping("/customer/updateAuthorizedCustomers")
    MSResponse<Integer> updateAuthorizedCustomers(@RequestParam("id") Long id, @RequestParam("type") Integer type, @RequestBody List<Long> customerIds);

    @GetMapping("/customer/findIdListByOfflineOrderFlagFromCacheForSD")
    MSResponse<List<Long>> findIdListByOfflineOrderFlagFromCacheForSD();
}
