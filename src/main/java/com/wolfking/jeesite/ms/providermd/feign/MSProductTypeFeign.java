...
public interface MSProductTypeFeign {
     ...
     * @param productCategoryIds    品类列表
     * */
    @GetMapping("productType/findTypeAndItemsByCategoryIds")
    MSResponse<List<TreeDTO>>  findTypeAndItemsByCategoryIds(@RequestParam("customerId") Long customerId,@RequestParam("productCategoryIds") List<Long> productCategoryIds);
