...
public abstract class BaseController {
    ...
    public String redirectException() {
        return "sys/sysLogin";
    }
    ...
    protected void initBinder(WebDataBinder binder) {
        // 设置需要包裹的元素个数，默认为256
        binder.setAutoGrowCollectionLimit(1024*4);
...
//			}
    ...
    @ModelAttribute
    public void checkLogout(HttpServletRequest request,Model model){
        if(Servlets.isAjax(request)){
            ...
            if(user == null || user.getId()==null){
                ...
                model.addAttribute("AjaxJsonEntity",jsonEntity);
            }else{
                model.addAttribute("AjaxJsonEntity",jsonEntity);
            }
