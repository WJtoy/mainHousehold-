...
public class FileUtils extends org.apache.commons.io.FileUtils {
	...
	/**
	 * 获得spring-boot(jar/war)方式运行的Web根目录
	 * @return
	 * @throws FileNotFoundException
	 */
	public static String getJarRootPath() throws FileNotFoundException {
		String path = ResourceUtils.getURL("classpath:").getPath();
		//java -jar => file:/root/tmp/demo-springboot-0.0.1-SNAPSHOT.jar!/BOOT-INF/classes!/
		//tomcat => /Users/yanshenglu/local/apache-tomcat-8.5.20/webapps/ROOT/WEB-INF/classes/
		log.debug("ResourceUtils.getURL(\"classpath:\").getPath() -> "+path);
		path = path.replace("!/BOOT-INF/classes!/","").replace("/WEB-INF/classes/","");
